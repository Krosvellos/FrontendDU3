...
;if(s){var u=s.match(/\.min\.js(\?|$)/)?".min":"";if(!o){
var i=(("undefined"!=typeof uu5Environment?uu5Environment||{}:"undefined"!=typeof UU5&&UU5.Environment||{}).cdnBaseUri||"https://cdn.plus4u.net").replace(/\/*$/,"");e({
uu5g05:i+"/uu-uu5g05/1.0.0/uu5g05"+u+".js"}),t("uu5stringg01")||e({uu5stringg01:i+"/uu-uu5stringg01/1.0.0/uu5stringg01"+u+".js"})}}}}(),function(e,t){
...
e.UU5.Forms=t(e[void 0],e.UU5,e.UU5.Bricks,e.Uu5))}(this,((t,o,s,u)=>(()=>{var r={2202:(e,t,o)=>{"use strict";o.d(t,{ZP:()=>a});var s=o(5032),u=o.n(s),i=o(4434),r=o.n(i);const n=(e,t)=>{
if(!r().Common.Context.isSupported())return e;let o=r().Common.Reference.forward(((o,s)=>Uu5g05.Utils.Element.create(r().Common.UserPreferencesContext.Consumer,null,(i=>{
const r=(null==i?void 0:i.userPreferences)||i;let n={};if(t)for(let e in t)n[e]=r[t[e]];else n=r;return Uu5g05.Utils.Element.create(e,u()({},n,o,{ref:s}))}))));return o.isUu5PureComponent=!0,
o.displayName=`forwardRef(${e.displayName||e.name||"Component"})`,o.tagName=e.tagName,o},a=n},7530:(e,t,o)=>{"use strict";o.d(t,{Z:()=>s});const s={text:"uu5-common-text",bg:"uu5-common-bg",
...
filled:"uu5-common-bg-style-filled",link:"uu5-common-bg-style-link",elevation:"uu5-common-elevation-",elevationHover:"uu5-common-elevation-hover-",forceRich:"uu5-common-force-rich"}},7791:(e,t,o)=>{
"use strict";o.d(t,{X:()=>C,Z:()=>w})
;var s=o(4434),u=(o(5617),o(1256)),i=o(7530),r=o(8977),n=o(6047),a=o(8216),l=o(6062),m=o.n(l),p=o(4036),c=o.n(p),h=o(507),f=o.n(h),d=o(7892),g=o.n(d),v=o(1173),b=o.n(v),x=o(2464),y=o.n(x),k=o(3864),_={}
;_.styleTagTransform=y(),_.setAttributes=g(),_.insert=f(),_.domAPI=c(),_.insertStyleElement=b();m()(k.Z,_);k.Z&&k.Z.locals&&k.Z.locals;const C=a.ZP.withContext(s.Common.VisualComponent.create({
displayName:"Checkbox",mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ElementaryMixin,s.Common.ColorSchemaMixin,r.ZP],statics:{tagName:u.Z.name("Checkbox"),classNames:{
main:u.Z.css("checkbox"),button:u.Z.css("checkbox-button"),right:u.Z.css("input-label-right"),rightWrapper:u.Z.css("right-wrapper"),radio:u.Z.css("input-radio"),checked:u.Z.css("checkbox-checked"),
dot:u.Z.css("checkbox-dot"),loading:u.Z.css("input-loading-icon"),typeSwitch:u.Z.css("checkbox-type-switch")},defaults:{onIcon:"mdi-check"}},propTypes:{value:s.PropTypes.bool,
onIcon:s.PropTypes.string,offIcon:s.PropTypes.string,labelPosition:s.PropTypes.oneOf(["left","right"]),_radio:s.PropTypes.bool,type:s.PropTypes.number,
bgStyleChecked:s.PropTypes.oneOf(["filled","outline"])},getDefaultProps:()=>({value:!1,onIcon:"",offIcon:"",labelPosition:"left",_radio:!1,type:1,bgStyleChecked:"outline"}),
...
this.props.bgStyleChecked&&2!==this.props.type&&(e.className+=" "+i.Z[this.props.bgStyleChecked]);let t=e=>{this._getEventPath(e).some((e=>{let t=e.matches?"matches":"msMatchesSelector"
;return!!e[t]&&e[t]("button.uu5-forms-checkbox-button, .uu5-forms-label")}))&&this._onChange(e)},o=e.onClick;return e.onClick=e=>{"function"==typeof o&&o(e),e.isDefaultPrevented()||t(e)},e},
_getIcon(){let e;return e=this.props._radio&&this.state.value&&!this.props.onIcon?Uu5g05.Utils.Element.create("span",{className:this.getClassName("dot")}):Uu5g05.Utils.Element.create(s.Bricks.Icon,{
...
this.props.inputWidth&&(e.style={width:this.getInputWidth_()}),e},render(){let e,t=this.getId()+"-input",o=this.getLabel(t);return e=2===this.props.type?Uu5g05.Utils.Element.create(s.Bricks.Switch,{
...
size:this.props.size,onIcon:this.props.onIcon,offIcon:this.props.offIcon,loading:this.isLoading(),ref_:e=>this._focusElement=e,mainAttrs:s.Common.Tools.merge({
disabled:this.isReadOnly()||this.isComputedDisabled()},this.props.inputAttrs)}):this.isLoading()?Uu5g05.Utils.Element.create(n.Z,{className:this.getClassName("loading"),id:this.getId()
}):Uu5g05.Utils.Element.create(s.Bricks.Button,{className:this.getClassName().button,colorSchema:"custom",disabled:this.isComputedDisabled(),mainAttrs:s.Common.Tools.merge({
disabled:this.isReadOnly()||this.isComputedDisabled()},this.props.inputAttrs),content:this._getIcon(),ref_:e=>this._focusElement=e,bgStyle:this.props.bgStyleChecked}),
Uu5g05.Utils.Element.create("div",this._getMainAttrs(),"left"===this.props.labelPosition&&o,this.getInputWrapper(Uu5g05.Utils.Element.create(s.Bricks.Div,this._getWrapperAttrs(),e,"right"===this.props.labelPosition&&o)))
}})),w=C},1225:(t,o,s)=>{"use strict";s.d(o,{x:()=>D})
;var u=s(4434),i=s(1256),r=s(7530),n=s(2851),a=s(8977),l=s(1182),m=s(7791),p=s(8216),c=s(6062),h=s.n(c),f=s(4036),d=s.n(f),g=s(507),v=s.n(g),b=s(7892),x=s.n(b),y=s(1173),k=s.n(y),_=s(2464),C=s.n(_),w=s(6329),T={}
;T.styleTagTransform=C(),T.setAttributes=x(),T.insert=v(),T.domAPI=d(),T.insertStyleElement=k();h()(w.Z,T);w.Z&&w.Z.locals&&w.Z.locals;const D=p.ZP.withContext(u.Common.VisualComponent.create({
displayName:"Checkboxes",mixins:[u.Common.BaseMixin,u.Common.PureRenderMixin,u.Common.ElementaryMixin,u.Common.ColorSchemaMixin,u.Common.ScreenSizeMixin,a.ZP,l.Z],statics:{
tagName:i.Z.name("Checkboxes"),classNames:{main:i.Z.css("checkboxes"),inline:i.Z.css("inputs-inline"),
inner:e=>i.Z.css("input-inner")+" "+n.Z.css(`\n          border-radius: ${u.Common.Tools.fillUnit(e.selectionBorderRadius)};\n        `),selectionBackground:i.Z.css("checkboxes-selection-background"),
column:i.Z.css("checkboxes-column")},defaults:{onIcon:"mdi-check",columnRegexp:/^((?:offset-)?[a-z]+)(?:-)?(\d+)$/},lsi:()=>u.Environment.Lsi.Forms.message},propTypes:{type:u.PropTypes.number,
bgStyleChecked:u.PropTypes.oneOf(["filled","outline"]),selectionBackground:u.PropTypes.bool,selectionBorderRadius:u.PropTypes.oneOfType([u.PropTypes.string,u.PropTypes.number])},getDefaultProps:()=>({
type:1,bgStyleChecked:"outline",selectionBackground:!0,selectionBorderRadius:"2px"}),UNSAFE_componentWillMount(){let e=this._getInitialValue()
...
if(this.props.controlled&&void 0!==e.value){let t=this.state.value;e.value.forEach((function(e){t[e.name]=e.value})),
...
u.Common.Tools.merge({},this.props.value[s]).name===o&&(t[o]=e[o])}})):t=null,t},_checkRequired(e){return this.props.required&&(this._isSelected(e.value)?"function"!=typeof this.props.onChange&&(e={
...
_isSelected(e){let t=e?u.Common.Tools.merge({},this.state.value,e):this.state.value;return Object.keys(t).map((e=>t[e])).indexOf(!0)>-1},_getNumberOfColumns(){
...
let i=u.Common.Tools.merge({},o),r=!!this.isComputedDisabled()||!!o.disabled,n=Math.floor(s/(this.props.value.length/e));void 0===t[n]&&(t[n]=[]),t[n].push(Uu5g05.Utils.Element.create(m.Z,{key:s,
value:this.state.value&&this.state.value[i.name],label:o.label,onChange:this._onChange,name:o.name,size:this.props.size,labelPosition:this.props.labelPosition,disabled:r,readOnly:this.isReadOnly(),
...
inputWidth:this._getInputWidth(),colorSchema:this.props.colorSchema,className:this.getClassName("inner"),bgStyleChecked:this.props.bgStyleChecked}))})),t},_getCheckboxes(){
let e=[],t=this._getNumberOfColumns();if(null!==this.props.colWidth&&!this.props.inline&&t){let o;o=this._getColumns(t),o.forEach((t=>{e.push(Uu5g05.Utils.Element.create(u.Bricks.Column,{
colWidth:this.props.colWidth,className:this.getClassName("column")},t))}))}else e=this.props.value.map(((e,t)=>{let o=u.Common.Tools.merge({},e),s=!!this.isComputedDisabled()||!!e.disabled
;return Uu5g05.Utils.Element.create(m.Z,{key:t,value:this.state.value&&this.state.value[o.name],label:e.label,onChange:this._onChange,name:e.name,size:this.props.size,
labelPosition:this.props.labelPosition,disabled:s,readOnly:this.isReadOnly(),onIcon:e.onIcon||this.props.onIcon||this.getDefault().onIcon,offIcon:e.offIcon||this.props.offIcon,type:this.props.type,
feedback:this.isLoading()&&0===t?"loading":"initial",inputWidth:this._getInputWidth(),colorSchema:this.props.colorSchema,className:this.getClassName("inner"),bgStyleChecked:this.props.bgStyleChecked})
}));return e},_getMainAttrs(){let e=this._getInputAttrs();return this.props.inline&&(e.className+=" "+this.getClassName().inline),
this.props.bgStyleChecked&&2!==this.props.type&&(e.className+=" "+r.Z[this.props.bgStyleChecked]),this.props.selectionBackground&&(e.className+=" "+this.getClassName("selectionBackground")),e},
render(){let e=this.getId()+"-input";return Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(e),this.getInputWrapper(this.props.value?[this._getCheckboxes()]:null))}}))},
5774:(e,t,o)=>{"use strict";o.d(t,{z:()=>g});var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(8977),a=o(2851);const l={s:{width:72,height:24,squareSize:8},m:{width:72,height:24,squareSize:8},l:{
width:96,height:40,squareSize:14},xl:{width:96,height:40,squareSize:14}},m=i.Common.VisualComponent.create({displayName:"ColorPreview",mixins:[i.Common.BaseMixin],statics:{
tagName:r.Z.name("ColorPreview"),classNames:{main:r.Z.css("color-preview"),chessboard:e=>{
const t=e.width||l[e.size].width,o=e.height||l[e.size].height,s=e.squareSize||l[e.size].squareSize,u=["color-preview"],i=e.borderRadius||"2px"
;if(u.push(a.Z.css(`\n            display: inline-block;\n            width: ${t}px;\n            height: ${o}px;\n            border-radius: ${i};\n            overflow: hidden;\n            position: relative;\n            vertical-align: bottom;\n            background-color: #FFFFFF;\n\n            &::before {\n              content: "";\n              width: 100%;\n              height: 100%;\n              display: block;\n              position: absolute;\n            }\n\n            &::after {\n              content: "";\n              width: 100%;\n              height: 100%;\n              border: 1px solid #BDBDBD;\n              box-sizing: border-box;\n              border-radius: ${i};\n              position: absolute;\n              left: 0;\n            }\n          `)),
e.color)u.push(a.Z.css(`\n              &::before {\n                background-image:\n                  -moz-linear-gradient(45deg, #000 25%, transparent 25%),\n                  -moz-linear-gradient(-45deg, #000 25%, transparent 25%),\n                  -moz-linear-gradient(45deg, transparent 75%, #000 75%),\n                  -moz-linear-gradient(-45deg, transparent 75%, #000 75%);\n                background-image:\n                  -webkit-gradient(linear, 0 100%, 100% 0, color-stop(.25, #000), color-stop(.25, transparent)),\n                  -webkit-gradient(linear, 0 0, 100% 100%, color-stop(.25, #000), color-stop(.25, transparent)),\n                  -webkit-gradient(linear, 0 100%, 100% 0, color-stop(.75, transparent), color-stop(.75, #000)),\n                  -webkit-gradient(linear, 0 0, 100% 100%, color-stop(.75, transparent), color-stop(.75, #000));\n\n                -webkit-background-size: ${2*s}px ${2*s}px;\n                -moz-background-size: ${2*s}px ${2*s}px;\n                background-size: ${2*s}px ${2*s}px;\n\n                background-position:0 0, ${s}px 0, ${s}px -${s}px, 0px ${s}px;\n              }\n\n              &::after {\n                background-color: ${e.color}\n              }\n            `));else{
...
borderRadius:i.PropTypes.string},getDefaultProps:()=>({color:null,width:null,height:null,size:"m",squareSize:null}),render(){
return Uu5g05.Utils.Element.create("div",this.getMainAttrs(),Uu5g05.Utils.Element.create("div",{key:"chessboard",className:this.getClassName("chessboard")},"​"))}}),p={};p.parse=e=>{let t={
opacity:100,r:0,g:0,b:0};if("#"===e[0])switch(t.opacity=100,e.length){case 4:t.r=parseInt(e[1]+e[1],16),t.g=parseInt(e[2]+e[2],16),t.b=parseInt(e[3]+e[3],16);break;case 7:t.r=parseInt(e[1]+e[2],16),
t.g=parseInt(e[3]+e[4],16),t.b=parseInt(e[5]+e[6],16);break;default:throw"Unsupported value format "+e}else{
let o=e.match(/^(rgba?)\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*,?\s*([0-9]*\.?[0-9]*)\s*\)$/);if(!o)throw"Unsupported value format "+e
...
;if(isNaN(s)||s<0||s>255)throw"Unsupported color value format "+e}return t},p.toString=(e,t={shorten:!0,upperCase:!1})=>{
if("object"!=typeof e||!p.getValid(e))throw"Unsupported value type or invalid value\n"+JSON.stringify(e,null,2);let o;if(100===e.opacity){
...
p.getValid=e=>"string"==typeof e?(e=>{if(!e)return!1;let t;try{t=p.parse(e)&&e}catch(e){t=!1}return t})(e):(e=>{if(!e)return!1;let t=e;return(e.opacity>100||e.opacity<0)&&(t=!1),
(e.r<0||e.r>255||e.b<0||e.b>255||e.g<0||e.g>255)&&(t=!1),t})(e),p.getValidString=(e,t)=>{if("string"==typeof e)return p.getValid(e);try{return p.toString(e,t)}catch(e){return""}},p.getValidObject=e=>{
if("string"!=typeof e)return p.getValid(e);try{return p.parse(e)}catch(e){return null}};const c=p;var h=o(6154);const f=i.Common.VisualComponent.create({displayName:"ColorPaletteForm",
mixins:[i.Common.BaseMixin,h.Z],statics:{tagName:r.Z.name("ColorPaletteForm"),classNames:{main:r.Z.css("color-palette-form"),colorPreviewFormItem:r.Z.css("color-preview-form-item"),
simplePaletteCustomColorForm:a.Z.css('\n        margin: 8px 16px 16px;\n        border-top: 1px solid #BDBDBD;\n        padding-top: 16px;\n        display: flex;\n        flex-wrap: wrap;\n        justify-content: center;\n        width: 328px;\n\n        .uu5-forms-input,\n        .uu5-forms-color-preview-form-item {\n          width: 33%;\n          box-sizing: border-box;\n          padding: 0 8px 16px;\n        }\n        .uu5-forms-input:first-child {\n          padding-left: 0;\n        }\n        .uu5-forms-color-preview-form-item {\n          padding-right: 0;\n\n          > label {\n            display: block;\n            font-size: 16px;\n            color: rgba(0, 0, 0, 0.54);\n            padding: 8px 16px 8px 0;\n          }\n        }\n\n        .uu5-forms-input-l input[type="text"].uu5-forms-input-form-item {\n          height: 40px;\n        }\n\n        .uu5-bricks-button.uu5-bricks-button-l {\n          width: auto;\n          height: 24px;\n        }\n      '),
fullPaletteCustomColorForm:a.Z.css('\n        margin: 8px;\n        border-top: 1px solid #BDBDBD;\n        padding: 24px 0 16px;\n\n        .uu5-forms-color-preview-form-item {\n          display: inline-flex;\n          align-items: baseline;\n\n          > label {\n            color: rgba(0, 0, 0, .54);\n            font-size: 12px;\n          }\n\n          > .uu5-forms-color-preview {\n            display: flex;\n          }\n        }\n\n        .uu5-bricks-button.uu5-bricks-button-s {\n          width: auto;\n          height: 24px;\n          position: absolute;\n          right: 24px;\n        }\n\n        .uu5-forms-color-preview-form-item > label,\n        .uu5-forms-input-s .uu5-forms-label {\n          padding: 2px 8px 2px 24px;\n        }\n\n        .uu5-forms-input-s input[type="text"].uu5-forms-input-form-item {\n          height: 24px;\n        }\n      '),
opacityInput:()=>a.Z.css('\n        &.uu5-forms-input-s {\n          input {\n            padding-right: 20px !important;\n          }\n\n          .uu5-forms-input-wrapper::after {\n            line-height: 24px;\n            right: 6px;\n          }\n        }\n\n        &.uu5-forms-input-l {\n          input {\n            padding-right: 30px !important;\n          }\n\n          .uu5-forms-input-wrapper::after {\n            line-height: 40px;\n            right: 10px;\n          }\n        }\n\n        .uu5-forms-input-wrapper {\n          position: relative;\n\n          input { text-align: right; }\n\n          &::after {\n            content: "%";\n            position: absolute;\n            display: block;\n            bottom: 0;\n            color: rgba(0, 0, 0, .54);\n            pointer-events: none;\n          }\n        }\n\n      '),
hexaInput:()=>a.Z.css('\n        &.uu5-forms-input-s {\n          input {\n            padding-left: 16px !important;\n          }\n\n          .uu5-forms-input-wrapper::after {\n            line-height: 24px;\n            left: 8px;\n          }\n        }\n\n        &.uu5-forms-input-l {\n          input {\n            padding-left: 20px !important;\n          }\n\n          .uu5-forms-input-wrapper::after {\n            line-height: 40px;\n            left: 8px;\n          }\n        }\n\n        .uu5-forms-input-wrapper {\n          position: relative;\n\n          &::after {\n            content: "#";\n            position: absolute;\n            display: block;\n            bottom: 0;\n            color: rgba(0, 0, 0, .54);\n            pointer-events: none;\n          }\n        }\n\n      '),
controls:a.Z.css("\n        padding: 2px 8px 8px 8px;\n        display: flex;\n        justify-content: flex-end;\n\n        .uu5-bricks-button {\n          &.uu5-bricks-button-s {\n            width: auto;\n            height: 24px;\n          }\n\n          &.uu5-bricks-button-l {\n            width: auto;\n            height: 24px;\n          }\n        }\n      ")
},lsi:()=>({...i.Environment.Lsi.Forms.colorPicker,...i.Environment.Lsi.Forms.message})},propTypes:{enableCustomColor:i.PropTypes.bool,value:i.PropTypes.string},getDefaultProps:()=>({
enableCustomColor:!1,value:void 0}),getInitialState(){return{value:c.getValid(this.props.value)||void 0}},UNSAFE_componentWillReceiveProps(e){
c.getValid(e.value)?e.value!==c.getValidString(this.state.value)&&this.setState({value:c.getValidObject(e.value)}):this.setState({value:void 0})},getColor(){return c.getValidString(this.state.value,{
upperCase:!0,shorten:!1})},_renderCustomColorInputs(e){let t,o=""
;return this.state.value&&("object"==typeof this.state.value?t=this.state.value:"string"==typeof this.state.value&&(t=c.getValidObject(this.state.value)),t&&(o=c.getValidString({r:t.r,g:t.g,b:t.b,
opacity:100},{upperCase:!0,shorten:!1}).replace("#",""))),Uu5g05.Utils.Element.create("div",{className:this.getClassName(e?"simplePaletteCustomColorForm":"fullPaletteCustomColorForm")
},Uu5g05.Utils.Element.create(i.Forms.Text,{label:"HEX",size:e?"l":"s",inputWidth:e?"96px":"72px",value:o,onChange:this._handleColorInputChange,onBlur:this._handleColorInputBlur,
className:this.getClassName("hexaInput")}),Uu5g05.Utils.Element.create(i.Forms.Text,{label:"Opacity",size:e?"l":"s",inputWidth:e?"96px":"72px",value:t&&null!=t.opacity?t.opacity+"":"",
onChange:this._handleOpacityChange,onBlur:this._handleOpacityBlur,disabled:!this.state.value,className:this.getClassName("opacityInput")}),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("colorPreviewFormItem")},Uu5g05.Utils.Element.create("label",null,this.getLsiComponent("preview")),Uu5g05.Utils.Element.create(m,{
color:this.state.value?c.getValidString(this.state.value):null,size:e?"l":"s"})),Uu5g05.Utils.Element.create(i.Bricks.Button,{bgStyle:"transparent",colorSchema:"red",size:e?"l":"s",
onClick:this._restore},this.getLsiComponent("clearButton")))},_renderControls(e){return Uu5g05.Utils.Element.create("div",{className:this.getClassName("controls")
},Uu5g05.Utils.Element.create(i.Bricks.Button,{bgStyle:"transparent",colorSchema:"red",size:e?"l":"s",onClick:this._restoreWithClose},this.getLsiComponent("clearButton")))},_getPaletteProps(){return{
simplePalette:this.props.simplePalette,onChange:this._colorPaletteChange,color:c.getValidString(this.state.value),onColorSchemaChange:this._colorSchemaPaletteChange}},_colorSchemaPaletteChange(e){
let t=c.getValidObject(e.value);this.setState({value:t})},_colorPaletteChange(e){let t=c.getValidObject(e.value);this.setState({value:t}),
...
;if(t&&"#"===t[0]?e.value=t.substring(1):t="#"+t,(!t||t.match(/^#[0-9A-Fa-f]{0,6}$/))&&(e.component.onChangeDefault(e),7===t.length)){let e=c.getValidObject(t);this.setState((t=>({value:{...e,
opacity:t.value&&!isNaN(t.value.opacity)?t.value.opacity:100}})))}},_handleColorInputBlur(e){if(e.value=`#${e.value}`,c.getValid(e.value)){if(4===e.value.length){let t=c.getValidObject(e.value)
;this.setState((e=>({value:{...t,opacity:e.value&&!isNaN(e.value.opacity)?e.value.opacity:100}})))}}else e.component.setValue(this.state.value?c.getValidString({...this.state.value,opacity:100},{
upperCase:!0,shorten:!1}):"")},_handleOpacityChange(e){let t=parseInt(e.value);isNaN(t)?e.value||e.component.onChangeDefault(e):(t=Math.min(100,Math.max(t,0)),this.setState((e=>({value:{
..."object"==typeof e.value?e.value:c.getValidObject(e.value),opacity:t}}))))},_handleOpacityBlur(e){isNaN(e.value)&&e.component.setValue(this.state.value?this.state.value.opacity:100)},_restore(){
this.setState({value:null})},_restoreWithClose(){this._colorPaletteChange({values:null})},render:function(){const e=this._getPaletteProps()
;return Uu5g05.Utils.Element.create(i.Bricks.Div,this.getMainPropsToPass(),Uu5g05.Utils.Element.create(i.Bricks.ScreenSize,null,Uu5g05.Utils.Element.create(i.Bricks.ScreenSize.Item,{
screenSize:["xs","s"],key:"resize-item"},Uu5g05.Utils.Element.create(i.Bricks.ColorPalette,u()({},e,{simplePalette:!0
})),this.props.enableCustomColor?this._renderCustomColorInputs(!0):this._renderControls(!0)),Uu5g05.Utils.Element.create(i.Bricks.ScreenSize.Item,{screenSize:"*",key:"resize-item"
},Uu5g05.Utils.Element.create(i.Bricks.ColorPalette,e),this.props.enableCustomColor?this._renderCustomColorInputs(e.simplePalette):this._renderControls(e.simplePalette))))}});var d=o(6047)
;const g=o(8216).ZP.withContext(i.Common.VisualComponent.create({displayName:"ColorPicker",
mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ScreenSizeMixin,i.Common.ElementaryMixin,i.Common.ColorSchemaMixin,n.ZP],statics:{tagName:r.Z.name("ColorPicker"),classNames:{
main:r.Z.css("color-picker"),
loading:()=>a.Z.css("\n          position: absolute;\n          top: 0;\n          right: 0;\n          bottom: 0;\n          left: 0;\n          margin: auto;\n          width: 24px;\n          height: 24px;\n        "),
pickerButton:()=>a.Z.css("\n          padding: 4px;\n          color: black;\n          text-align: left;\n\n          &&.uu5-bricks-button {\n            width: 56px;\n          }\n\n          &.uu5-bricks-button {\n            &.uu5-bricks-button-outline {\n              padding: 3px 4px;\n            }\n          }\n\n          .uu5-forms-color-picker.uu5-forms-input-xl &.uu5-bricks-button {\n            width: 64px;\n          }\n        "),
buttonError:r.Z.css("button-error")},lsi:()=>({...i.Environment.Lsi.Forms.colorPicker,...i.Environment.Lsi.Forms.message})},propTypes:{value:i.PropTypes.string,enableCustomColor:i.PropTypes.bool,
...
!0)))}else"boolean"==typeof this.props.openToContent&&(e=this.props.openToContent);return e},_getValidColor(e,t){if(!e)return"";let o=c.getValid(e)
...
borderRadius:this.props.borderRadius,elevation:this.props.elevation,mainAttrs:this.props.inputAttrs}
;return Uu5g05.Utils.Element.create(i.Bricks.Button,t,this.isLoading()?Uu5g05.Utils.Element.create(d.Z,{className:this.getClassName("loading")+" "+r.Z.css("input-loading-icon"),id:this.getId()
}):i.Common.Tools.wrapIfExists(i.Common.Fragment,Uu5g05.Utils.Element.create(m,{color:this.getValue()||null,size:"s",width:24,borderRadius:this.props.borderRadius
}),Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:"mdi-menu-down"}),Uu5g05.Utils.Element.create("span",{className:"uu5-common-hidden"})))},_getMainAttrs(){let e=this._getInputAttrs()
...
this._shouldOpenToContent()&&(e+=" "+a.Z.css("\n          position: relative;\n          width: 362px;\n      ")),{shown:!0,forceRender:!0,className:e,
...
_changeColor(e,t=!0){this.setState({value:e.value}),t&&this._close(),"function"==typeof this.props.onChange&&this.props.onChange({value:e.value,component:this})},render(){
return Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(this.getId()+"-label"),this.getInputWrapper([this._getButton(),this.state.open&&Uu5g05.Utils.Element.create(i.Bricks.Popover,u()({},this._getPopoverProps(),{
ref_:this._registerPopover}),Uu5g05.Utils.Element.create(f,{ref_:this._registerColorForm,enableCustomColor:this.props.enableCustomColor,simplePalette:this.props.simplePalette,value:this.getValue(),
onChange:this._changeColor}))]))}}))},1936:(e,t,o)=>{"use strict";o.d(t,{Z:()=>c});var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(6067),a=o(8081),l=o(1055);let m,p=e=>e
;const c=i.Common.Reference.forward((({align:e,className:t,...o},s)=>{let i=[l.Z.css(m||(m=p`
      text-align: ${0};
    ...
    `),e)];return t&&i.push(t),Uu5g05.Utils.Element.create(n.MR,null,(({getForm:e})=>Uu5g05.Utils.Element.create(a.C,u()({},o,{getForm:e,ref_:s,className:i.join(" ")}))))}))
;c.displayName=c.tagName=r.Z.name("ContextControls"),c.propTypes={...a.C.propTypes,align:i.PropTypes.oneOf(["left","center","right"])},c.defaultProps={align:"right"}},138:(e,t,o)=>{"use strict"
;o.d(t,{t:()=>c});var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(6067),a=o(5966),l=o(1055);let m,p=e=>e;const c=i.Common.Reference.forward((({className:e,...t},o)=>{const s=[l.Z.css(m||(m=p`
      padding: 0 !important;
    ...
    `),i.Environment.colors.grey.c100)];return e&&s.push(e),Uu5g05.Utils.Element.create(n.MR,null,(({setForm:e})=>Uu5g05.Utils.Element.create(a.Z,u()({},t,{ref:o,ref_:o=>{e(o),
"function"==typeof t.ref_&&t.ref_(o)},className:s.join(" "),spacing:t.spacing}))))}));c.displayName=c.tagName=r.Z.name("ContextForm"),c.propTypes={...a.Z.propTypes},c.defaultProps={
...a.Z.getDefaultProps(),labelColWidth:"xs-12",inputColWidth:"xs-12",spacing:16}},2115:(e,t,o)=>{"use strict";o.d(t,{P:()=>d});var s=o(4434),u=(o(5617),o(1256)),i=o(1055);let r,n,a=e=>e
;const l=s.Common.VisualComponent.create({statics:{tagName:u.Z.name("ContextInfo"),classNames:{icon:()=>i.Z.css(r||(r=a`
        font-size: 26px;
        margin-right: 16px;
        align-self: start;
        color: rgba(0,0,0,0.54);
      ...
      `)),content:()=>i.Z.css(n||(n=a`
        /** just for IE **/
        @media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {
          flex: 1;
        }
      `))}},propTypes:{content:s.PropTypes.any,icon:s.PropTypes.string},getDefaultProps:()=>({content:void 0,icon:"mdi-help-circle"}),render(){
return Uu5g05.Utils.Element.create(s.Common.Fragment,null,Uu5g05.Utils.Element.create(s.Bricks.Icon,{icon:this.props.icon,className:this.constructor.classNames.icon()
}),Uu5g05.Utils.Element.create(s.Bricks.Div,{content:this.props.content,className:this.constructor.classNames.content()}))}});var m=o(6067);let p,c=e=>e;const h="info";function f(e){let t
;if(null!=e)switch(typeof e){case"string":t=s.Common.UU5String.isValid(e)?s.Common.UU5String.toChildren(e):e;break;case"object":
t=Array.isArray(e)?e.map((e=>f(e))):e.tag&&e.props||e.propsArray?Uu5g05.Utils.Element.create(s.Bricks.Span,{content:e}):e;break;default:t=e}return t}const d=s.Common.VisualComponent.create({statics:{
tagName:u.Z.name("ContextHeader"),classNames:{icon:()=>s.Common.Css.css(p||(p=c`
        margin-left: 4px;
        line-height: 1;
        width: 1em;
        height: 1em;
...
this._unmounted=!0,delete this._getForm},_doClick(e){const t=e();if(!t)return;const o=t.getAlertBus(),s=o.getAlerts().find((e=>e.id===h));s?o.removeAlert(s.id):o.setAlert({id:h,
content:Uu5g05.Utils.Element.create(l,{content:this.props.info,icon:this.props.icon}),closeDisabled:!0})},render(){return Uu5g05.Utils.Element.create(m.MR,null,(({getForm:e})=>(this._getForm=e,
Uu5g05.Utils.Element.create(s.Common.Fragment,null,f(this.props.content||this.props.children),this.props.info&&Uu5g05.Utils.Element.create(s.Bricks.Icon,{icon:this.props.icon,mainAttrs:{
onClick:()=>this._doClick(e)},className:this.constructor.classNames.icon()})))))}})},8272:(e,t,o)=>{"use strict";o.d(t,{Y:()=>p});var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),
o(1256)),n=o(6067),a=o(1055);let l,m=e=>e;const p=i.Common.Reference.forward((({className:e,...t},o)=>{const s=[a.Z.css(l||(l=m`
    ...
    `),8,16,32,i.Utils.ScreenSize.getMinMediaQueries("m","padding: 8px 40px 32px;"),8,16,i.Utils.ScreenSize.getMinMediaQueries("m","margin: -8px 0px 24px -40px;"),32,i.Utils.ScreenSize.getMinMediaQueries("m","min-width: calc(100% + 80px);"),i.Utils.ScreenSize.getMinMediaQueries("m","padding: 16px 40px;"),i.Utils.ScreenSize.getMinMediaQueries("m","padding: 8px 40px;"))]
;return e&&s.push(e),Uu5g05.Utils.Element.create(n.r4,null,Uu5g05.Utils.Element.create(i.Bricks.Modal,u()({},t,{location:"portal",ref:o,className:s.join(" ")})))}))
;p.displayName=p.tagName=r.Z.name("ContextModal"),p.propTypes={...i.Bricks.Modal.propTypes},p.defaultProps={}},7252:(e,t,o)=>{"use strict";o.d(t,{N:()=>p});var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),
o(1256)),n=o(6067),a=o(1055);let l,m=e=>e;const p=i.Common.Reference.forward((({className:e,...t},o)=>{const s=[a.Z.css(l||(l=m`
      & > .uu5-bricks-header {
        display: flex;
        align-items: center;
    ...
    `))];return e&&s.push(e),Uu5g05.Utils.Element.create(n.r4,null,Uu5g05.Utils.Element.create(i.Bricks.Section,u()({},t,{ref:o,className:s.join(" ")})))}))
;p.displayName=p.tagName=r.Z.name("ContextSection"),p.propTypes={...i.Bricks.Section.propTypes},p.defaultProps={}},6067:(e,t,o)=>{"use strict";o.d(t,{MR:()=>r,r4:()=>n});var s=o(4434),u=(o(5617),
o(1256));const i=s.Common.Context.create(),r=i.Consumer,n=s.Common.VisualComponent.create({displayName:u.Z.name("ContextFormProvider"),getInitialState(){return{getForm:this._getForm,
setForm:this._setForm}},_getForm(){return this._form},_setForm(e){this._form=e},render(){return Uu5g05.Utils.Element.create(i.Provider,{value:this.state},this.props.children)}})},1055:(e,t,o)=>{
"use strict";o.d(t,{Z:()=>u});var s=o(4434);const u=o.n(s)().Common.Css.createCssModule("uu-forms-context")},8081:(e,t,o)=>{"use strict";o.d(t,{Z:()=>C,C:()=>w})
;var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=(o(5617),o(8887)),a=o(6062),l=o.n(a),m=o(4036),p=o.n(m),c=o(507),h=o.n(c),f=o(7892),d=o.n(f),g=o(1173),v=o.n(g),b=o(2464),x=o.n(b),y=o(5021),k={}
;k.styleTagTransform=x(),k.setAttributes=d(),k.insert=h(),k.domAPI=p(),k.insertStyleElement=v();l()(y.Z,k);y.Z&&y.Z.locals&&y.Z.locals;const _=i.PropTypes.shape({
size:i.PropTypes.oneOf(["s","m","l","xl"]),content:i.PropTypes.any,colorSchema:i.PropTypes.oneOf(i.Environment.colorSchema),bgStyle:i.PropTypes.oneOf(["filled","outline","transparent","underline"])
}),C=i.Common.VisualComponent.create({displayName:"Controls",mixins:[n.Z],statics:{tagName:r.Z.name("Controls"),classNames:{main:r.Z.css("controls")},lsi:()=>i.Environment.Lsi.Forms.controls,
defaults:{reset:{bgStyle:"transparent"},validate:{bgStyle:"transparent"},submit:{colorSchema:"primary"},cancel:{}}},propTypes:{buttonSubmitProps:_,buttonCancelProps:_,buttonResetProps:_,
buttonValidateProps:_,buttonReset:i.PropTypes.bool,buttonValidate:i.PropTypes.bool},getDefaultProps:()=>({buttonReset:!1,buttonValidate:!1,buttonSubmitProps:null,buttonCancelProps:null,
buttonValidateProps:null,buttonResetProps:null}),getInitialState(){return this._mergeButtonsState()},UNSAFE_componentWillReceiveProps(e){
this.props.controlled&&this.setState(this._mergeButtonsState(e))},_save(){return this.getForm().save(),this},_getMainPropsToPass(){let e=this.getMainPropsToPass();return e.disabled=!1,e},
_getButtonKeyName:e=>`button${e.charAt(0).toUpperCase()+e.slice(1)}Props`,_constructButtonState(e,t=this.props){let o=i.Common.Tools.merge({},this.getDefault(e),t[this._getButtonKeyName(e)])
;return o.content=o.content||this.getLsiComponent("submit"===e?"ok":e),o},_getButtonState(e){var t,o
;let s=this.state[this._getButtonKeyName(e)],u=null===(t=this.getForm())||void 0===t||null===(o=t.isFormPending)||void 0===o?void 0:o.call(t);return{...s,
disabled:u||("boolean"==typeof s.disabled?s.disabled:this.isDisabled())}},_mergeButtonsState(e=this.props){let t={};return["reset","validate","submit","cancel"].forEach((o=>{
let s=this._constructButtonState(o,e);t[this._getButtonKeyName(o)]=s})),t},render(){
return Uu5g05.Utils.Element.create(i.Common.Div,this._getMainPropsToPass(),this.props.buttonReset&&Uu5g05.Utils.Element.create(i.Bricks.Button,u()({},this._getButtonState("reset"),{onClick:()=>{
this._registerToForm(),this.getForm().reset()}})),this.props.buttonValidate&&Uu5g05.Utils.Element.create(i.Bricks.Button,u()({},this._getButtonState("validate"),{onClick:()=>{this._registerToForm(),
this.getForm().validate()}})),Uu5g05.Utils.Element.create(i.Bricks.Button,u()({},this._getButtonState("cancel"),{onClick:()=>{this._registerToForm(),this.getForm().cancel()}
})),Uu5g05.Utils.Element.create(i.Bricks.Button,u()({},this._getButtonState("submit"),{onClick:()=>{this._registerToForm(),this._save()}})))}}),w=C},5743:(e,t,o)=>{"use strict";o.d(t,{Mt:()=>I,
aN:()=>P});var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(2810),a=o(1939),l=o(1960),m=o(8216),p=o(2202),c=o(8881),h=(o(6232),
o(6062)),f=o.n(h),d=o(4036),g=o.n(d),v=o(507),b=o.n(v),x=o(7892),y=o.n(x),k=o(1173),_=o.n(k),C=o(2464),w=o.n(C),T=o(1478),D={};D.styleTagTransform=w(),D.setAttributes=y(),D.insert=b(),D.domAPI=g(),
D.insertStyleElement=_();f()(T.Z,D);T.Z&&T.Z.locals&&T.Z.locals;let I=m.ZP.withContext(i.Common.VisualComponent.create({displayName:"DatePicker",
mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ScreenSizeMixin,a.Z],statics:{tagName:r.Z.name("DatePicker"),classNames:{main:r.Z.css("datepicker"),
open:r.Z.css("datepicker-open"),menu:r.Z.css("input-menu"),screenSizeBehaviour:r.Z.css("screen-size-behaviour"),popover:r.Z.css("datepicker-popover")},defaults:{inputColWidth:"xs12 s4 m4 l3 xl3"},
...
UNSAFE_componentWillReceiveProps(e){if(e.controlled){this._setFormattingValues(e);let t=this._getIncomingValue(e.value);t=(!this._hasInputFocus()||t instanceof Date)&&this._getDateString(t)||t,
t=this._getDateString(t);let o=this._validateDate({value:t});if("initial"===o.feedback){let s=this._validateOnChange({value:t,event:null,component:this},!0)
;s?this._updateState(s):(o.feedback=e.feedback||o.feedback,o.message=e.message||o.message,this._updateState(o,!0))}else this._updateState(o,!0)}return this},componentWillUnmount(){this._removeEvent(),
...
;"initial"===o.feedback&&(o=this.getBlurFeedback(e)),o={feedback:"initial",message:null,...o},this._updateState({...o,value:t})}else this.setState({value:o||t})},onFocusDefault_(e){
...
;e=l.ZP.getShortenedValueDateString(t,"-","years"===this._formattingValues.step)
}else if("date"===this._formattingValues.valueType)e=this._parseDate(e);else if("iso"===this._formattingValues.valueType){let t=this._parseDate(e);e=l.ZP.toISODateOnlyString(t)}return e},
...
this._hasFocus||this._onFocus(t),"function"==typeof this.props.onChange?this.props.onChange(t):this.onChangeDefault(t)}}else this._hasFocus||(this._onFocus(t),t={...t,value:e.target.value}),
this._updateState({value:t.value});return this},_onChangeDefault(e,t,o){let s=e._data?e._data.value:e.value,u="function"==typeof o,i=()=>{t?(this._onBlur(e),
!0!==e._data.setToday&&this.close(o)):"function"==typeof o&&o()};if(this.props.validateOnChange){if(e={...e,value:e._data.value},this._checkRequired(e)){let t=this._validateDate(e)
;"initial"!==t.feedback||this._validateOnChange(e)||(u=!1,this._updateState(t,!1,i))}}else if(s){if(this._checkRequired({value:s})){e.required=this.props.required,e={...e,required:this.props.required,
value:s,feedback:this.getFeedback(),message:this.getMessage()};let o=this.getChangeFeedback(e);u=!1,this._updateState(o,t,i)}}else u=!1,this.setState({value:s},i);u&&i()},_onFocus(e){
this._hasFocus||(this._addKeyEvents(),this._hasFocus=!0,e._data?(e._data.value=e.value,e.value=this._getOutcomingValue(e.value)):(e._data={value:e.value},e.value=this._getOutcomingValue(e.value)),
this.isReadOnly()||this.isComputedDisabled()||(this._addEvent(),"function"==typeof this.props.onFocus?this.props.onFocus(e):this.onFocusDefault(e)))},_onBlur(e){
this._hasFocus&&(this._removeKeyEvents(),this._hasFocus=!1,e._data?(e._data.value=e._data.value||e.value,e.value=this._getOutcomingValue(e.value)):(e._data={value:e.value},
...
;return this._textInput&&(e=this._textInput.hasFocus()),e},_getDate(e){return"string"==typeof e&&(e=this._parseDate(e)),e},_validateDate(e){let t={...e
},o=this._parseDate(e.value?e.value:this.state.value);if(t.feedback=t.feedback||"initial",t.message=t.message||null,e.value&&!o&&(t.feedback="error",t.message=this.props.nanMessage),o){
...
value:e.value,event:e.event,component:this,_data:{type:"picker",value:t,...o}},null!==this.props.valueType&&"string"!=this.props.valueType||(e.value=t),e.value=this._getOutcomingValue(e.value),
...
monthNameFormat:this.props.monthNameFormat,weekStartDay:this.props.weekStartDay}},_getDateString(e){"string"==typeof e&&(e=this._parseDate(e));let t=e instanceof Date?l.ZP.toISODateOnlyString(e):e
...
let e=this.state.value;return"months"!==this.props.step&&"years"!==this.props.step||(e=this._parseDate(e),e&&(e=l.ZP.getShortenedInputDateString(e,"/","years"===this.props.step))),e||this.state.value
},render(){let e=this.getId()+"-input",t=this.props.inputAttrs;return t=i.Common.Tools.merge({autoComplete:"off"},t),""===t.className&&delete t.className,
Uu5g05.Utils.Element.create("div",u()({},this._getMainAttrs(),{ref:e=>this._root=e}),this.getLabel(e),this.getInputWrapper([Uu5g05.Utils.Element.create(n.Z,{id:e,name:this.props.name||e,
...
mainAttrs:t,disabled:this.isComputedDisabled(),readonly:this.isReadOnly(),icon:this._getFeedbackIcon(),iconClickable:!1,loading:this.isLoading(),ref_:e=>this._textInput=e,feedback:this.getFeedback(),
...
}),Uu5g05.Utils.Element.create(i.Bricks.Popover,this._getPopoverProps(),this.isOpen()?Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps()):null)]))}}));I=(0,c.Z)(I),I=(0,p.ZP)(I,{
weekStartDay:"weekStartDay",_dateFormat:"shortDateFormat"});const P=I},7321:(e,t,o)=>{"use strict";o.d(t,{D:()=>O})
;var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(1939),a=o(8379),l=o(2810),m=o(2196),p=o(8216),c=o(1960),h=o(2202),f=o(2851),d=(o(6232),
o(6062)),g=o.n(d),v=o(4036),b=o.n(v),x=o(507),y=o.n(x),k=o(7892),_=o.n(k),C=o(1173),w=o.n(C),T=o(2464),D=o.n(T),I=o(2037),P={};P.styleTagTransform=D(),P.setAttributes=_(),P.insert=y(),P.domAPI=b(),
P.insertStyleElement=w();g()(I.Z,P);I.Z&&I.Z.locals&&I.Z.locals;let S,F,N,E,V,U=e=>e,O=p.ZP.withContext(i.Common.VisualComponent.create({displayName:"DateRangePicker",
mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ScreenSizeMixin,i.Common.ContentMixin,n.Z],statics:{tagName:r.Z.name("DateRangePicker"),classNames:{
main:r.Z.css("daterangepicker"),open:r.Z.css("daterangepicker-open"),menu:r.Z.css("input-menu"),leftCalendar:r.Z.css("daterangepicker-calendar-left"),
rightCalendar:r.Z.css("daterangepicker-calendar-right"),multiMonth:r.Z.css("daterangepicker-multi-month-selection"),screenSizeBehaviour:r.Z.css("screen-size-behaviour"),
mainInput:r.Z.css("daterangepicker-main-input"),inputContentWrapper:r.Z.css("daterangepicker-input-content-wrapper"),inputText:r.Z.css("daterangepicker-input-text"),
inputValue:r.Z.css("daterangepicker-input-value"),inputFrom:r.Z.css("daterangepicker-from-input"),inputTo:r.Z.css("daterangepicker-to-input"),inputActive:r.Z.css("input-active"),
calendarSeparator:r.Z.css("daterangepicker-calendar-separator"),firstRow:r.Z.css("daterangepicker-popover-first-row"),secondRow:r.Z.css("daterangepicker-popover-second-row"),
leftColumn:r.Z.css("daterangepicker-popover-left-column"),rightColumn:r.Z.css("daterangepicker-popover-right-column"),calendarInput:e=>{let t=[r.Z.css("daterangepicker-calendar-input")]
;return e.singleCalendar&&(t.push(f.Z.css(S||(S=U`
                flex: 1 1 0;
                top: -1px;
              `))),e.pickerLabelFrom||e.pickerLabelTo||t.push(f.Z.css(F||(F=U`
                  && { width: 0px; }
                `)))),t.join(" ")},todayButton:r.Z.css("daterangepicker-today-button"),inputOpen:r.Z.css("items-input-open"),calendars:r.Z.css("daterangepicker-calendars"),
customContent:r.Z.css("daterangepicker-custom-content"),labelFrom:r.Z.css("daterangepicker-from-label"),labelTo:r.Z.css("daterangepicker-to-label"),
mainPlaceholder:r.Z.css("daterangepicker-main-placeholder"),popoverWrapper:r.Z.css("daterangepicker-popover-wrapper"),inputPlaceholder:r.Z.css("input-placeholder"),
labelBogus:r.Z.css("datetimerangepicker-label-bogus"),popover:r.Z.css("daterangepicker-popover"),resetButton:()=>f.Z.css(N||(N=U`&&&& { margin-left: auto; }`)),singleCalendarInputsWrapper:e=>{
let t=[f.Z.css(E||(E=U`
              display: flex;
              & > .uu5-forms-daterangepicker-calendar-input:first-child {
                margin-left: -1px;
              }
            `))];return(e.pickerLabelFrom||e.pickerLabelTo)&&t.push(f.Z.css(V||(V=U`
...
this._isAllowedFromUnspecifiedRange=c.ZP.isAllowedFromUnspecifiedRange(this.props),this._isAllowedToUnspecifiedRange=c.ZP.isAllowedToUnspecifiedRange(this.props),this._formattingValues={},
...
;let t=null,o=null,s=c.ZP.getCalendarStartView(this.props);if(e){let s=this._validateDevProps(e,this.props.dateFrom,this.props.dateTo);if(s.valid){("error"===this._validateDateRangeResult({value:e
...
i.Environment.EventListener.registerDateTime(this.getId(),this._change)},UNSAFE_componentWillReceiveProps(e){if(e.controlled){this._isAllowedFromUnspecifiedRange=c.ZP.isAllowedFromUnspecifiedRange(e),
this._isAllowedToUnspecifiedRange=c.ZP.isAllowedToUnspecifiedRange(e),this._setFormattingValues(e);let t=Array.isArray(e.value)&&e.value.length>1?e.value:null;t=this._unspecifiedRangeValueToDate(t),
t=this.parseDate(t);let o=c.ZP.getCalendarStartView(e),s=this._validateDevProps(t,e.dateFrom,e.dateTo);if(s.valid){let s=this._validateDateRangeResult({value:t,message:e.message,feedback:e.feedback
...
0===t.length&&(t=null)):t=this._parseDate(e),t},parseDateDefault(e){return this._parseDateDefault(e)},open_(e){this._addEvent(),this.openDefault((()=>this._onOpen(!1,e)))},close_(e){
this._removeEvent(),this.closeDefault((()=>this._onClose(e)))},setValue_(e,t){e=this._unspecifiedRangeValueToDate(e);let o=this._validateDevProps(e,this.props.dateFrom,this.props.dateTo);if(o.valid){
if(Array.isArray(e)&&e.length<2&&(e=null),this._checkRequired({value:e})){let o={...{feedback:"initial",message:null},...this._getInnerState(e,!0)}
;"function"==typeof this.props.onValidate?this._validateOnChange({value:e,event:null,component:this}):this.setState({...o},t)}}else this.showError(o.error)},setFeedback_(e,t,o,s){
""===(o=this._unspecifiedRangeValueToDate(o))&&(o=null);let u={...this._getInnerState(o),feedback:e,message:t};this.setState({...u},s)},getValue_(){let e
...
;return(t||e._data)&&(t=t||{},e._data&&this.state.toInputActive!==e._data.toInputActive&&(e._data.toInputActive?t.toInputActive=!0:t.toInputActive=!1),this.setState({...t})),this},
setChangeFeedback__(e,t){let o=this.parseDate(e.value);o=this._unspecifiedRangeValueToDate(o);let s=this._getInnerState(o);s.feedback=e.feedback,s.message=e.message,this.setState({...s},t)},
getInitialValue_(e){this._isAllowedFromUnspecifiedRange=c.ZP.isAllowedFromUnspecifiedRange(this.props),this._isAllowedToUnspecifiedRange=c.ZP.isAllowedToUnspecifiedRange(this.props),
...
0===t&&this._isAllowedFromUnspecifiedRange&&e&&e.getTime()===c.d8.getTime()||1===t&&this._isAllowedToUnspecifiedRange&&e&&e.getTime()===c.fR.getTime()?e=null:("iso"===this._formattingValues.valueType&&"days"===this._formattingValues.step&&e&&(e=c.ZP.getISO(e,!0)),
"years"!==this._formattingValues.step&&"months"!==this._formattingValues.step||this._formattingValues.format||this._formattingValues.country||(e=c.ZP.getShortenedValueDateString(e,"-","years"===this._formattingValues.step)))),
...
if("months"!==this._formattingValues.step||this._formattingValues.format||this._formattingValues.country){let t=e instanceof Date?c.ZP.toISODateOnlyString(e):e;return i.Common.Tools.getDateString(t,{
format:this._formattingValues.format,country:this._formattingValues.country})}return c.ZP.getShortenedInputDateString(e,"/")}return c.ZP.getShortenedInputDateString(e,"/",!0)},_getDateFrom(e){
...
let s="function"==typeof o;if(!t||this._hasValueChanged(this.state.value,e.value)){var u;let t="function"==typeof this.props.onValidate?this.props.onValidate({...e,
...
},o)):this.showError("validateError",null,{context:{event:null,func:this.props.onValidate,result:t}}):null!==(u=e._data)&&void 0!==u&&u.state?(s=!1,this.setState({...e._data.state},o)):e.value&&(s=!1,
this.setInitial(null,e.value,o))}return s&&o(),this},_validateDateResult(e,t=this.props){let o=e;if(e){let s=this.parseDate(e.value);s=this._getOutcomingValue(s)
;const u=this._getDateFromRange(t.dateFrom),i=this._getDateToRange(t.dateTo);e.value&&!s||(this._compareDates(s,u,"lesser")?(o.feedback="error",
...
s.error="firstGreaterThanSecond"):u&&i&&this._compareDates(u,i,"greater")&&(s.valid=!1,s.error="dateFromGreaterThanDateTo")),s},_getDateFromRange(e){return this._isAllowedFromUnspecifiedRange?c.d8:e},
_getDateToRange(e){return this._isAllowedToUnspecifiedRange?c.fR:e},_onOpen(e,t){let o=this.isS()?e?this._rightTextInput.findDOMNode():this._leftTextInput.findDOMNode():this._textInput
...
},t):"function"==typeof t&&t()},_onClose(e){let t=c.ZP.getDisplayDates(this.state.value||this.state.tempValue,this.state.calendarView);this.setState({
calendarView:c.ZP.getCalendarStartView(this.props),fromDisplayDate:t.dateFrom,toDisplayDate:t.dateTo}),this._popover?this._popover.close(e):"function"==typeof e&&e()},_onKeyDown(e,t){let o={
...
let t=this.state.fromDisplayDate,o=this.state.toDisplayDate,s=e._data;"days"===e.view?(t=c.ZP.setDate(t,s.day,s.month-1,s.year),
o=c.ZP.increaseDate(t,void 0,1)):"months"===e.view?"days"===this.state.calendarView?o=c.ZP.increaseDate(t,void 0,void 0,1):"years"===this.state.calendarView&&(t=c.ZP.setDate(t,void 0,s.month-1,s.year),
o=c.ZP.increaseDate(t,void 0,void 0,1)):"years"===e.view&&(o=c.ZP.increaseDate(t,void 0,void 0,10)),this.setState({calendarView:e.view,fromDisplayDate:t,toDisplayDate:o})},_onChange(e){
...
o=!0):t=[t]:this.props.strictSelection?(t=c.ZP.getAutoRange(t,this.props.strictSelection,this.props.weekStartDay),o=!0):t=[t],e._data.value=t,e.value=this._getOutcomingValue(t),
...
},s=!1;this.state.tempValue?(t=[this.state.tempValue,c.fR],s=!0):t=[c.d8],o.value=this._getOutcomingValue(t),o._data.value=t,o._data.executeOnChange=s,
s&&"function"==typeof this.props.onChange?this.props.onChange(o):this.onChangeDefault(o)},_unspecifiedRangeValueToDate(e){
return c.ZP.unspecifiedRangeValueToDate(e,this._isAllowedFromUnspecifiedRange,this._isAllowedToUnspecifiedRange)},_onClickReset(e){let t={event:e,component:this,_data:{type:"calendar"}
...
let t=this.parseDate(e.value),o=t?this._getDateString(t):null,s={fromFeedback:this.state.fromFeedback,toFeedback:this.state.toFeedback},u=!1,i=this.state.tempValue
;if(e._data.right?s.toInputValue=e.value||o:s.fromInputValue=e.value||o,t){let o,u,r;if(this.props.strictSelection){const[i,r]=c.ZP.getAutoRange(t,this.props.strictSelection,this.props.weekStartDay)
;e._data.right?(t=r,o=this._getDateString(i),s.fromInputValue=o):(t=i,u=this._getDateString(r),s.toInputValue=u)}if(e._data.right){let e=this._isSameMonth(t,this.state.fromDisplayDate)
;if(o=o||this.parseDate(this.state.fromInputValue),u=u||this.parseDate(t),r=this._getInputValidationResult(o,t),!e&&"error"!==r.toFeedback.feedback){let e
;e="months"===this.props.step?c.ZP.getDisplayDates(this.props.singleCalendar?t:c.ZP.decreaseDate(t,void 0,void 0,1),this.state.calendarView):"years"===this.props.step?c.ZP.getDisplayDates(this.props.singleCalendar?t:c.ZP.decreaseDate(t,void 0,void 0,10),this.state.calendarView):c.ZP.getDisplayDates(this.props.singleCalendar?t:c.ZP.decreaseDate(t,0,1),this.state.calendarView),
s.fromDisplayDate=e.dateFrom,s.toDisplayDate=e.dateTo}}else if(o=o||this.parseDate(t),u=u||this.parseDate(this.state.toInputValue),r=this._getInputValidationResult(t,u),
"error"!==r.fromFeedback.feedback){let e=c.ZP.getDisplayDates(t,this.state.calendarView);s.fromDisplayDate=e.dateFrom,s.toDisplayDate=e.dateTo}
let n="error"!==r.fromFeedback.feedback,a="error"!==r.toFeedback.feedback;s={...s,...r},o?(e._data.right||a&&u||!n||(s.tempValue=t),
(e._data.right&&a||!e._data.right&&n)&&(i?e._data.right?a?(s.value=[i,t],s.tempValue=null):s.value=null:a&&u?(s.value=[t,this.parseDate(u)],s.tempValue=null):(s.value=[t,t],
s.tempValue=null):u&&(e._data.right?a?s.value=[this.parseDate(o),t]:(s.value=null,s.tempValue=this.parseDate(o)):s.value=a?[t,this.parseDate(u)]:[t,t]))):s.tempValue=e._data.right?null:t
...
;null===s.value&&this.state.value||null===this.state.value&&s.value?u=!0:s.value&&this.state.value&&2===s.value.length&&2===this.state.value.length&&(this._compareDates(s.value[0],this.state.value[0],"equals")&&this._compareDates(s.value[1],this.state.value[1],"equals")||(u=!0)),
this.isComputedDisabled()||this.isReadOnly()||(e._data.state=s,e._data.executeOnChange=u,e.value=this._getOutcomingValue(s.value),
u&&"function"==typeof this.props.onChange?this.props.onChange(e):this.onChangeDefault(e))},_onCalendarValueChangeDefault(e,t){var o
;let s,u=(null===(o=e._data)||void 0===o?void 0:o.value)||e.value,i=this._getInnerState(u),r="function"==typeof t;if((i.value||!i.value&&this.state.value)&&(s={feedback:"initial",message:null}),
i.tempValue&&(i.toInputActive=!0),e._data.executeOnChange){if(e={...e,value:i.value,feedback:s&&s.feedback,message:s&&s.message},this.props.validateOnChange)r=!1,
this._validateOnChange(e,t);else if(this._checkRequired({value:e.value})){e.required=this.props.required;let o=this.getChangeFeedback(e);r=!1,this.setState({...s,...i,...o},t)}}else r=!1,
this.setState({...s,...i},t);r&&t()},_onInputChangeDefault(e,t){let o="function"==typeof t;if(e._data.executeOnChange){if(this.props.validateOnChange)o=!1,
...
e.message=this.props.requiredMessage||this.getLsiComponent("requiredMessage")),e.required=this.props.required;let u=this.getChangeFeedback({...e,value:s});o=!1,this.setState({...e._data.state,...u},t)
}}else o=!1,this.setState({...e._data.state},t);o&&t()},_getInnerState(e,t){let o,s,u,i,r={feedback:"initial",message:null},n={}
...
let e=c.ZP.getDisplayDates(n.value||n.tempValue,this.state.calendarView);n.fromDisplayDate=e.dateFrom,n.toDisplayDate=e.dateTo}return n},_handleClick(e){
...
let u=c.ZP.getDisplayDates(e,t),i=new Date(Date.now())
;return e||!o&&!s?e||(u=c.ZP.getDisplayDates(i,t)):u=(!o||o&&this._compareDates(i,o,"greater"))&&(!s||s&&this._compareDates(i,s,"lesser"))?c.ZP.getDisplayDates(i,t):c.ZP.getDisplayDates(this.parseDate(o||s),t),
u.dateFrom.getTime()!==c.d8.getTime()&&u.dateTo.getTime()!==c.fR.getTime()||(this.state?(u.dateFrom=this.state.fromDisplayDate,u.dateTo=this.state.toDisplayDate):u=c.ZP.getDisplayDates(i,t)),{
...
let e=c.ZP.getDisplayDates(new Date,this.state.calendarView);this._onChange({value:new Date,_data:{type:"calendar"}}),this.setState({fromDisplayDate:e.dateFrom,toDisplayDate:e.dateTo})},
...
_onNextSelection(){let e=c.ZP.getDisplayDates(this.state.toDisplayDate,this.state.calendarView);this.setState({fromDisplayDate:e.dateFrom,toDisplayDate:e.dateTo})},_onPrevSelection(){
let e=this.state.fromDisplayDate
;"days"===this.state.calendarView?e=c.ZP.decreaseDate(this.state.fromDisplayDate,void 0,1):"months"===this.state.calendarView?e=c.ZP.decreaseDate(this.state.fromDisplayDate,void 0,void 0,1):"years"===this.state.calendarView&&(e=c.ZP.decreaseDate(this.state.fromDisplayDate,void 0,void 0,10))
;let t=c.ZP.getDisplayDates(e,this.state.calendarView);this.setState({fromDisplayDate:t.dateFrom,toDisplayDate:t.dateTo})},_onFocus(e){let t;if(this._hasFocus||(this._addKeyEvents(),this._hasFocus=!0,
...
;if(this.state.tempValue&&!this._getToValue()){let u=this.state.tempValue,i=this.state.tempValue;u.getTime()===c.d8.getTime()&&(i=new Date(Date.now())),s=[u,i],e.value=this._getOutcomingValue(s),
e._data.value=s,o={...o,value:s,...this._getInnerState(s)};let r=t;t=e=>{"function"==typeof this.props.onChange&&this.props.onChange(e),r(e)}
...
e.value=this._getOutcomingValue(s),e._data.value=s,o={...o,value:s,...this._getInnerState(s)};let u=t;t=e=>{"function"==typeof this.props.onChange&&this.props.onChange(e),u(e)}}
...
component:!1,input:!1,label:!1,fromInput:!1,toInput:!1,popover:!1,customContent:!1};return this._getEventPath(e).every((e=>{let l=e.matches?"matches":"msMatchesSelector";if(e[l]){
if(e[l](t))a.label=!0,a.component=!0;else if(e[l](o))a.input=!0,a.component=!0;else if(e[l](s))a.input=!0,a.component=!0,e[l](u)?a.fromInput=!0:e[l](i)&&(a.toInput=!0);else if(e[l](r))a.popover=!0,
...
dateFrom:this.props.dateFrom,dateTo:this.props.dateTo,hidden:!this.isOpen(),selectionMode:"range",onChange:e=>this._onChange({...e,_data:{right:this.state.toInputActive||t,type:"calendar"}}),
...
s.borderRadius=this.props.borderRadius,s.elevation=this.props.elevation,s.bgStyle=this.props.bgStyle,s.size=this.props.size,t?(e?(s={...s,...this.state.toFeedback},
...
this.isOpen()&&this.state.toInputActive&&(s.mainAttrs.className=this.getClassName("inputActive"))):(e?(s={...s,...this.state.fromFeedback},
...
s.feedback=this.state.fromFeedback.feedback,s.prefix=this.props.pickerLabelFrom,s.ref_=e=>this._leftTextInput=e);let u=this._parseDate(s.value)
;return u&&(this._isAllowedFromUnspecifiedRange&&!t&&u.getTime()===c.d8.getTime()||this._isAllowedToUnspecifiedRange&&t&&u.getTime()===c.fR.getTime())&&(s.value=void 0,
s.placeholder=this._isSorXs()?c.zU:this.getLsiValue("unspecifiedRange")),s},_getMainAttrs(){let e=this.getMainAttrs();e.id=this.getId(),e.ref=e=>this._root=e
...
this.props.disableBackdrop&&this.isOpen()&&this.state.toInputActive&&(u=!0)):this.isOpen()&&(u=!0),
u?this._close(!0,(()=>this._onFocus(i))):s?this._open(o.toInput,(()=>this._onFocus(i))):this._onFocus(i))};t.onClick=e=>{o(e)}}return t},_getInputValue(){
let e=null,t=this._getFromValue(),o=this._getToValue();if(t&&o){
let s=this._isAllowedFromUnspecifiedRange&&t.getTime()===c.d8.getTime()?c.zU:this._getDateString(t),u=this._isAllowedToUnspecifiedRange&&o.getTime()===c.fR.getTime()?c.zU:this._getDateString(o)
;if(s!==c.zU&&u!==c.zU){
...
e=this._isAllowedFromUnspecifiedRange&&t.getTime()===c.d8.getTime()?c.zU:this._getDateString(t)}return e=e?i.Common.Tools.wrapIfExists(i.Common.Fragment,Uu5g05.Utils.Element.create("span",{
className:this.getClassName("inputText")},this.props.innerLabel&&this.props.label?this.props.label+" ":null),Uu5g05.Utils.Element.create("span",{className:this.getClassName("inputValue")
},e)):i.Common.Tools.wrapIfExists(i.Common.Fragment,Uu5g05.Utils.Element.create("span",{className:this.getClassName("inputText")
},this.props.innerLabel&&this.props.label?this.props.label+" ":null),Uu5g05.Utils.Element.create("span",{className:this.getClassName("mainPlaceholder")+" "+this.getClassName("inputPlaceholder")
},this._getMainPlaceholder())),Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputContentWrapper")},Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.props.icon
}),e,this.isComputedDisabled()||this.isReadOnly()?null:Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.isOpen()?this.props.iconOpen:this.props.iconClosed}))},_getLabelBogus(e){
return Uu5g05.Utils.Element.create(m.Z,{colWidth:e,key:"labelBogus",className:this.getClassName("labelBogus")})},_getSideLabels(e){
...
;o.className+=` ${this.getClassName("labelFrom")}`,t.push(Uu5g05.Utils.Element.create(m.Z,u()({},o,{content:this.props.labelFrom,key:"fromLabel"})))}else t.push(this._getLabelBogus(o))
;if(this.props.labelTo){let o=this._getLabelProps(e);o.className+=` ${this.getClassName("labelTo")}`,t.push(Uu5g05.Utils.Element.create(m.Z,u()({},o,{
...
let e=null,t=this.getChildren();return t&&(e=Uu5g05.Utils.Element.create("div",{className:this.getClassName("customContent")},t)),e},_getSecondRow(){let e=[]
;if(this.props.showTodayButton&&e.push(Uu5g05.Utils.Element.create(i.Bricks.Button,{content:this.getLsiComponent("today"),className:this.getClassName("todayButton"),onClick:this._goToToday,key:"today"
...
this._isAllowedFromUnspecifiedRange||this.state.tempValue&&!this.state.value||(t=!0),e.push(Uu5g05.Utils.Element.create(i.Bricks.Button,{content:this.getLsiComponent("unspecifiedRange"),
onClick:this._onClickUnspecifiedRange,disabled:t,key:"unspecifiedRange"}))}
return!this.props.hideResetButton&&(!this._isSorXs()&&!this.props.singleCalendar||e.length<2)&&e.push(Uu5g05.Utils.Element.create(i.Bricks.Button,{content:this.getLsiComponent("reset"),
onClick:this._onClickReset,key:"reset",className:this.getClassName("resetButton")})),e.length?Uu5g05.Utils.Element.create("div",{className:this.getClassName("secondRow")},e):null},_getNormalPopup(){
let e;return e=this.props.singleCalendar?Uu5g05.Utils.Element.create(Uu5g05.Fragment,null,Uu5g05.Utils.Element.create("div",{className:this.getClassName("singleCalendarInputsWrapper")
},Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps(!1,!1)),Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps(!1,!0))),this.isOpen()&&Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!1,!1))):Uu5g05.Utils.Element.create("div",{
className:this.getClassName("firstRow")},Uu5g05.Utils.Element.create("div",{className:this.getClassName("leftColumn")
},Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps(!1,!1)),this.isOpen()&&Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!1,!1))),Uu5g05.Utils.Element.create("span",{
className:this.getClassName("calendarSeparator")}),Uu5g05.Utils.Element.create("div",{className:this.getClassName("rightColumn")
},Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps(!1,!0)),this.isOpen()&&Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!1,!0)))),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("popoverWrapper")},Uu5g05.Utils.Element.create(i.Bricks.Popover,u()({},this._getPopoverProps(),{key:"popover"}),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("calendars")+" uu5-forms-input-m"},e,this._getSecondRow()),this._getCustomContent()))},_normalRender(e,t){let o=this.getClassName("mainInput")
;this.isOpen()&&(o+=" "+this.getClassName("inputOpen")),o+=" "+t;let s=this.props.inputAttrs;return s=i.Common.Tools.merge({autoComplete:"off"},s),""===s.className&&delete s.className,
s.tabIndex=this.isReadOnly()||this.isComputedDisabled()?void 0:"0",s.onFocus=this.isReadOnly()||this.isComputedDisabled()?null:this._handleFocus,
Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("div",this._getMainInnerMainAttrs(!0),this._getLabels(e,!0),this.getInputWrapper([Uu5g05.Utils.Element.create(a.Z,{
id:e,name:this.props.name||e,value:this._getInputValue(),placeholder:this._getMainPlaceholder(),mainAttrs:s,disabled:this.isComputedDisabled(),readonly:this.isReadOnly(),loading:this.isLoading(),
ref_:e=>this._textInput=e&&e.findDOMNode(),feedback:this.getFeedback(),borderRadius:this.props.borderRadius,elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth({
dualInput:!1}),key:"input",size:this.props.size,className:o,onKeyDown:this._onKeyDown,colorSchema:this.props.colorSchema})])),this._getNormalPopup())},_smallRender(e,t){
return Uu5g05.Utils.Element.create("div",this._getMainInnerMainAttrs(),this._getLabels(e),this.getInputWrapper([Uu5g05.Utils.Element.create(l.Z,u()({id:e},this._getCalendarInputProps(!0,!1,t),{
key:"input1"})),Uu5g05.Utils.Element.create(l.Z,u()({id:e+"-2"},this._getCalendarInputProps(!0,!0,t),{key:"input2"})),Uu5g05.Utils.Element.create(i.Bricks.Popover,u()({},this._getPopoverProps(),{
key:"popover"}),Uu5g05.Utils.Element.create("div",{className:this.getClassName("calendars")+" uu5-forms-input-m"},Uu5g05.Utils.Element.create("div",{className:this.getClassName("firstRow")
},Uu5g05.Utils.Element.create("div",{className:this.getClassName("leftColumn")},this.isOpen()&&Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!0,!1)))),this._getSecondRow()))]))
},_getLabels(e,t){let o;return o=this._getTotalCols()>12?this._getSideLabels(e):t&&this.props.innerLabel?null:this.getLabel(e),o},render(){
let e=this.getId()+"-input",t=this.props.size?"uu5-forms-input-"+this.props.size:null,o=null;return o=this.isXs()||this.isS()?this._smallRender(e,t):this._normalRender(e,t),o}}));O=(0,h.ZP)(O,{
weekStartDay:"weekStartDay"})},4133:(e,t,o)=>{"use strict";o.d(t,{xZ:()=>N,T4:()=>E});var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(2810),a=o(1939),l=o(2438),m=o(8216),p=o(1960),c=o(2202),h=(o(6232),
o(6062)),f=o.n(h),d=o(4036),g=o.n(d),v=o(507),b=o.n(v),x=o(7892),y=o.n(x),k=o(1173),_=o.n(k),C=o(2464),w=o.n(C),T=o(6554),D={};D.styleTagTransform=w(),D.setAttributes=y(),D.insert=b(),D.domAPI=g(),
D.insertStyleElement=_();f()(T.Z,D);T.Z&&T.Z.locals&&T.Z.locals;var I=o(8881);const P="AM",S="PM",F="12";let N=m.ZP.withContext(i.Common.VisualComponent.create({displayName:"DateTimePicker",
mixins:[i.Common.BaseMixin,i.Common.ElementaryMixin,i.Common.ScreenSizeMixin,a.Z],statics:{tagName:r.Z.name("DateTimePicker"),classNames:{main:r.Z.css("datetimepicker"),
datepickerOpen:r.Z.css("datepicker-open"),timepickerOpen:r.Z.css("timepicker-open"),menu:r.Z.css("input-menu"),dateInput:r.Z.css("date-input"),timeInput:r.Z.css("time-input"),
seconds:r.Z.css("time-input-seconds"),screenSizeBehaviour:r.Z.css("screen-size-behaviour"),popoverWrapper:r.Z.css("datetimepicker-popover-wrapper"),
popoverWrapperDate:r.Z.css("datetimepicker-popover-wrapper-date"),popoverWrapperTime:r.Z.css("datetimepicker-popover-wrapper-time"),withSeconds:r.Z.css("datetimepicker-seconds"),
withEnglishFormat:r.Z.css("datetimepicker-english-format"),dateWrapper:r.Z.css("datetimepicker-date-wrapper"),timeWrapper:r.Z.css("datetimepicker-time-wrapper"),
popover:r.Z.css("datetimepicker-popover")},defaults:{regexpFormat1:/^\d{1,2}:?\d{0,2} ?[PpAa]?\.?[Mm]?\.?$/,regexpFormat2:/^\d{1,2}:?\d{0,2}$/,regexpTime:/[Pp]\.?([Mm]\.?)?/,regexpSpace:/ /g,
...
this._allowTimeZoneAdjustment=!0;let t=this._parseDate(e.value);this._getDateString(t)&&!this._getTimeString(t)&&(t+=" "+this._getAutofilledTime());let o=this._validateDateTime({value:t})
;if("initial"===o.feedback){let s=this._validateOnChange({value:this._getOutcomingValue(t,e),event:null,component:this,_data:{value:t,timeZoneAdjusted:!0}},!0)
;s?this._updateState(s,!1,!0):(o.feedback=e.feedback||o.feedback,o.message=e.message||o.message,this._updateState(o,!1,!0))
}else this._updateState(o,this._hasInputFocus()&&!(o.value instanceof Date),!0)}return this},componentWillUnmount(){this._removeEvent(),
i.Environment.EventListener.unregisterDateTime(this.getId(),this._change)},componentDidUpdate(e,t){
...
t&&o)o.dayPart===P&&12===o.hours?o.hours-=12:o.dayPart===S&&o.hours<12&&(o.hours+=12),
...
;let o=this._validateDateTime(e);"initial"===o.feedback&&(o=this.getBlurFeedback(e)),o={feedback:"initial",message:null,...o},this._updateState({...o,value:t})}},onChangeDefault_(e,t){
let o=e._data.type
...
"string"!==this._formattingValues.valueType&&this._formattingValues.valueType)"date"===this._formattingValues.valueType?e="number"==typeof this._formattingValues.timeZone?i.Common.Tools.adjustForTimezone(t,-t.getTimezoneOffset()/60,this._formattingValues.timeZone):t:"iso"===this._formattingValues.valueType?(e="number"==typeof this._formattingValues.timeZone?i.Common.Tools.adjustForTimezone(t,-t.getTimezoneOffset()/60,this._formattingValues.timeZone):t)&&(e=p.ZP.getISO(e)):"isoLocal"===this._formattingValues.valueType&&t&&(e=p.ZP.getISOLocal(t,this._formattingValues.timeZone));else{
...
return e},_getIncomingValue(e){if(e){let t;t=e instanceof Date?e:this._parseDate(e),e=t}return e},_setUpLimits(e){let{timeFrom:t,timeTo:o,show24:s}=p.ZP.setupLimits(e);this._timeFrom=t,this._timeTo=o,
...
_setDayPart:(e,t)=>(t=(e=i.Common.Tools.cloneDateObject(e))?t||i.Common.Tools.getDayPart(e):null,e&&(t===S&&0===e.getHours()?e.setHours(12):t===P&&12===e.getHours()&&e.setHours(0)),e),
...
let e=this._formattingValues.timeFormat==F?"12:00":"00:00",t="00",o=P;if(this.props.timeDefault){let s=this.props.timeDefault
;this._formattingValues.timeFormat!=F||/AM|PM/.test(s)||(s=p.ZP.timeFormat24to12(s));let u=s.trim().split(" ");o=u[1],u=u[0].split(":"),e=u[0]+":"+(u[1]||"00"),t=u[2]}
...
this.setState({calendarOpen:!0,timeOpen:!1},(()=>this._onOpenCalendar(e)))},_openTime(e){this._addEvent(),this.setState({calendarOpen:!1,timeOpen:!0},(()=>this._onOpenTime(e)))},
...
;return this.props.required&&!e.value&&(t=!1,this._updateState({feedback:"error",message:this.props.requiredMessage||this.getLsiComponent("requiredMessage")})),t},_validateDate(e,t=this.props){let o={
...e},s=e._data?e._data.value:e.value,u=this._parseDate(void 0!==s?s:this.state.dateString);if(o.feedback=o.feedback||"initial",o.message=o.message||null,s&&!u&&(o.feedback="error",
o.message=t.nanMessage),u&&"error"!==o.feedback){let e=this._getDateFrom(o.dateFrom,t),s=this._getDateTo(o.dateTo,t);e&&u<e?(o.feedback="error",
o.message=t.beforeRangeMessage):s&&u>s?(o.feedback="error",o.message=t.afterRangeMessage):(o.feedback=o.feedback||"initial",o.message=o.message||null,o.value=u)}return o},_validateLimits(e){
return p.ZP.validateLimits(e,this._timeFrom,this._timeTo)},_validateTime(e,t=this.props){let o={...e},s=e.value?this._getTimeString(e.value):null,u=s?i.Common.Tools.parseTime(s):null
;return e.value&&!s||u&&t.strictTimeStep&&u.minutes%t.timeStep>0?(o.feedback="error",o.message=t.nanMessage):this._validateLimits(u)?(o.feedback=o.feedback||"initial",
...
o},_validateOnChange(e,t,o){let s,u="function"==typeof o,i=(e={...e})._data?e._data.value:e.value;return t&&!this._hasValueChanged(this.state.value,i,["",null,void 0])||(e.component=this,
e.required=this.props.required,"date"==this.props.valueType&&i&&(e.value=this._parseDate(i)),s="function"==typeof this.props.onValidate?this.props.onValidate(e):null,
s&&"object"==typeof s&&s.feedback&&(u=!1,this._allowTimeZoneAdjustment=!0,this._updateState(s,!1,!1,o))),u&&o(),s},_getDateIcon(){return this.props.dateIcon},_getTimeIcon(){return this.props.timeIcon
...
s=this._parseDate(e);let o=this._parseTime(t);s&&(o.dayPart===P&&12===o.hours?o.hours-=12:o.dayPart===S&&o.hours<12&&(o.hours+=12),s.setHours(o.hours),s.setMinutes(o.minutes),s.setSeconds(o.seconds))
...
;if(o&&this.props.timeFormat==F&&a===P&&a===S||(a=null),this.props.seconds&&1===this.props.timeStep?(t=!!(i&&2==i.length&&r&&2==r.length&&n&&2==n.length)&&("12"!=this.props.timeFormat||a),
...
;let u=this._getFullDate(o,t,"date"==this.props.valueType);e={component:this,value:this._getOutcomingValue(u),_data:{type:"calendarPicker",dateString:o,value:u,timeZoneAdjusted:!0,...s}},
...
dateString:e._data.dateString},!1,!1,t);s&&this.setState({},t)},_onChangeDatePickerDefault(e,t){let o=!0===e._data.setToday?{calendarOpen:!0}:{calendarOpen:!1};this._updateState({...o,
...
;e&&(e.dayPart===P&&12===e.hours?e.hours-=12:e.dayPart===S&&e.hours<12&&(e.hours+=12),o.setHours(e.hours),o.setMinutes(e.minutes),o.setSeconds(e.seconds))}}else o=e;return this._adjustTimeZone(o)},
...
;return this._isCalendarOpen()?o+=" "+this.getClassName("popoverWrapperDate"):this._isTimeOpen()&&(o+=" "+this.getClassName("popoverWrapperTime")),
Uu5g05.Utils.Element.create("div",u()({},this._getMainAttrs(),{ref:e=>this._root=e}),this.getLabel(this.getId()+"-date-input"),this.getInputWrapper([Uu5g05.Utils.Element.create("div",{
className:this.getClassName("dateWrapper"),key:"1"},Uu5g05.Utils.Element.create(n.Z,{id:this.getId()+"-date-input",name:this.props.name||this.getId()+"-date-input",value:e||"",
...
bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth({pickerType:"date"}),colorSchema:this.props.colorSchema,size:this.props.size})),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("timeWrapper"),key:"2"},Uu5g05.Utils.Element.create(n.Z,{id:this.getId()+"-time-input",name:this.props.name||this.getId()+"-time-input",value:t||"",
...
size:this.props.size})),Uu5g05.Utils.Element.create("div",{className:o,key:"3"
},Uu5g05.Utils.Element.create(i.Bricks.Popover,this._getDatePopoverProps(),this._isCalendarOpen()?Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getDatePickerProps(e)):null),Uu5g05.Utils.Element.create(i.Bricks.Popover,this._getTimePopoverProps(),this._isTimeOpen()?Uu5g05.Utils.Element.create(l.Z,this._getTimePickerProps(this._parseTime(t))):null)),"portal"===this.props.popoverLocation&&this.isOpen()&&!this._shouldOpenToContent()?Uu5g05.Utils.Element.create(i.Bricks.ResizeObserver,{
onResize:this._onInputWrapperResize,key:"resizeObserver"}):null]))}}));N=(0,I.Z)(N),N=(0,c.ZP)(N,{weekStartDay:"weekStartDay",timeFormat:"hourFormat",_dateFormat:"shortDateFormat"});const E=N},
4660:(e,t,o)=>{"use strict";o.d(t,{X:()=>O});var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(1939),a=o(8379),l=o(2810),m=o(2196),p=o(2438),c=o(8216),h=o(1960),f=o(2202),d=o(2851),g=(o(6232),
o(6062)),v=o.n(g),b=o(4036),x=o.n(b),y=o(507),k=o.n(y),_=o(7892),C=o.n(_),w=o(1173),T=o.n(w),D=o(2464),I=o.n(D),P=o(5940),S={};S.styleTagTransform=I(),S.setAttributes=C(),S.insert=k(),S.domAPI=x(),
S.insertStyleElement=T();v()(P.Z,S);P.Z&&P.Z.locals&&P.Z.locals;let F,N=e=>e;const E="AM",V="PM",U="12";let O=c.ZP.withContext(i.Common.VisualComponent.create({displayName:"DateTimeRangePicker",
mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ScreenSizeMixin,i.Common.ContentMixin,n.Z],statics:{tagName:r.Z.name("DateTimeRangePicker"),classNames:{
main:r.Z.css("datetimerangepicker"),open:r.Z.css("datetimerangepicker-open"),menu:r.Z.css("input-menu"),leftCalendar:r.Z.css("datetimerangepicker-calendar-left"),
rightCalendar:r.Z.css("datetimerangepicker-calendar-right"),multiMonth:r.Z.css("datetimerangepicker-multi-month-selection"),screenSizeBehaviour:r.Z.css("screen-size-behaviour"),
mainInput:r.Z.css("datetimerangepicker-main-input"),inputContentWrapper:r.Z.css("datetimerangepicker-input-content-wrapper"),inputText:r.Z.css("datetimerangepicker-input-text"),
inputValue:r.Z.css("datetimerangepicker-input-value"),inputFrom:r.Z.css("datetimerangepicker-from-input"),inputTo:r.Z.css("datetimerangepicker-to-input"),inputActive:r.Z.css("input-active"),
inputWrapper:r.Z.css("datetimerangepicker-input-wrapper"),calendarSeparator:r.Z.css("datetimerangepicker-calendar-separator"),firstRow:r.Z.css("datetimerangepicker-popover-first-row"),
secondRow:r.Z.css("datetimerangepicker-popover-second-row"),leftColumn:r.Z.css("datetimerangepicker-popover-left-column"),rightColumn:r.Z.css("datetimerangepicker-popover-right-column"),
fromWrapper:r.Z.css("datetimerangepicker-from-wrapper"),toWrapper:r.Z.css("datetimerangepicker-to-wrapper"),dateInput:r.Z.css("datetimerangepicker-date-input"),
timeInput:r.Z.css("datetimerangepicker-time-input"),dayPartInput:r.Z.css("datetimerangepicker-time-part-input"),todayButton:r.Z.css("datetimerangepicker-today-button"),
inputOpen:r.Z.css("items-input-open"),calendars:r.Z.css("datetimerangepicker-calendars"),customContent:r.Z.css("datetimerangepicker-custom-content"),
labelFrom:r.Z.css("datetimerangepicker-from-label"),labelTo:r.Z.css("datetimerangepicker-to-label"),mainPlaceholder:r.Z.css("datetimerangepicker-main-placeholder"),
inputsWrapper:r.Z.css("datetimerangepicker-inputs-wrapper"),popoverWrapper:r.Z.css("datetimerangepicker-popover-wrapper"),removeRightBorder:r.Z.css("datetimerangepicker-remove-right-border"),
compactLayout:r.Z.css("datetimerangepicker-compact-layout"),labelBogus:r.Z.css("datetimerangepicker-label-bogus"),withSeconds:r.Z.css("datetimerangepicker-seconds"),
withEnglishFormat:r.Z.css("datetimerangepicker-english-format"),inputPlaceholder:r.Z.css("input-placeholder"),popover:r.Z.css("datetimerangepicker-popover"),
resetButton:()=>d.Z.css(F||(F=N`&&&& { margin-left: auto; }`))},defaults:{format:"dd.mm.Y",columnRegexp:/^((?:offset-)?[a-z]+)(?:-)?(\d+)$/},errors:{
dateFromGreaterThanDateTo:"The property dateFrom is greater than the property dateTo.",firstGreaterThanSecond:"The first date of range is greater than the second date of range."},
lsi:()=>i.Common.Tools.merge({},i.Environment.Lsi.Bricks.calendar,i.Environment.Lsi.Forms.message,i.Environment.Lsi.Forms.datePicker)},propTypes:{
value:i.PropTypes.arrayOf(i.PropTypes.oneOfType([i.PropTypes.object,i.PropTypes.string])),dateFrom:i.PropTypes.oneOfType([i.PropTypes.object,i.PropTypes.string]),
dateTo:i.PropTypes.oneOfType([i.PropTypes.object,i.PropTypes.string]),format:i.PropTypes.string,country:i.PropTypes.string,beforeRangeMessage:i.PropTypes.any,afterRangeMessage:i.PropTypes.any,
...
allowUnspecifiedRange:!1,hideResetButton:!1,timeFromDefault:void 0,timeToDefault:void 0}),getInitialState(){this._isAllowedFromUnspecifiedRange=h.ZP.isAllowedFromUnspecifiedRange(this.props),
this._isAllowedToUnspecifiedRange=h.ZP.isAllowedToUnspecifiedRange(this.props),this._formattingValues={},this._setFormattingValues(this.props),this._allowTimeZoneAdjustment=!0
;let e=Array.isArray(this.props.value)&&this.props.value.length>1?this.props.value:null;e=this._parseDate(e);let t=null,o=null,s=null,u=null,r=E,n=E,a=this._getFromValue(e),l=this._getToValue(e)
...
i.Environment.EventListener.registerDateTime(this.getId(),this._change)},UNSAFE_componentWillReceiveProps(e){if(e.controlled){this._isAllowedFromUnspecifiedRange=h.ZP.isAllowedFromUnspecifiedRange(e),
this._isAllowedToUnspecifiedRange=h.ZP.isAllowedToUnspecifiedRange(e),this._setFormattingValues(e),this._setUpLimits(e),this._allowTimeZoneAdjustment=!0
...
let t=i.Common.Tools.cloneDateObject(this.state.toDisplayDate);t=h.ZP.increaseDate(t,void 0,1),e.toDisplayDate=t}this.setState({...e})}},toggle(e){
return this.isOpen()?this.close((()=>this._removeEvent(e))):this.open((()=>this._addEvent(e))),this},parseDate(e){let t;return Array.isArray(e)?(t=e.map((e=>this._parseDate(e))).filter((e=>!!e)),
...
this._allowTimeZoneAdjustment=!0;let t=this._getInnerState(this.props.value,"interface",!0);t.message=this.props.message,t.feedback=this.props.feedback,t.readOnly=this.props.readOnly,this.setState({
...t},e)},setValue_(e,t){this._allowTimeZoneAdjustment=!0,e=this._unspecifiedRangeValueToDate(e),e=this._getInitialValue(e);let o=this._validateDevProps(e,this.props.dateFrom,this.props.dateTo)
;if(o.valid)if(Array.isArray(e)&&e.length<2&&(e=null),this._checkRequired({value:e})){let o={...{feedback:"initial",message:null},...this._getInnerState(e,"interface",!0)}
;"function"==typeof this.props.onValidate?this._validateOnChange({value:e,event:null,component:this},t):this.setState({...o},t)}else"function"==typeof t&&t();else this.showError(o.error),
"function"==typeof t&&t()},setFeedback_(e,t,o,s){""===(o=this._unspecifiedRangeValueToDate(o))&&(o=null),this._allowTimeZoneAdjustment=!0,o=this._parseDate(o);let u={...this._getInnerState(o),
feedback:e,message:t};this.setState({...u},s)},getValue_(){let e;return e=this.state.value?this.state.value:null,e=this._parseDate(e),this._getOutcomingValue(e)},getInputWidth_(e){let t=null
;if(this.props.inputWidth&&!this._isSorXs())if(e&&e.dualInput){let e=this.props.inputWidth.replace(/[0-9]/g,"");t=parseInt(this.props.inputWidth)/2+e}else t=this.props.inputWidth;return t},
onChangeDefault_(e,t){
...
e._data&&this.state.activeInput!==e._data.activeInput&&(o.activeInput=e._data.activeInput),this.setState({...o})),this},onBlurDefault_(e){let t=e._data?e._data.value:e.value
;if(e.value=this._getOutcomingValue(t),this._checkRequired({value:e.value})&&!this.props.validateOnChange){e.required=this.props.required;let o=this.getBlurFeedback({...e,value:t});return o={
feedback:"initial",message:null,...o},"function"==typeof this.props.onChangeFeedback?this.props.onChangeFeedback({...o,component:this}):this.setState({...o}),this}return this},
setChangeFeedback__(e,t){this._allowTimeZoneAdjustment=!0;let o=this._getInitialValue(e.value);o=this._unspecifiedRangeValueToDate(o);let s=this._getInnerState(o);s.feedback=e.feedback,
s.message=e.message,this.setState({...s},t)},getInitialValue_(e){this._isAllowedFromUnspecifiedRange=h.ZP.isAllowedFromUnspecifiedRange(this.props),
this._isAllowedToUnspecifiedRange=h.ZP.isAllowedToUnspecifiedRange(this.props),this._formattingValues=this._formattingValues||{},this._setFormattingValues(this.props)
...
0===o&&this._isAllowedFromUnspecifiedRange&&e&&e.getTime()===h.d8.getTime()||1===o&&this._isAllowedToUnspecifiedRange&&e&&e.getTime()===h.fR.getTime()?e=null:"number"==typeof t&&"isoLocal"!==this._formattingValues.valueType&&(e=i.Common.Tools.adjustForTimezone(e,-e.getTimezoneOffset()/60,t)),
"iso"===this._formattingValues.valueType?e=h.ZP.getISO(e):"isoLocal"===this._formattingValues.valueType&&e&&(e=h.ZP.getISOLocal(e,this._formattingValues.timeZone))),e)
...
let{timeFrom:t,timeTo:o,show24:s}=h.ZP.setupLimits(e);this._timeFrom=t,this._timeTo=o,this._show24=s},_getInitialValue(e,t=this.props){let o=null;if(Array.isArray(e)){let s=(e,o)=>{
...
let t=this._formattingValues.timeFormat==U?"12:00":"00:00",o="00",s=E,u=this._formattingValues[e?"timeToDefault":"timeFromDefault"];if(u){let e=u
;this._formattingValues.timeFormat!=U||/AM|PM/.test(e)||(e=h.ZP.timeFormat24to12(e));let i=e.trim().split(" ");s=i[1],i=i[0].split(":"),t=i[0]+":"+(i[1]||"00"),o=i[2]}
return this._formattingValues.seconds&&(t+=":"+o),this._formattingValues.timeFormat==U&&(t+=" "+s),t},_parseDate(e,t,o=!0){let s=null,{parseDate:u,timeZone:i}=this._formattingValues,r=(e,s)=>{t=1===s
...
;if(o&&!s&&(s=this._getAutofilledTime(t)),s&&i instanceof Date){let e=this._parseTime(s);e&&(e.dayPart===E&&12===e.hours?e.hours-=12:e.dayPart===V&&e.hours<12&&(e.hours+=12),i.setHours(e.hours),
i.setMinutes(e.minutes),i.setSeconds(e.seconds))}}return i};return Array.isArray(e)?(s=e.map(r).filter((e=>!!e)),0===s.length&&(s=null),s=this._adjustTimeZone(s,i)):s=r(e,t?1:0),s},
_parseDateDefault(e){let{format:t,country:o}=this._formattingValues;return i.Common.Tools.parseDate(e,{format:t,country:o})},_parseTime(e){let t,{timeFormat:o}=this._formattingValues
...
let{format:t,country:o}=this._formattingValues,s=e instanceof Date?h.ZP.toISODateOnlyString(e):e;return i.Common.Tools.getDateString(s,{format:t,country:o})},_getFullDate(e,t,o){
let s=null,u=this._parseDate(e),i=this._parseTime(t);return u&&(i&&(i.dayPart===E&&12===i.hours?i.hours-=12:i.dayPart===V&&i.hours<12&&(i.hours+=12),u.setHours(i.hours),u.setMinutes(i.minutes),
u.setSeconds(i.seconds)),this.props.timeFormat==U?(o=o||i.dayPart,s=this._setDayPart(u,o)):s=u),s},_getDateFrom(e){return this._parseDate(e||this.props.dateFrom,!1,!1)},_getDateTo(e){
...
this._privateSetFeedback("initial",null,e.value,o))}return s&&o(),this},_validateDateResult(e,t){let o=e;if(e){let s=this._parseDate(e.value,t);s=this._getOutcomingValue(s)
;const u=this._getDateFromRange(this._formattingValues.dateFrom),i=this._getDateToRange(this._formattingValues.dateTo);if(e.value&&!s||(this._compareDates(s,u,"lesser")?(o.feedback="error",
o.message=this.getLsiItem(this._formattingValues.beforeRangeMessage)):this._compareDates(s,i,"greater")?(o.feedback="error",
...
o.message=this.getLsiItem(this.props.afterRangeMessage))}return o},_validateDevProps(e,t=this.props.dateFrom,o=this.props.dateTo){let s={valid:!0,error:null}
;const u=this._getDateFromRange(t),i=this._getDateToRange(o);return Array.isArray(e)&&2===e.length&&(this._compareDates(e[0],e[1],"greater")?(s.valid=!1,
s.error="firstGreaterThanSecond"):u&&i&&this._compareDates(u,i,"greater")&&(s.valid=!1,s.error="dateFromGreaterThanDateTo")),s},_getDateFromRange(e){return this._isAllowedFromUnspecifiedRange?h.d8:e},
_getDateToRange(e){return this._isAllowedToUnspecifiedRange?h.fR:e},_onOpen(e,t){let o,s=e?e.match(/to/i):void 0,u=this._isSorXs()?s?this._toPopover:this._fromPopover:this._popover
...
;t?t.close(e):"function"==typeof e&&e()},_close(e,t){e||this._removeEvent(),this.closeDefault((()=>this._onClose(t)))},_open(e,t){this._addEvent(),this.openDefault((()=>this._onOpen(e,t)))},
_change(e){this._onChangeFormat(e)},_onChangeFormat(e,t){
let o=void 0===e.format?this._formattingValues.format:e.format,s=void 0===e.country?this._formattingValues.country:e.country?e.country.toLowerCase():e.country;this._formattingValues.format=o,
this._formattingValues.country=s,this.setState({},t)},_toggleDayPart(e){let t={},o=this.state.fromDayPart,s=o==E?V:E,u=this.state.toDayPart,i=u==E?V:E,r=this.state.value?[...this.state.value]:null
;if(e){r=[this._setDayPart(this._getFromValue()||this.state.tempValue,o),this._setDayPart(this._getToValue(),i)],t=this._getInnerState(r,"input"),t.toDayPart=i}else{
r=[this._setDayPart(this._getFromValue()||this.state.tempValue,s),this._setDayPart(this._getToValue(),u)],t=this._getInnerState(r,"input"),t.fromDayPart=s}this.setState({...t})},_setDayPart(e,t){
if(t=(e=i.Common.Tools.cloneDateObject(e))?t||i.Common.Tools.getDayPart(e):null,e){let o=e.getHours();t===V?o<12&&e.setHours(o+12):t===E&&o>=12&&e.setHours(o-12)}return e},
...
this.isOpen()&&!this.isXs()&&i.Common.Tools.debounce((()=>{this.state.activeInput?this._onOpen(this.state.activeInput):this._onClose()}),500)()},_onCalendarViewChange(e){},_onChange(e){
e.component=this,
...
;this.state.tempValue&&(this._compareDates(t,this.state.tempValue,"greater")||this._compareDates(t,this.state.tempValue,"equals"))?(this.props.timeToDefault&&h.ZP.setTimeToDate(t,this.props.timeToDefault),
t=[this.state.tempValue,t],o=!0):(this.props.timeFromDefault&&h.ZP.setTimeToDate(t,this.props.timeFromDefault),t=[t]),e.value=this._getOutcomingValue(t),e._data.value=t,e._data.executeOnChange=o,
...
;r=this._setDayPart(r,o.dayPart);r=t?[this._getFromValue(),r]:[r,this._getToValue()],e.value=this._getOutcomingValue(r),e._data.value=r,e._data.executeOnChange=false,this.onChangeDefault(e)},
...
this.state.toTimeInputValue&&(s=this._getFullDate(o,this.state.toTimeInputValue),s&&this.props.timeFormat==U&&(s=this._setDayPart(s,this.state.toDayPart)))):(u.fromDateInputValue=o,
this.state.fromTimeInputValue&&(s=this._getFullDate(o,this.state.fromTimeInputValue)),s&&this.props.timeFormat==U&&(s=this._setDayPart(s,this.state.fromDayPart))),
s?t?(this.props.timeToDefault&&h.ZP.setTimeToDate(s,this.props.timeToDefault),u=this._getInnerState([this.state.value?this.state.value[0]:this.state.tempValue,s],"input",!0,!0),
u.toDateInputValue=e.value):(this.props.timeFromDefault&&h.ZP.setTimeToDate(s,this.props.timeFromDefault),u=this._getInnerState([s,this.state.value?this.state.value[1]:null],"input",!0),
...
;s=o&&Array.isArray(s)&&1===s.length?[null,s[0]]:s;let u,i=this._getInnerState(s,"input"),r="function"==typeof t;if(!i.value&&this.props.required&&this.state.value?u={feedback:"error",
message:this.props.requiredMessage||this.getLsiComponent("requiredMessage")}:(i.value||!i.value&&this.state.value)&&(u={feedback:"initial",message:null}),e._data.executeOnChange){if(e.value=i.value,
e.feedback=u&&u.feedback,e.message=u&&u.message,this.props.validateOnChange)r=!1,this._validateOnChange(e,!1,t);else if(this._checkRequired({value:e.value})){e.required=this.props.required
;let o=this.getChangeFeedback(e);r=!1,this.setState({...u,...i,...o},t)}}else r=!1,this.setState({...u,...i},t);r&&t()},_onCalendarChangeDefault(e,t){var o
;let s,u=e._data?e._data.value:e.value,i=this._getInnerState(u),r="function"==typeof t;if(!i.value&&(i.value||!this.state.value||u&&2!==u.length)||(s={feedback:"initial",message:null}),
i.tempValue?i.activeInput=this._isAllowedFromUnspecifiedRange&&i.tempValue.getTime()===h.d8.getTime()?"toDate":"fromTime":this._isAllowedToUnspecifiedRange&&i.value&&(null===(o=i.value[1])||void 0===o?void 0:o.getTime())===h.d8.getTime()&&(i.activeInput="toTime"),
e._data.executeOnChange){if(e={...e,value:i.value,feedback:s&&s.feedback,message:s&&s.message},this.props.validateOnChange)r=!1,this._validateOnChange(e,!1,t);else if(this._checkRequired({
value:e.value})){e.required=this.props.required;let o=this.getChangeFeedback(e);r=!1,this.setState({...s,...i,...o},t)}}else r=!1,this.setState({...s,...i},t);r&&t()},_onInputChangeDefault(e,t){
let o="function"==typeof t,s=e._data?e._data.value:e.value;if(e._data.executeOnChange){if(this.props.validateOnChange)o=!1,this._validateOnChange(e,!1,t);else if(this.shouldValidateRequired()){
this.props.required&&!s&&(e.feedback="error",e.message=this.props.requiredMessage||this.getLsiComponent("requiredMessage")),e.required=this.props.required;let u=this.getChangeFeedback({...e,value:s})
;o=!1,this.setState({...e._data.state,...u},t)}}else o=!1,this.setState({...e._data.state},t);o&&t()},_onClickUnspecifiedRange(e){let t,o={event:e,component:this,_data:{type:"calendar"}},s=!1
;this.state.tempValue?(t=[this.state.tempValue,h.fR],s=!0):t=[h.d8],o.value=this._getOutcomingValue(t),o._data.value=t,o._data.executeOnChange=s,
s&&"function"==typeof this.props.onChange?this.props.onChange(o):this.onChangeDefault(o)},_unspecifiedRangeValueToDate(e){
return h.ZP.unspecifiedRangeValueToDate(e,this._isAllowedFromUnspecifiedRange,this._isAllowedToUnspecifiedRange)},_onClickReset(e){let t={event:e,component:this,_data:{type:"calendar"}
...
m.fromDisplayDate=h.ZP.decreaseDate(r,void 0,1)):(m.fromDisplayDate=u,m.toDisplayDate=h.ZP.increaseDate(u,void 0,1)):u?(m.fromDisplayDate=u,
m.toDisplayDate=h.ZP.increaseDate(u,void 0,1)):r&&(m.toDisplayDate=r,m.toDisplayDate=h.ZP.decreaseDate(r,void 0,1))),
...
this._isAllowedFromUnspecifiedRange&&s.getTime()===h.d8.getTime()&&(s=this.state?this.state.fromDisplayDate:n),u=this._isSorXs()?s:new Date(s.getFullYear(),s.getMonth()+1,1),{fromDisplayDate:s,
...
;this._isSorXs()||(t=h.ZP.increaseDate(t,void 0,1)),this._onChange({value:this._getToday(),_data:{type:"calendar"}}),this.setState({fromDisplayDate:e,toDisplayDate:t})},_getWeeksInMonth(e){
let t=i.Common.Tools.cloneDateObject(e),o=i.Common.Tools.cloneDateObject(e);return t.setDate(1),o=h.ZP.increaseDate(o,void 0,1),o.setDate(0),
i.Common.Tools.getWeekNumber(o)-i.Common.Tools.getWeekNumber(t)+1},_onNextSelection(){
let e=h.ZP.increaseDate(this.state.fromDisplayDate,void 0,1),t=h.ZP.increaseDate(this.state.toDisplayDate,void 0,1);this.setState({fromDisplayDate:e,toDisplayDate:t})},_onPrevSelection(){
let e=h.ZP.decreaseDate(this.state.fromDisplayDate,void 0,1),t=h.ZP.decreaseDate(this.state.toDisplayDate,void 0,1);this.setState({fromDisplayDate:e,toDisplayDate:t})},_getInputType(e,t){
...
"function"==typeof this.props.onBlur?this.props.onBlur(e):this.onBlurDefault(e)};let u=null;if(this.state.tempValue&&!this._getToValue()){let t=this.state.tempValue,i=this.state.tempValue
;this._isAllowedFromUnspecifiedRange&&t.getTime()===h.d8.getTime()&&(i=new Date(Date.now())),u=[t,i],e.value=u,e._data.value=u,s={...s,value:u,...this._getInnerState(u)};let r=o;o=e=>{
"function"==typeof this.props.onChange&&this.props.onChange({...e,_data:{...e._data,type:"input"}}),r(e)}}else if(this.state.toDateInputValue&&!this.state.fromDateInputValue){
u=[this._parseDate(this.state.toDateInputValue),this._parseDate(this.state.toDateInputValue,!0)],u[0]&&u[1]||(u=null),e.value=u,e._data.value=u,s={...s,value:u,...this._getInnerState(u)};let t=o
;o=e=>{"function"==typeof this.props.onChange&&this.props.onChange(e),t(e)}
}else if(this.props.timeFormat==U&&this.state.value&&("error"===this.state.fromFeedback.feedback||"error"===this.state.toFeedback.feedback)){let e={...s,...this._getInnerState(this.state.value)}
;if("initial"===e.fromFeedback.feedback&&"initial"===e.toFeedback.feedback){let t=i.Common.Tools.getDayPart(this._getFromValue()),o=i.Common.Tools.getDayPart(this._getToValue());s={...e,fromDayPart:t,
toDayPart:o}}}this.setState(s,(()=>o(e)))}},_onKeyDown(e,t){let o={value:this.state.value,event:e,component:this};"function"==typeof t&&t(e,o),
...
this.props.seconds&&(s.className+=" "+this.getClassName("withSeconds")),this.props.timeFormat==U&&(s.className+=" "+this.getClassName("withEnglishFormat")),s},_getCalendarValue(e){
...
},_isFromUnspecified(){let e=this._parseDate(this.state.fromDateInputValue);return this._isAllowedFromUnspecifiedRange&&e&&e.getTime()===h.d8.getTime()},_isToUnspecified(){
let e=this._parseDate(this.state.toDateInputValue,!0);return this._isAllowedToUnspecifiedRange&&e&&e.getTime()===h.fR.getTime()},_getTimeProps(e){let t=!1
...
onChange:t=>this._onChange({...t,_data:{right:e,type:"time",changeType:t._data.changeType}}),format:this.props.timeFormat,seconds:this.props.seconds,step:this.props.timeStep,
...
value:this._getCalendarValue(!e&&t),dateFrom:this.props.dateFrom,dateTo:this.props.dateTo,hidden:!o,selectionMode:"range",onChange:e=>this._onChange({...e,_data:{right:t,type:"calendar"}}),
...
e.value=(t?this.state.toDateInputValue:this.state.fromDateInputValue)||"",e.icon=o?this.props.dateIcon:null,s&&(e.value=void 0,e.placeholder=this._isSorXs()?h.zU:this.getLsiValue("unspecifiedRange")),
...
e.mainAttrs.onClick=()=>this._onClickDayPart(t),o&&(e.disabled=!0,e.onFocus=void 0,e.mainAttrs.onClick=void 0),e},_getCalendarInputProps(e,t,o,s){let u
;"date"===e?u=this._getDatePlaceholder():"time"===e&&(u=this.props.placeholderTime);let r={onFocus:this.isReadOnly()||this.isComputedDisabled()?null:this._onFocus,onKeyDown:this._onKeyDown,
placeholder:u,mainAttrs:{},colorSchema:this.props.colorSchema};if(t){r.mainAttrs=this.props.inputAttrs,r.mainAttrs=i.Common.Tools.merge({autoComplete:"off"},r.mainAttrs),
""===r.mainAttrs.className&&delete r.mainAttrs.className,r.mainAttrs.tabIndex=this.isReadOnly()||this.isComputedDisabled()?void 0:"0",
r.mainAttrs.onFocus=this.isReadOnly()||this.isComputedDisabled()?null:this._onFocus;let t="error"===this.state.fromFeedback.feedback||"error"===this.state.toFeedback.feedback
;r.inputWidth=this._getInputWidth({dualInput:!0}),r.className+=" "+s,r.borderRadius=this.props.borderRadius,r.elevation=this.props.elevation,r.bgStyle=this.props.bgStyle,r.size=this.props.size,
o?(t?(r={...r,...this.state.toFeedback},r.mainAttrs.title=this.state.toFeedback.message):r.feedback=this.getFeedback(),r.className+=" "+this.getClassName("inputTo"),
"date"===e?(r.ref_=e=>this._toDateTextInput=e,
this.isOpen()&&"toDate"===this.state.activeInput&&(r.mainAttrs.className=this.getClassName("inputActive"))):"time"===e&&(r.ref_=e=>this._toTimeTextInput=e,
this.isOpen()&&"toTime"===this.state.activeInput&&(r.mainAttrs.className=this.getClassName("inputActive")))):(t?(r={...r,...this.state.fromFeedback},
r.mainAttrs.title=this.state.fromFeedback.message):r.feedback=this.getFeedback(),r.className+=" "+this.getClassName("inputFrom"),"date"===e?(r.ref_=e=>{this._textInput=e,this._fromDateTextInput=e},
this.isOpen()&&"fromDate"===this.state.activeInput&&(r.mainAttrs.className=this.getClassName("inputActive"))):"time"===e&&(r.ref_=e=>this._fromTimeTextInput=e,
this.isOpen()&&"fromTime"===this.state.activeInput&&(r.mainAttrs.className=this.getClassName("inputActive"))))}else o?(r.mainAttrs.title=this.state.toFeedback.message,
r.feedback=this.state.toFeedback.feedback,"date"===e&&(r.prefix=this.props.pickerLabelTo)):(r.mainAttrs.title=this.state.fromFeedback.message,r.feedback=this.state.fromFeedback.feedback,
"date"===e&&(r.prefix=this.props.pickerLabelFrom)),
("date"===e||"time"===e&&this.props.timeFormat==U)&&(r.mainAttrs.className=(r.mainAttrs.className?r.mainAttrs.className+" ":"")+this.getClassName("removeRightBorder")),r.size="m",r.ref_=e=>{
o?this._rightTextInput=e:this._leftTextInput=e};let n=o?this._isToUnspecified():this._isFromUnspecified()
;return"date"===e?r=this._getDateInputProps(r,o,t,n):"time"===e?r=this._getTimeInputProps(r,o,t,n):"dayPart"===e&&(r=this._getDayPartInputProps(r,o,n)),r},_getMainAttrs(){let e=this.getMainAttrs()
...
this.props.seconds&&(t.className+=" "+this.getClassName("withSeconds")),this.props.timeFormat==U&&(t.className+=" "+this.getClassName("withEnglishFormat")),
...
let s=this._isAllowedFromUnspecifiedRange&&t.getTime()===h.d8.getTime()?h.zU:this._getDateString(t),u=this._isAllowedToUnspecifiedRange&&o.getTime()===h.fR.getTime()?h.zU:this._getDateString(o),i=this._getTimeString(t,this.props,!0),r=this._getTimeString(o,this.props,!0),n=s,a=u
;s!==h.zU&&(n+=" "+i),u!==h.zU&&(a+=" "+r),s!==h.zU&&u!==h.zU&&this._compareDates(t,o,"equals")&&(n=""),e=n+(n?" - ":"")+a}else if(t){
let o=this._isAllowedFromUnspecifiedRange&&t.getTime()===h.d8.getTime()?h.zU:this._getDateString(t),s=this._getTimeString(t,this.props,!0);e=o===h.zU?o:o+" "+s}
return e=e?i.Common.Tools.wrapIfExists(i.Common.Fragment,Uu5g05.Utils.Element.create("span",{className:this.getClassName("inputText")
},this.props.innerLabel&&this.props.label?this.props.label+" ":null),Uu5g05.Utils.Element.create("span",{className:this.getClassName("inputValue")
},e)):i.Common.Tools.wrapIfExists(i.Common.Fragment,Uu5g05.Utils.Element.create("span",{className:this.getClassName("inputText")
},this.props.innerLabel&&this.props.label?this.props.label+" ":null),Uu5g05.Utils.Element.create("span",{className:this.getClassName("mainPlaceholder")+" "+this.getClassName("inputPlaceholder")
},this._getMainPlaceholder())),Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputContentWrapper")},Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.props.icon
}),e,this.isComputedDisabled()||this.isReadOnly()?null:Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.isOpen()?this.props.iconOpen:this.props.iconClosed}))},_getLabelBogus(e){
return Uu5g05.Utils.Element.create(m.Z,{key:"labelBogus",className:this.getClassName("labelBogus"),colWidth:e})},_getLabel(e,t,o){
let s,r=null,n=this.props.labelColWidth||this.getDefault("labelColWidth","UU5.Forms.InputMixin");if(this.props.inputWidth||this.props.labelWidth||(r=i.Common.Tools.buildColWidthClassName(n)),
this._isSorXs())if(this.props.labelFrom&&this.props.labelTo){if(o&&this.props.labelTo){let t=this._getLabelProps(e);t.className+=` ${this.getClassName("labelTo")}`,
s=Uu5g05.Utils.Element.create(m.Z,u()({},t,{tooltip:this.props.labelFrom?null:this.props.tooltip,content:this.props.labelTo,key:"toLabel"}))}else if(!o&&this.props.labelFrom){
let t=this._getLabelProps(e);t.className+=` ${this.getClassName("labelFrom")}`,s=Uu5g05.Utils.Element.create(m.Z,u()({},t,{content:this.props.labelFrom,key:"fromLabel"}))}
...
this._isAllowedFromUnspecifiedRange||this.state.tempValue&&!this.state.value||(t=!0),e.push(Uu5g05.Utils.Element.create(i.Bricks.Button,{content:this.getLsiComponent("unspecifiedRange"),
onClick:this._onClickUnspecifiedRange,disabled:t,key:"unspecifiedRange"}))}return this.props.hideResetButton||this._isSorXs()&&!(e.length<2)||e.push(Uu5g05.Utils.Element.create(i.Bricks.Button,{
content:this.getLsiComponent("reset"),onClick:this._onClickReset,key:"reset",className:this.getClassName("resetButton")})),e.length?Uu5g05.Utils.Element.create("div",{
className:this.getClassName("secondRow")},e):null},_normalRender(e,t){let o=this.getClassName("mainInput");this.isOpen()&&(o+=" "+this.getClassName("inputOpen")),o+=" "+t;let s=this.props.inputAttrs
;return s=i.Common.Tools.merge({autoComplete:"off"},s),""===s.className&&delete s.className,s.tabIndex=this.isReadOnly()||this.isComputedDisabled()?void 0:"0",s.onFocus=e=>this._onFocus({
value:this.state.value||null,event:e,component:this
}),Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("div",this._getMainInnerMainAttrs(!0),this._getLabel(e,!0,!1),this.getInputWrapper([Uu5g05.Utils.Element.create(a.Z,{
id:e,name:this.props.name||e,value:this._getInputValue(),placeholder:this._getMainPlaceholder(),mainAttrs:s,disabled:this.isComputedDisabled(),readonly:this.isReadOnly(),loading:this.isLoading(),
ref_:e=>this._textInput=e&&e.findDOMNode(),feedback:this.getFeedback(),borderRadius:this.props.borderRadius,elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth({
dualInput:!1}),key:"input",size:this.props.size,className:o,onKeyDown:this._onKeyDown,colorSchema:this.props.colorSchema})])),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("popoverWrapper")},Uu5g05.Utils.Element.create(i.Bricks.Popover,u()({},this._getPopoverProps(),{key:"popover"
}),this.isOpen()?i.Common.Tools.wrapIfExists(i.Common.Fragment,Uu5g05.Utils.Element.create("div",{className:this.getClassName("calendars")+" uu5-forms-input-m"},Uu5g05.Utils.Element.create("div",{
className:this.getClassName("firstRow")},Uu5g05.Utils.Element.create("div",{className:this.getClassName("fromWrapper")},Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputWrapper")
},Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps("date",!1,!1)),Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps("time",!1,!1)),12==this.props.timeFormat?Uu5g05.Utils.Element.create(a.Z,this._getCalendarInputProps("dayPart",!1,!1)):null),Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!1,!1))),Uu5g05.Utils.Element.create("span",{
className:this.getClassName("calendarSeparator")}),Uu5g05.Utils.Element.create("div",{className:this.getClassName("toWrapper")},Uu5g05.Utils.Element.create("div",{
className:this.getClassName("inputWrapper")
},Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps("date",!1,!0)),Uu5g05.Utils.Element.create(l.Z,this._getCalendarInputProps("time",!1,!0)),12==this.props.timeFormat?Uu5g05.Utils.Element.create(a.Z,this._getCalendarInputProps("dayPart",!1,!0)):null),Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!1,!0)))),this._getSecondRow()),this._getCustomContent()):null)))
},_smallRender(e){return Uu5g05.Utils.Element.create("div",this._getMainInnerMainAttrs(),Uu5g05.Utils.Element.create("div",{className:this.getClassName("fromWrapper"),key:"fromWrapper"
},Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputsWrapper")},this._getLabel(e,!1,!1),this.getInputWrapper([Uu5g05.Utils.Element.create(l.Z,u()({id:e
},this._getCalendarInputProps("date",!0,!1),{key:"dateInput"})),Uu5g05.Utils.Element.create(l.Z,u()({id:e+"-2"},this._getCalendarInputProps("time",!0,!1),{key:"timeInput"}))],null,{type:"fromWrapper"
})),Uu5g05.Utils.Element.create("div",{className:this.getClassName("popoverWrapper")
},Uu5g05.Utils.Element.create(i.Bricks.Popover,this._getPopoverProps(!0,!1),this.isOpen()?Uu5g05.Utils.Element.create("div",{className:this.getClassName("calendars")+" uu5-forms-input-m"
},Uu5g05.Utils.Element.create("div",{className:this.getClassName("firstRow")
},!this.state.activeInput||this.state.activeInput.match(/date/i)?Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!0,!1)):Uu5g05.Utils.Element.create(p.Z,this._getTimeProps(!1))),!this.state.activeInput||this.state.activeInput.match(/date/i)?this._getSecondRow():null):null))),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("toWrapper"),key:"toWrapper"},Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputsWrapper")
},this._getLabel(e,!1,!0),this.getInputWrapper([Uu5g05.Utils.Element.create(l.Z,u()({id:e+"-3"},this._getCalendarInputProps("date",!0,!0),{key:"dateInput"})),Uu5g05.Utils.Element.create(l.Z,u()({
id:e+"-4"},this._getCalendarInputProps("time",!0,!0),{key:"timeInput"}))],null,{type:"toWrapper"})),Uu5g05.Utils.Element.create("div",{className:this.getClassName("popoverWrapper")
},Uu5g05.Utils.Element.create(i.Bricks.Popover,this._getPopoverProps(!0,!0),this.isOpen()?Uu5g05.Utils.Element.create("div",{className:this.getClassName("calendars")+" uu5-forms-input-m"
},Uu5g05.Utils.Element.create("div",{className:this.getClassName("firstRow")
},!this.state.activeInput||this.state.activeInput.match(/date/i)?Uu5g05.Utils.Element.create(i.Bricks.Calendar,this._getCalendarProps(!0,!0)):Uu5g05.Utils.Element.create(p.Z,this._getTimeProps(!0))),!this.state.activeInput||this.state.activeInput.match(/date/i)?this._getSecondRow():null):null))))
},render(){let e=this.getId()+"-input",t=this.props.size?"uu5-forms-input-"+this.props.size:null,o=null;return o=this._isSorXs()?this._smallRender(e,t):this._normalRender(e,t),o}}));O=(0,f.ZP)(O,{
weekStartDay:"weekStartDay",timeFormat:"hourFormat"})},8421:(e,t,o)=>{"use strict";o.d(t,{$:()=>S});var s=o(5032),u=o.n(s),r=o(4434),n=(o(5617),
o(1256)),a=o(8379),l=o(1370),m=o(7054),p=o(8977),c=o(7530),h=o(8216),f=o(6062),d=o.n(f),g=o(4036),v=o.n(g),b=o(507),x=o.n(b),y=o(7892),k=o.n(y),_=o(1173),C=o.n(_),w=o(2464),T=o.n(w),D=o(4028),I={}
;I.styleTagTransform=T(),I.setAttributes=k(),I.insert=x(),I.domAPI=v(),I.insertStyleElement=C();d()(D.Z,I);D.Z&&D.Z.locals&&D.Z.locals
;const P=r.Common.Fragment||(e=>e.children),S=h.ZP.withContext(r.Common.VisualComponent.create({displayName:"File",
mixins:[r.Common.BaseMixin,r.Common.PureRenderMixin,r.Common.ElementaryMixin,r.Common.ContentMixin,r.Common.ColorSchemaMixin,p.ZP,m.Z],statics:{tagName:n.Z.name("File"),classNames:{
main:n.Z.css("file"),input:n.Z.css("file-input"),inputRow:n.Z.css("file-input-row"),inputInProgress:n.Z.css("file-input-in-progress"),placeholder:n.Z.css("file-placeholder"),icon:n.Z.css("file-icon"),
noIcon:n.Z.css("file-no-icon"),closeButton:n.Z.css("file-close-button"),closeIcon:n.Z.css("file-close-icon"),downloadButton:n.Z.css("file-download-button"),downloadIcon:n.Z.css("file-download-icon"),
item:n.Z.css("file-item"),itemNoIcon:n.Z.css("file-item-no-icon"),itemIcon:n.Z.css("file-item-icon"),itemName:n.Z.css("file-item-name"),itemSize:n.Z.css("file-item-size"),
itemMessage:n.Z.css("file-item-message"),itemMessageIcon:n.Z.css("file-item-message-icon"),itemInProgress:n.Z.css("file-item-in-progress"),progress:n.Z.css("file-progress"),
progressCurrent:n.Z.css("file-progress-current"),multiple:n.Z.css("file-multiple"),selected:n.Z.css("file-selected"),list:n.Z.css("file-list"),noValue:n.Z.css("file-no-value"),
indicateDrop:n.Z.css("file-indicate-drop")},lsi:()=>r.Common.Tools.merge({},r.Environment.Lsi.Forms.file,r.Environment.Lsi.Forms.message)},propTypes:{
...
;return this.props.selectedIcon||m||p.push(this.getClassName("itemNoIcon")),Uu5g05.Utils.Element.create("li",{key:t,className:p.join(" ")},m?this._renderItemError(l):Uu5g05.Utils.Element.create(P,{
key:"ok"},this.props.selectedIcon?Uu5g05.Utils.Element.create(r.Bricks.Icon,{icon:this.props.selectedIcon,
className:this.getClassName("itemIcon")+(null!=a&&a<1?" "+this.getClassName("itemInProgress"):"")}):null,null!=a&&a<1?Uu5g05.Utils.Element.create(r.Bricks.Text,{disabled:this.isDisabled(),content:s,
className:this.getClassName("itemName")+" "+this.getClassName("itemInProgress"),nestingLevel:"inline",colorSchema:"custom"}):Uu5g05.Utils.Element.create(r.Bricks.Link,u()({disabled:this.isDisabled(),
content:s,mainAttrs:{tabIndex:this.isDisabled()?null:"0"},className:this.getClassName("itemName")},this._getItemOpenLinkProps({url:n,file:o,name:s
}))),null!=a?this._renderProgress(a):null,null!=i?this._renderSize(i):null,(o||n)&&(null==a||a>=1)&&this.props.downloadIcon?Uu5g05.Utils.Element.create(r.Bricks.Link,u()({disabled:this.isDisabled(),
className:this.getClassName().downloadButton+" uu5-bricks-button uu5-bricks-button-transparent uu5-bricks-button-"+this.props.size,colorSchema:this.getColorSchema()},this._getItemDownloadLinkProps({
url:n,file:o,name:s}),{onFocus:this.isReadOnly()||this.isDisabled()?null:()=>this._onFocusExit(t),onBlur:this.isReadOnly()||this.isDisabled()?null:()=>this._onBlur()
}),Uu5g05.Utils.Element.create(r.Bricks.Icon,{className:this.getClassName().downloadIcon,icon:this.props.downloadIcon})):null),this.isReadOnly()?null:Uu5g05.Utils.Element.create(r.Bricks.Button,{
disabled:this.isDisabled(),className:this.getClassName().closeButton,bgStyle:"transparent",colorSchema:this.getColorSchema(),onClick:(t,o)=>{
...
onFocus:this.isReadOnly()||this.isDisabled()?null:()=>this._onFocusExit(t),onBlur:this.isReadOnly()||this.isDisabled()?null:()=>this._onBlur()},Uu5g05.Utils.Element.create(r.Bricks.Icon,{
className:this.getClassName().closeIcon,icon:this.props.closeIcon||this.constructor.getDefaultProps().closeIcon})))}));else{let{file:o,name:s,url:i,progress:n}=this._normalizeValueItem(t)
;e=null!=n&&n<1?Uu5g05.Utils.Element.create(r.Bricks.Text,{disabled:this.isDisabled(),content:s,className:this.getClassName("itemName")+" "+this.getClassName("itemInProgress"),nestingLevel:"inline",
colorSchema:"custom"}):Uu5g05.Utils.Element.create(r.Bricks.Link,u()({disabled:this.isDisabled(),content:s,mainAttrs:{tabIndex:this.isDisabled()?null:"0"},className:this.getClassName("itemName")
},this._getItemOpenLinkProps({url:i,file:o,name:s})))}return e},_normalizeValueItem(e){let t;return t=!e||e.file||e.url?e||{}:"[object File]"===e.toString()?{file:e,name:e.name,size:e.size
}:"object"==typeof e?e:{},t},_getItemDownloadLinkProps(e){let t;return t=e.file&&navigator.msSaveBlob?{onClick:()=>navigator.msSaveBlob(e.file,e.name)}:{target:"_blank",download:e.name,
...
this.isRendered()&&this.setState((o=>({authenticatedUrls:{...o.authenticatedUrls,[e]:t}})))})),o},_checkRequired(e){let t=!0;return this.props.required&&!e.value&&this.shouldValidateRequired()&&(t=!1,
this.setError(this.props.requiredMessage||this.getLsiComponent("requiredMessage"),e.value)),t},_resetInputValue(){this._inputVal&&(this._inputVal.value="")},_renderProgress(e){
return null!=e&&e>=0&&e<1?Uu5g05.Utils.Element.create("span",{key:"progress",className:this.getClassName("progress")},Uu5g05.Utils.Element.create("span",{
className:this.getClassName("progressCurrent"),style:{width:100*e+"%"}})):null},_renderSize(e){let t=["B","KB","MB","GB","TB","PB","EB","ZB","YB"];for(;e>=1e3&&t.length>1;)e/=1024,t.shift()
;return Uu5g05.Utils.Element.create(r.Bricks.Text,{key:"size",className:this.getClassName("itemSize")}," ("+Math.round(e*(e>=100?1:10))/(e>=100?1:10)+" "+t[0]+")")},_renderItemError(e){
return Uu5g05.Utils.Element.create(r.Bricks.Text,{key:"error",colorSchema:"danger"},Uu5g05.Utils.Element.create(r.Bricks.Icon,{icon:"mdi-alert",className:this.getClassName("itemMessageIcon")
}),Uu5g05.Utils.Element.create(l.Z,{inline:!0,className:this.getClassName("itemMessage"),content:e,colorSchema:"danger"}))},_getFileInput(){
return Uu5g05.Utils.Element.create("input",u()({},this.props.inputAttrs,{key:"fileinput",type:"file",id:this.getId()+"-file",multiple:this.props.multiple,onChange:this._onChange,
className:this.getClassName().input,ref:e=>this._inputVal=e}))},_getSingleInput(e){let t=this.props.inputAttrs||{};t.onFocus=this.isReadOnly()||this.isComputedDisabled()?null:()=>this._onFocus(),
t.onBlur=this.isReadOnly()||this.isComputedDisabled()?null:()=>this._onBlur(),t.tabIndex=this.isReadOnly()||this.isComputedDisabled()||this.isLoading()||null!==this.state.value?null:"0",
...
return this.props.elevation&&!this.props.multiple&&(g.className+=" "+c.Z.elevation+this.props.elevation,g.style={borderRadius:this.props.borderRadius}),
Uu5g05.Utils.Element.create(r.Bricks.Div,g,h?this._renderItemError(p):Uu5g05.Utils.Element.create(a.Z,{id:e,key:e,name:this.props.name||e,value:this._getFilesName(),className:d.join(" ")||void 0,
...
}),h?null:this._getFileInput(),h||null==m?null:this._renderProgress(m),h||null==n?null:this._renderSize(n),!h&&(s||o)&&(null==m||m>=1)&&this.props.downloadIcon?Uu5g05.Utils.Element.create(r.Bricks.Link,u()({
...
},this._getItemDownloadLinkProps({url:o,file:s,name:l}),{onFocus:this.isReadOnly()||this.isDisabled()?null:()=>this._onFocusExit(i),onBlur:this.isReadOnly()||this.isDisabled()?null:()=>this._onBlur()
}),Uu5g05.Utils.Element.create(r.Bricks.Icon,{className:this.getClassName().downloadIcon,icon:this.props.downloadIcon
})):null,this.isReadOnly()||null===this.state.value?null:Uu5g05.Utils.Element.create(r.Bricks.Button,{className:this.getClassName().closeButton,bgStyle:"transparent",colorSchema:this.getColorSchema(),
...
onBlur:this.isReadOnly()||this.isComputedDisabled()?null:()=>this._onBlur()},Uu5g05.Utils.Element.create(r.Bricks.Icon,{className:this.getClassName().closeIcon,
...
return this.props.elevation&&!this.props.multiple&&(u+=" "+c.Z.elevation+this.props.elevation),Uu5g05.Utils.Element.create(r.Bricks.Div,{className:u},Uu5g05.Utils.Element.create(a.Z,{id:e,key:e,
name:this.props.name||e,className:s.join(" ")||void 0,placeholder:o?this._getDndAreaPlaceholder():this.props.placeholder,multiple:this.props.multiple,mainAttrs:t,disabled:this.isComputedDisabled(),
readonly:this.isReadOnly(),loading:this.isLoading(),onItemClick:e=>{this.removeItem(e)},icon:this._getIcon(),iconClassName:this.getClassName("icon"),feedback:this.getFeedback(),
...
}),this.state.value&&(!Array.isArray(this.state.value)||this.state.value.length>0)?Uu5g05.Utils.Element.create("ul",{key:"list",className:this.getClassName().list
},this._getFilesName()):null,this._getFileInput())},_onFocus(){r.Environment.EventListener.addWindowEvent("keyup",this.getId(),(e=>{13===e.which&&!this.isDisabled()&&this._inputVal.click()}))},
_onFocusExit(e){r.Environment.EventListener.addWindowEvent("keyup",this.getId(),(t=>{
...
r.Environment.EventListener.removeWindowEvent("keyup",this.getId())},render(){let e=this.getId()+"-input";return Uu5g05.Utils.Element.create("div",u()({},this._getMainAttrs(),{id:this.getId()
}),this.getLabel(e),this.getInputWrapper(this.props.multiple?this._getMultipleInput(e):this._getSingleInput(e)))}}))},8216:(e,t,o)=>{"use strict";o.d(t,{ZP:()=>p,_y:()=>m,q3:()=>l})
;var s=o(5032),u=o.n(s),i=o(4434),r=o.n(i);const n="xs12 s5",a="xs12 s7",l=r().Common.Context.create();class m{static withContext(e){if(!r().Common.Context.create)return e
;let t=r().Common.Reference.forward(((t,o)=>Uu5g05.Utils.Element.create(l.Consumer,null,(({readOnly:s,values:i,labelColWidth:l,inputColWidth:m,labelAlignment:p})=>{let c=t.value
;return i&&void 0===c&&(c=i[t.name||t.id]),
void 0!==t.readOnly&&(s=t.readOnly),t.labelColWidth&&r().Forms.InputMixin.statics["UU5.Forms.InputMixin"].defaults.labelColWidth!==t.labelColWidth&&(l=t.labelColWidth),
t.inputColWidth&&r().Forms.InputMixin.statics["UU5.Forms.InputMixin"].defaults.inputColWidth!==t.inputColWidth&&(m=t.inputColWidth),void 0!==t.labelAlignment&&(p=t.labelAlignment),
Uu5g05.Utils.Element.create(e,u()({},t,{ref:o,readOnly:s,value:c,labelColWidth:l||n,inputColWidth:m||e.defaults&&e.defaults.inputColWidth||a,labelAlignment:p,_hasFormContext:!0}))}))))
;return t.isUu5PureComponent=!0,t.displayName=`forwardRef(${e.displayName||e.name||"Component"})`,t.tagName=e.tagName,t}}const p=m},5966:(e,t,o)=>{"use strict";o.d(t,{l:()=>y,Z:()=>k})
;var s=o(4434),u=o(1256),i=(o(5617),o(6154)),r=o(6062),n=o.n(r),a=o(4036),l=o.n(a),m=o(507),p=o.n(m),c=o(7892),h=o.n(c),f=o(1173),d=o.n(f),g=o(2464),v=o.n(g),b=o(5735),x={};x.styleTagTransform=v(),
x.setAttributes=h(),x.insert=p(),x.domAPI=l(),x.insertStyleElement=d();n()(b.Z,x);b.Z&&b.Z.locals&&b.Z.locals;const y=s.Common.VisualComponent.create({displayName:"Form",
mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ElementaryMixin,s.Common.SectionMixin,i.Z],statics:{tagName:u.Z.name("Form"),classNames:{main:u.Z.css("form")}},componentDidMount(){
...
let t=this.getInputs();return Object.keys(t).forEach((e=>{t[e].disable()})),this.eachFormControls((t=>t.disable(e))),this},enable_(e){let t=this.getInputs();return Object.keys(t).forEach((e=>{
t[e].enable()})),this.eachFormControls((t=>t.enable(e))),this},render(){return this.getFormChildren((()=>[this.getHeaderChild(),this.getChildren(),this.getFooterChild()]))}}),k=y},8583:(e,t,o)=>{
"use strict";o.r(t),o.d(t,{default:()=>n});var s=o(4434),u=o.n(s),i=(o(4723),o(526)),r={};for(const e in i)"default"!==e&&(r[e]=()=>i[e]);o.d(t,r);const n=i
;Object.defineProperties(u().Forms,Object.getOwnPropertyDescriptors(i))},4590:(e,t,o)=>{"use strict";o.d(t,{D:()=>r,n:()=>n});var s=o(4434),u=o.n(s),i=o(8081)
;const r=e=>(u().Common.Tools.warning("UU5.Forms.FormControls is deprecated! Use UU5.Forms.Controls instead."),
Uu5g05.Utils.Element.create(i.Z,e)),n="https://uuos9.plus4u.net/uu-bookkitg01-main/78462435-ed11ec379073476db0aa295ad6c00178/book/page"},1256:(e,t,o)=>{"use strict";o.d(t,{Z:()=>u});const s={
NAME:"UU5.Forms",CSS:"uu5-forms",name:e=>s.NAME+"."+e,css(){return Array.prototype.slice.call(arguments).map((e=>s.CSS+"-"+e)).join(" ")}},u=s},4723:(e,t,o)=>{"use strict";var s=o(4434),u=o.n(s)
;o(2851),o(1055);const i={message:{patternMessage:{en:"Enter a value that matches the specified format.",cs:"Zadejte hodnotu, která odpovídá požadovanému formátu.",
...
;var r=o(6062),n=o.n(r),a=o(4036),l=o.n(a),m=o(507),p=o.n(m),c=o(7892),h=o.n(c),f=o(1173),d=o.n(f),g=o(2464),v=o.n(g),b=o(3083),x={};x.styleTagTransform=v(),x.setAttributes=h(),x.insert=p(),
x.domAPI=l(),x.insertStyleElement=d();n()(b.Z,x);b.Z&&b.Z.locals&&b.Z.locals;u().Environment.addRuntimeLibrary({name:`${u().Environment.name}-forms`,version:"1.58.6",namespace:"UU5.Forms"}),
u().Environment.Lsi.Forms=i},526:(e,t,o)=>{e.exports={get FormControls(){return o(4590).D},get bookKitUrl(){return o(4590).n},get ChoiceMixin(){return o(7054).n},get FormMixin(){return o(6154).T},
get ControlsMixin(){return o(8887).b},get GroupMixin(){return o(1182).K},get INITIAL_FEEDBACK(){return o(8977).ry},get SUCCESS_FEEDBACK(){return o(8977).BI},get WARNING_FEEDBACK(){return o(8977).Ng},
get ERROR_FEEDBACK(){return o(8977).Hb},get LOADING_FEEDBACK(){return o(8977).LB},get InputMixin(){return o(8977).J5},get TextInputMixin(){return o(1939).Q},get Text(){return o(4328).x},
get TextArea(){return o(1755).K},get TextButton(){return o(2435).A},get TextIcon(){return o(2523).V},get DatePicker(){return o(5743).Mt},get Datepicker(){return o(5743).aN},get DateTimePicker(){
return o(4133).xZ},get Datetimepicker(){return o(4133).T4},get DateRangePicker(){return o(7321).D},get DateTimeRangePicker(){return o(4660).X},get Time(){return o(2438).q},get TimePicker(){
return o(1952).jI},get Timepicker(){return o(1952).LB},get File(){return o(8421).$},get Number(){return o(7443).M},get Checkbox(){return o(7791).X},get Checkboxes(){return o(1225).x},get Radios(){
return o(3588).T},get Select(){return o(901).P},get TagSelect(){return o(9656).O},get Slider(){return o(1046).i},get SwitchSelector(){return o(1226).K},get Form(){return o(5966).l},get PropsForm(){
return o(1518).h},get IconPicker(){return o(1408).$1},get Iconpicker(){return o(1408).Zz},get TriStateCheckbox(){return o(7123).I},get ColorPicker(){return o(5774).z},get ContextControls(){
return o(1936).Z},get ContextForm(){return o(138).t},get ContextHeader(){return o(2115).P},get ContextModal(){return o(8272).Y},get ContextSection(){return o(7252).N},get ContextFormConsumer(){
return o(6067).MR},get Context(){return o(8216)._y},get Controls(){return o(8081).Z}}},1408:(e,t,o)=>{"use strict";o.d(t,{$1:()=>M,Zz:()=>B})
;var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(8977),a=o(6047),l=o(8216),m=o(2851);let p,c,h,f,d,g,v=e=>e
;const b="\n  border: 1px solid transparent;\n  display: inline-block;\n  border-radius: 4px;\n  font-size: 20px;\n  width: 32px;\n  height: 32px;\n  overflow: hidden;\n  vertical-align: top;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  color: rgba(0,0,0,0.54);\n  right: auto;\n  top: auto;\n  position: relative;\n",x="\n  position: absolute;\n\n  .uu5-bricks-icon {\n    \n  right: auto;\n  top: auto;\n  position: relative;\n  padding: 0;\n  font-size: inherit;\n\n  }\n\n  .uu5-bricks-button-s & {\n    font-size: 14px;\n    left: 3px;\n    top: 3px;\n    bottom: 3px;\n  }\n\n  .uu5-bricks-button-m & {\n    font-size: 20px;\n    left: 3px;\n    top: 3px;\n    bottom: 3px;\n  }\n\n  .uu5-bricks-button-l & {\n    font-size: 26px;\n    left: 4px;\n    top: 4px;\n    bottom: 4px;\n  }\n\n  .uu5-bricks-button-xl & {\n    font-size: 34px;\n    left: 3px;\n    top: 3px;\n    bottom: 3px;\n  }\n",y={
rightWrapper:r.Z.css("right-wrapper"),right:r.Z.css("input-label-right"),main:r.Z.css("iconpicker"),open:r.Z.css("iconpicker-open"),openButton:r.Z.css("iconpicker-open-button"),
selectedIcon:r.Z.css("iconpicker-selected-icon"),selectedTag:()=>m.Z.css(p||(p=v`${0}`),x),selectedCustom:()=>m.Z.css(c||(c=v`
    ${0}
    display: flex;
    align-items: center;
  `),x),arrowIcon:r.Z.css("iconpicker-arrow-down-icon"),picker:r.Z.css("iconpicker-picker"),pickerBody:r.Z.css("iconpicker-body"),pickerHeader:r.Z.css("iconpicker-header"),
pickerFooter:r.Z.css("iconpicker-footer"),pickerItem:()=>r.Z.css("iconpicker-item")+" "+m.Z.css(h||(h=v`&& {${0}}`),b),pickerItemTag:(e,t)=>m.Z.css(f||(f=v`
    width: 30px;
    height: 30px;
    outline: none;
...
pickerItemCustom:()=>r.Z.css("iconpicker-item")+" "+m.Z.css(d||(d=v`&& {${0}}`),b),pickerItemSelected:r.Z.css("iconpicker-item-selected"),error:r.Z.css("iconpicker-error"),
multicategory:r.Z.css("iconpicker-multicategory"),searchInput:r.Z.css("iconpicker-search-input"),categoryInput:r.Z.css("iconpicker-category-input"),
removeSelection:r.Z.css("iconpicker-remove-selected-icon"),loading:r.Z.css("input-loading-icon"),screenSizeBehaviour:r.Z.css("screen-size-behaviour"),buttonError:r.Z.css("button-error"),
header:()=>m.Z.css(g||(g=v`
    display: flex;
  `))};var k=o(6062),_=o.n(k),C=o(4036),w=o.n(C),T=o(507),D=o.n(T),I=o(7892),P=o.n(I),S=o(1173),F=o.n(S),N=o(2464),E=o.n(N),V=o(9595),U={};U.styleTagTransform=E(),U.setAttributes=P(),U.insert=D(),
U.domAPI=w(),U.insertStyleElement=F();_()(V.Z,U);V.Z&&V.Z.locals&&V.Z.locals;let O={};const Z="all";function A(e,t){return t.find((t=>"object"==typeof t?e===t.code:t===e))}function R(e){let t=[]
;for(let o of e){o="object"==typeof o?o.icon:o;let e=o.split("-")[0];-1===t.indexOf(e)&&t.push(e)}return t}const M=l.ZP.withContext(i.Common.VisualComponent.create({displayName:"IconPicker",
mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ScreenSizeMixin,i.Common.ElementaryMixin,i.Common.ColorSchemaMixin,n.ZP],statics:{tagName:r.Z.name("IconPicker"),classNames:y,defaults:{
arrowIcon:"mdi-menu-down"},lsi:()=>i.Common.Tools.merge({},i.Environment.Lsi.Forms.iconPicker,i.Environment.Lsi.Forms.message)},propTypes:{disableBackdrop:i.PropTypes.bool,
...
;return this.props.selectedCategory===Z?t=Z:this.props.selectedCategory&&(t=this.props.categories.find((e=>e===this.props.selectedCategory))?this.props.selectedCategory:this.props.categories[0]),
...
this.setState({selectedCategory:e},(()=>this._open()))},_parseRules(e,t){let o=[];if(e)for(let s=0;s<e.length;s++){let u=e[s];if(u.selectorText&&u.style.content){
let e=u.selectorText.split(",").map((e=>{let o=!1;if(e.startsWith("."+t+"-")&&(e.endsWith(":before")||e.endsWith(":after")))o=e.substr(1).replace(/[^a-zA-Z0-9\-_].*/,"");else{
...
;(function(e,t){if(e===Z){let e=[];for(let o=0;o<t.length;o++){let s=t[o];if("object"==typeof s){let t=R(s.iconList);e=[...e,...t]}else e.push(s)}return e}let o=A(e,t)
;return"object"==typeof o?R(o.iconList):[o]})(this.state.selectedCategory,this.props.categories).forEach((o=>{if(O[o])this.state.icons[o]?this.setState({loading:!1,error:!1}):this.setState((e=>({
icons:{...e.icons,[o]:O[o]},loading:!1})));else{t=!0,0===this._calls.length&&this.setState({loading:!0,error:!1}),this._calls.push(o);let s=new XMLHttpRequest;s.onreadystatechange=()=>{
...
;u.textContent=s.responseText.replace(/@font-face\{[^}]*\}/g,""),document.head.appendChild(u);let i=(u.sheet||{}).cssRules,r=new Set(this._parseRules(i,o));O[o]=[...r],
0===this._calls.length&&this.setState({loading:!1,error:!1,icons:O},e)}else if(2==s.readyState&&s.status>=400){let t;this._calls.find(((e,s)=>(t=s,e==o))),this._calls.splice(t,1),
...
_getVirtualListItem(e){let t;if("iconpicker-remove-selection"==e.data){let e=this.getClassName("pickerItem")+" "+this.getClassName("removeSelection");t=Uu5g05.Utils.Element.create("span",{className:e,
...
"object"==typeof e.data)if(e.data.component){u+=" "+this.getClassName("pickerItemCustom");const i=e.data.component;t=Uu5g05.Utils.Element.create("span",{title:(o=e.data,s=e.data.category,
o.code?`${s}-${o.code}`:o.icon),className:u,tabIndex:0,onClick:this.isReadOnly()||this.isComputedDisabled()?null:t=>this._onClickIcon(e.data,t),onKeyDown:t=>this._onIconEnter(e.data,t)
},Uu5g05.Utils.Element.create(i,{icon:e.data.icon,state:e.data.state}))}else u+=" "+this.getClassName("pickerItemTag"),t=Uu5g05.Utils.Element.create(i.Bricks.Tag,{icon:e.data.icon,state:e.data.state,
tooltip:e.data.icon,className:u,mainAttrs:{tabIndex:0,onClick:this.isReadOnly()||this.isComputedDisabled()?null:t=>this._onClickIcon(e.data,t),onKeyDown:t=>this._onIconEnter(e.data,t)}
});else u=" "+this.getClassName("pickerItem"),t=Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:e.data,tooltip:e.data,className:u,mainAttrs:{tabIndex:0,
onClick:this.isReadOnly()||this.isComputedDisabled()?null:t=>this._onClickIcon(e.data,t),onKeyDown:t=>this._onIconEnter(e.data,t)}})}var o,s;return t},_getIconButtons(){let e
;if(this.state.error)e=Uu5g05.Utils.Element.create("div",{className:this.getClassName("error")
},this.getLsiComponent("loadError"));else if(this.isLoadingData())e=Uu5g05.Utils.Element.create(i.Bricks.Loading,null);else{let t=function(e,t,o,s){let u=[];s||u.push("iconpicker-remove-selection")
;let i=A(t,o);if("object"==typeof i&&i.iconList)u=[...u,...i.iconList.map((e=>e&&"object"==typeof e?{...e,category:i.code}:e))];else if(t===Z)for(let t of o){
let o="object"==typeof t&&t.iconList?t.iconList.map((e=>({...e,category:t.code}))):e[t];o&&(u=[...u,...o])}else{let o=e[t];o&&(u=[...u,...o])}let r=u.indexOf("plus4u5-plus4u")
;return r>-1&&u.splice(r,1),u}(this.state.icons,this.state.selectedCategory,this.props.categories,this.props.hideEmptyIcon);if(this.state.searchString){
...
e=t&&t.length?Uu5g05.Utils.Element.create(i.Bricks.VirtualList,{data:t,itemHeight:32,itemWidth:32,height:176,width:267,boxPadding:{left:4,right:4,top:1,bottom:1},
initialScrollTop:this.state.scrollPosition,ref_:e=>this._virtualList=e,item:this._getVirtualListItem}):this.state.searchString?Uu5g05.Utils.Element.create("div",{className:this.getClassName("error")
},this.getLsiComponent("noMatchError")):null}return e},_getDisplayedValue(){let e=(this.state.value&&"object"==typeof this.state.value?this.state.value:function(e,t){for(let o=0;o<t.length;o++){
let s=t[o];if("object"==typeof s){let t=s.iconList;for(let o=0;o<t.length;o++){let u=t[o],i=u.code;if(i&&(i=s.code+"-"+i,i===e))return u}}}}(this.state.value,this.props.categories))||this.state.value
;if(e&&!this.isLoading()){if("object"==typeof e){if(e.component){const t=e.component;return Uu5g05.Utils.Element.create("span",{className:this.getClassName("selectedCustom")
},Uu5g05.Utils.Element.create(t,{icon:e.icon,state:e.state}))}return Uu5g05.Utils.Element.create(i.Bricks.Tag,{icon:e.icon,state:e.state,className:this.getClassName("selectedTag")})}
return Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:e,className:this.getClassName("selectedIcon")})}return" "},_getButton(){let e=this.getClassName("openButton")
;if(this.state.disabled||this.state.readonly||!this.state.feedback||"initial"===this.state.feedback)this.props.colorSchema&&(e+=" color-schema-"+i.Environment.getColorSchema(this.props.colorSchema));else switch(this.state.feedback){
...
;return Uu5g05.Utils.Element.create(i.Bricks.Button,t,this._getDisplayedValue(),this.isLoading()?Uu5g05.Utils.Element.create(a.Z,{className:this.getClassName("loading"),id:this.getId()
}):Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.getDefault("arrowIcon"),className:this.getClassName("arrowIcon")}))},_getHeader(){let e=this.props.categories.map((e=>{
return"object"==typeof e?{content:(t=e.label,t&&"object"==typeof t&&!t.type?Uu5g05.Utils.Element.create(i.Bricks.Lsi,{lsi:e.label}):e.label),value:e.code}:{content:e,value:e};var t}))
;return this.props.categories.length>1&&e.unshift({content:this.getLsiComponent("selectAll"),value:Z}),Uu5g05.Utils.Element.create(i.Bricks.Row,{className:this.getClassName("header")
},this.props.hideSearchInput?null:Uu5g05.Utils.Element.create(i.Forms.TextIcon,{onChange:e=>{e.component.onChangeDefault(e),this._onChangeSearchString(e.value)},
...
}),this.props.categories.length>1?Uu5g05.Utils.Element.create(i.Forms.Select,{onChange:e=>{e.component.onChangeDefault(e);let t=e.value;this._changeCategory(t)},openToContent:!1,
value:this.state.selectedCategory,className:this.getClassName("categoryInput"),readOnly:this.isReadOnly(),disabled:this.isComputedDisabled(),size:"s",mainAttrs:{onClick:e=>{e.preventDefault(),
e.stopPropagation()}}},e.map(((e,t)=>Uu5g05.Utils.Element.create(i.Forms.Select.Option,{content:e.content,key:t,value:e.value})))):null)},_getPickerProps(){let e={};return e.ref_=e=>this._picker=e,
e.fitHeightToViewport=!0,e.forceRender=!0,e.controlled=!1,e.disableBackdrop=this.props.disableBackdrop,e.header=this._getHeader(),
...
this.props.categories.length>1&&(e.className+=" "+this.getClassName("multicategory")),this._shouldOpenToContent()&&(e.className+=" "+this.getClassName("screenSizeBehaviour")),e},render(){
return Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(this.getId()+"-_button"),this.getInputWrapper([Uu5g05.Utils.Element.create(i.Bricks.Div,{
className:this.getClassName("rightWrapper"),key:"button"},this._getButton()),Uu5g05.Utils.Element.create(i.Bricks.Popover,u()({},this._getPickerProps(),{key:"popover"
}),this.isOpen()?this._getIconButtons():null)]))}})),B=M},9036:(e,t,o)=>{"use strict";o.d(t,{Z:()=>m});var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),o(4260)),n=o(2810),a=o(1256)
;const l="text",m=i.Common.VisualComponent.create({displayName:"autocomplete-text-input",mixins:[i.Common.BaseMixin,i.Common.ElementaryMixin,i.Common.LsiMixin],statics:{
tagName:a.Z.name("AutocompleteTextInput")},propTypes:{value:i.PropTypes.string,placeholder:i.PropTypes.oneOfType([i.PropTypes.object,i.PropTypes.string]),
type:i.PropTypes.oneOf([l,"password","textarea"]),onChange:i.PropTypes.func,onBlur:i.PropTypes.func,onFocus:i.PropTypes.func,onKeyDown:i.PropTypes.func,icon:i.PropTypes.string,
loading:i.PropTypes.bool,rows:i.PropTypes.number,iconOnClick:i.PropTypes.func,autoResize:i.PropTypes.bool,maxRows:i.PropTypes.number,feedback:i.PropTypes.string,borderRadius:i.PropTypes.string,
...
colorSchema:i.PropTypes.string,open:i.PropTypes.bool,itemsListItems:i.PropTypes.arrayOf(i.PropTypes.shape({value:i.PropTypes.string,params:i.PropTypes.object,content:i.PropTypes.any})),
foundItemListItems:i.PropTypes.arrayOf(i.PropTypes.shape({value:i.PropTypes.string,params:i.PropTypes.object,content:i.PropTypes.any})),itemListProps:i.PropTypes.object,onClose:i.PropTypes.func,
onOpen:i.PropTypes.func,popoverLocation:i.PropTypes.oneOf(["local","portal"]),revealable:i.PropTypes.bool},getDefaultProps:()=>({value:"",placeholder:null,type:l,onChange:null,onBlur:null,
onFocus:null,onKeyDown:null,icon:null,loading:!1,rows:null,iconOnClick:null,autoResize:!1,maxRows:null,feedback:null,borderRadius:null,bgStyle:null,elevation:null,inputWidth:null,colorSchema:null,
open:!1,itemsListItems:void 0,foundItemListItems:void 0,itemListProps:void 0,onClose:void 0,onOpen:void 0,popoverLocation:"local",revealable:!1}),UNSAFE_componentWillMount(){this._hasFocus=!1},
componentWillUnmount(){this._removeEvent()},componentDidUpdate(e){!1===e.open&&!0===this.props.open?this._open():!0===e.open&&!1===this.props.open&&this._close()},focus(){this._textInput.focus()},
hasFocus(){return document.activeElement===this._textInput},getInput(){return this._textInput?this._textInput.getInput():null},_getEventPath(e){let t=[],o=e.target
...
t&&this.props.open&&(this.focus(),this._close())})),i.Environment.EventListener.addWindowEvent("keyup",this.getId(),(s=>{switch(s.which){case 13:if(t&&this.props.open&&t[o]){let u={
value:s.target.value,event:s,component:this};e.changeValue(t[o].props.value,s,(()=>this._onBlur(u)))}break;case 38:t&&(s.preventDefault(),o=o-1<-1?-1:o-1,
this.props.open&&(o>-1?t&&t.length&&t[o].focus():this.focus()));break;case 40:t&&(s.preventDefault(),this.props.open?(o=o+1>=t.length?t.length-1:o+1,setTimeout((()=>t&&t.length&&t[o].focus()))):(o=0,
this.props.onOpen((()=>{e=this._itemList,t=e.getRenderedChildren(),setTimeout((()=>t&&t.length&&t[o].focus()))}))))}}))},_onMouseDown(e){let t=this._findTarget(e),o={value:this.props.value,event:e,
component:this};t.input||t.picker||(this._close((()=>this._onBlur(o))),this._removeEvent())},_onInputWrapperResize(){"portal"===this.props.popoverLocation&&this.state.open&&this._open()},_addEvent(){
...
icon:this.props.icon,iconOnClick:this.props.iconOnClick,clickable:this.props.clickable,revealable:this.props.revealable,size:this.props.size}},render(){
return Uu5g05.Utils.Element.create(i.Common.Fragment,null,Uu5g05.Utils.Element.create(n.Z,this._getInputProps()),!this.props.itemsListItems||Array.isArray(this.props.itemsListItems)&&!this.props.itemsListItems.length?null:Uu5g05.Utils.Element.create(r.Z,u()({},this.props.itemListProps,{
ref:this._registerItemList,id:`${this.getId()}-item-list`}),this.props.foundItemListItems),"portal"===this.props.popoverLocation&&this.props.open?Uu5g05.Utils.Element.create(i.Bricks.ResizeObserver,{
onResize:this._onInputWrapperResize,key:"resizeObserver"}):null)}})},2851:(e,t,o)=>{"use strict";o.d(t,{Z:()=>u});var s=o(4434);const u=s.Common.Css.createCssModule("uu-forms")},1960:(e,t,o)=>{
"use strict";o.d(t,{ZP:()=>l,d8:()=>i,fR:()=>r,o1:()=>u,zU:()=>n});var s=o(4434);const u={timeFormat12:/^\d{1,2}:?\d{0,2} ?[PpAa]?\.?[Mm]?\.?$/,
timeFormat12seconds:/^\d{1,2}:?\d{0,2}:?\d{0,2} ?[PpAa]?\.?[Mm]?\.?$/,timeFormat24:/^\d{1,2}:?\d{0,2}$/,timeFormat24seconds:/^\d{1,2}:?\d{0,2}:?\d{0,2}$/}
;const i=new Date("1900-01-01T00:00:00"),r=new Date("2099-12-31T00:00:00"),n="∞",a={setupLimits:e=>{let t,o,u=!1;if("12"==e.format)t={hours:1,minutes:0,seconds:0},o={hours:25,minutes:0,seconds:0
};else{if(e.timeFrom){let o=e.timeFrom;t=s.Common.Tools.parseTime(o,24)}else t={hours:0,minutes:0,seconds:0};if(e.timeTo){let t=e.timeTo;o=s.Common.Tools.parseTime(t,24)
}else o=e.show24&&"12"!=e.format?{hours:24,minutes:0,seconds:0}:{hours:23,minutes:59,seconds:59};a.isDefaultLimit(t,o)&&e.show24&&(u=!0)}return{timeFrom:t,timeTo:o,show24:u}},
isDefaultLimit:(e,t)=>0===e.hours&&0===e.minutes&&0===e.seconds&&24===t.hours&&0===t.minutes&&0===t.seconds,validateLimits:(e,t,o)=>{let s=!0;if(e){e=60*e.hours*60+60*e.minutes+e.seconds
...
setTimeToDate(e,t){/(AM|PM)$/.test(t)&&(t=a.timeFormat12to24(t));let o=t.split(":");e.setHours(o[0]),e.setMinutes(o[1]||0),e.setSeconds(o[2]||0)}},l=a},4260:(e,t,o)=>{"use strict";o.d(t,{Z:()=>x})
;var s=o(4434),u=o(1256),i=o(6062),r=o.n(i),n=o(4036),a=o.n(n),l=o(507),m=o.n(l),p=o(7892),c=o.n(p),h=o(1173),f=o.n(h),d=o(2464),g=o.n(d),v=o(2834),b={};b.styleTagTransform=g(),b.setAttributes=c(),
b.insert=m(),b.domAPI=a(),b.insertStyleElement=f();r()(v.Z,b);v.Z&&v.Z.locals&&v.Z.locals;const x=s.Common.VisualComponent.create({displayName:"item-list",
mixins:[s.Common.BaseMixin,s.Common.ElementaryMixin,s.Common.SectionMixin],statics:{tagName:u.Z.name("ItemList"),classNames:{main:u.Z.css("item-list"),header:u.Z.css("item-list-header"),
body:u.Z.css("item-list-body"),footer:u.Z.css("item-list-footer"),selectedItem:u.Z.css("item-list-selected uu5-common-bg")},defaults:{childTagName:"UU5.Forms.Select.Option"}},propTypes:{
allowTags:s.PropTypes.arrayOf(s.PropTypes.string),location:s.PropTypes.oneOf(["local","portal"])},getDefaultProps:function(){return{allowTags:[],location:"local"}},changeValue(e,t,o){let s={value:e,
...
let t=s.Common.Tools.getChildTagName(e),o=this.getDefault().childTagName,u=this.props.allowTags.concat(o).indexOf(t)>-1
...
mixinName:"UU5.Common.BaseMixin"})),u},expandChildProps_(e,t){var o={...e.props};this.props.value&&this.props.value.find((t=>t===e.props.value))&&(o.selected=!0,
...
;return(null===(e=this._popover)||void 0===e?void 0:e.getRenderedChildrenNameList())||{}},_getHeader(){let e;return this.props.header&&(e=Uu5g05.Utils.Element.create("div",{
className:this.getClassName().header},this.getHeader())),e},_getFooter(){let e;return this.props.footer&&(e=Uu5g05.Utils.Element.create("div",{className:this.getClassName().footer},this.getFooter())),
e},_getMainProps(){let e=this.getMainPropsToPass();return e.ref_=e=>this._popover=e,e.disableBackdrop=!0,e.shown=!this.isHidden(),e.fitHeightToViewport=!0,e.forceRender=!0,e.header=this.getHeader(),
e.footer=this._getFooter(),e.location=this.props.location,e},render:function(){return Uu5g05.Utils.Element.create(s.Bricks.Popover,this._getMainProps(),this.getChildren())}})},8379:(e,t,o)=>{
"use strict";o.d(t,{Z:()=>_})
;var s=o(4434),u=(o(5617),o(1256)),i=o(7530),r=o(2851),n=o(6047),a=o(6062),l=o.n(a),m=o(4036),p=o.n(m),c=o(507),h=o.n(c),f=o(7892),d=o.n(f),g=o(1173),v=o.n(g),b=o(2464),x=o.n(b),y=o(4868),k={}
;k.styleTagTransform=x(),k.setAttributes=d(),k.insert=h(),k.domAPI=p(),k.insertStyleElement=v();l()(y.Z,k);y.Z&&y.Z.locals&&y.Z.locals;const _=s.Common.VisualComponent.create({
displayName:"items-input",mixins:[s.Common.BaseMixin,s.Common.ElementaryMixin,s.Common.LsiMixin],statics:{tagName:u.Z.name("ItemsInput"),classNames:{main:u.Z.css("items-input"),
loading:u.Z.css("input-loading-icon"),value:u.Z.css("input-form-item-value"),item:u.Z.css("input-form-item items-input-item uu5-common-bg color-schema-blue"),link:u.Z.css("items-input-item-link"),
icon:u.Z.css("items-input-item-icon"),placeholder:u.Z.css("input-placeholder"),inputError:u.Z.css("input-error")}},propTypes:{
...
s.Environment.getColorSchema("blue")},changeValue(e,t,o){"function"==typeof this.props.onChange&&this.props.onChange({value:e,event:t,component:this,setStateCallback:o})},_getPlaceholder(){let e
...
_getFeedbackIcon(){return this.props.loading?Uu5g05.Utils.Element.create(n.Z,{className:this.getClassName("loading"),id:this.getId()}):this.props.icon?Uu5g05.Utils.Element.create(s.Bricks.Icon,{
icon:this.props.icon,className:this.props.iconClassName}):null},_getItems(){let e=this.props.value
;return e=this.props.multiple&&this.props.value&&this.props.value instanceof Array?this.props.value.map(((e,t)=>Uu5g05.Utils.Element.create(s.Bricks.Span,{className:this.getClassName("item"),key:t
},s.Common.Children.toArray(e),!this.props.readonly&&Uu5g05.Utils.Element.create(s.Bricks.Link,{className:this.getClassName("link"),onClick:(o,s)=>{s.stopPropagation(),
!this.props.disabled&&this.props.onItemClick({component:this,event:s,value:e,index:t})}},Uu5g05.Utils.Element.create(s.Bricks.Icon,{icon:"mdi-close",className:this.getClassName("icon")
}))))):s.Common.Children.toArray(this.props.value),this.props.value.length<1&&(e=this._getPlaceholder()),e},_getInputWidth(){return"auto"===this.props.inputWidth?null:this.props.inputWidth},
...
;case"error":e.className+=" color-schema-"+s.Environment.getColorSchema("danger"),e.className+=" "+this.getClassName("inputError")}return e.style={...e.style,borderRadius:this.props.borderRadius},
"filled"!==this.props.bgStyle&&"transparent"!==this.props.bgStyle||(e.className+=` ${i.Z.focus}`),this.props.elevation&&(e.className+=" "+i.Z.elevation+this.props.elevation),
this.props.bgStyle?e.className+=" "+i.Z[this.props.bgStyle]:["success","warning","error"].indexOf(this.props.feedback)>-1&&(e.className+=" "+i.Z.outline,
e.className+=" "+r.Z.css("\n          &&&& {\n            background-color: #FFFFFF;\n          }\n        ")),this.props.inputWidth&&(e=s.Common.Tools.mergeDeep(e,{style:{width:this._getInputWidth()}
})),e},render:function(){let e=this.getClassName().value;return this.props.value.length<1&&(e+=" "+this.getClassName().placeholder),
Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("span",{className:e},this._getItems()),this._getFeedbackIcon())}})},2196:(e,t,o)=>{"use strict";o.d(t,{Z:()=>x})
;var s=o(4434),u=o(1256),i=(o(5853),o(6062)),r=o.n(i),n=o(4036),a=o.n(n),l=o(507),m=o.n(l),p=o(7892),c=o.n(p),h=o(1173),f=o.n(h),d=o(2464),g=o.n(d),v=o(4593),b={};b.styleTagTransform=g(),
b.setAttributes=c(),b.insert=m(),b.domAPI=a(),b.insertStyleElement=f();r()(v.Z,b);v.Z&&v.Z.locals&&v.Z.locals;const x=s.Common.VisualComponent.create({displayName:"label",
mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ContentMixin,s.Common.LsiMixin,s.Common.ColorSchemaMixin],statics:{tagName:u.Z.name("Label"),classNames:{main:u.Z.css("label"),
labelContent:u.Z.css("label-content"),required:u.Z.css("label-required"),tooltip:u.Z.css("label-tooltip"),tooltipWrapper:u.Z.css("label-tooltip-wrapper"),withWidth:u.Z.css("with-label-width")}},
propTypes:{for:s.PropTypes.string,required:s.PropTypes.bool,width:s.PropTypes.string,tooltipIcon:s.PropTypes.string},getDefaultProps:()=>({for:null,required:!1,width:null,
...
return"auto"===this.props.width?null:this.props.width},_getTooltip(){let e,t=this.getTooltip();return t&&(e=this.props.colorSchema?Uu5g05.Utils.Element.create(s.Bricks.Text,{
colorSchema:this.props.colorSchema,className:this.getClassName("tooltipWrapper")},Uu5g05.Utils.Element.create(s.Bricks.Icon,{tooltip:t,icon:this.props.tooltipIcon,
className:this.getClassName("tooltip")})):Uu5g05.Utils.Element.create(s.Bricks.Icon,{tooltip:t,icon:this.props.tooltipIcon,className:this.getClassName("tooltip")})),e},_getMainAttrs(){
let e=this.getMainAttrs(),t={};return this.props.for&&(t.htmlFor=this.props.for),this.props.colWidth&&(e.className+=" "+this.props.colWidth),
this.props.required&&(e.className+=" "+this.getClassName("required")),this.props.width&&(e.className+=" "+this.getClassName("withWidth"),e.style={width:this._getLabelWidth()}),{mainAttrs:e,
labelAttrs:t}},render(){const{mainAttrs:e,labelAttrs:t}=this._getMainAttrs()
;return Uu5g05.Utils.Element.create(s.Bricks.Div,e,Uu5g05.Utils.Element.create("label",t,s.Common.Tools.wrapIfExists(s.Common.Fragment,Uu5g05.Utils.Element.create("span",{
className:this.getClassName("labelContent")},this.getChildren()),this._getTooltip())))}})},6047:(e,t,o)=>{"use strict";o.d(t,{Z:()=>s});const s=e=>Uu5g05.Utils.Element.create("span",{
className:e.className},Uu5g05.Utils.Element.create("svg",{width:"24",height:"24",viewBox:"0 0 100 100",version:"1.1",xmlns:"http://www.w3.org/2000/svg"},Uu5g05.Utils.Element.create("defs",{key:"defs"
},Uu5g05.Utils.Element.create("linearGradient",{key:"gradient1",id:"gradient1_"+e.id,x1:"0",y1:"0",x2:"1",y2:"1"},Uu5g05.Utils.Element.create("stop",{key:"stop1",offset:"0%",
stopColor:"rgba(0, 0, 0, 0)"}),Uu5g05.Utils.Element.create("stop",{key:"stop2",offset:"100%",stopColor:"rgba(0, 0, 0, 0.33)"})),Uu5g05.Utils.Element.create("linearGradient",{key:"gradient2",
id:"gradient2_"+e.id,x1:"1",y1:"0",x2:"0",y2:"1"},Uu5g05.Utils.Element.create("stop",{key:"stop1",offset:"0%",stopColor:"rgba(0, 0, 0, 0.33)"}),Uu5g05.Utils.Element.create("stop",{key:"stop2",
offset:"100%",stopColor:"rgba(0, 0, 0, 0.66)"})),Uu5g05.Utils.Element.create("linearGradient",{key:"gradient3",id:"gradient3_"+e.id,x1:"1",y1:"1",x2:"0",y2:"0"},Uu5g05.Utils.Element.create("stop",{
key:"stop1",offset:"0%",stopColor:"rgba(0, 0, 0, 0.66)"}),Uu5g05.Utils.Element.create("stop",{key:"stop2",offset:"100%",stopColor:"rgba(0, 0, 0, 1)"}))),Uu5g05.Utils.Element.create("path",{
key:"path1",d:"M50 10 a40 40 0 0 1 40 40",fill:"none",
stroke:(navigator.userAgent.match("Safari")&&!navigator.userAgent.match("Chrome/")?`url(${location.href.replace(/#.*/,"")}`:"url(")+"#gradient1_"+e.id+")",strokeWidth:"20"
}),Uu5g05.Utils.Element.create("path",{key:"path2",d:"M90 50 a40 40 0 0 1 -40 40",fill:"none",
stroke:(navigator.userAgent.match("Safari")&&!navigator.userAgent.match("Chrome/")?`url(${location.href.replace(/#.*/,"")}`:"url(")+"#gradient2_"+e.id+")",strokeWidth:"20"
}),Uu5g05.Utils.Element.create("path",{key:"path3",d:"M50 90 a40 40 0 0 1 -40 -40",fill:"none",
stroke:(navigator.userAgent.match("Safari")&&!navigator.userAgent.match("Chrome/")?`url(${location.href.replace(/#.*/,"")}`:"url(")+"#gradient3_"+e.id+")",strokeWidth:"20"})))},1370:(e,t,o)=>{
"use strict";o.d(t,{Z:()=>D})
;var s=o(4434),u=(o(5617),o(1256)),i=o(2851),r=o(6062),n=o.n(r),a=o(4036),l=o.n(a),m=o(507),p=o.n(m),c=o(7892),h=o.n(c),f=o(1173),d=o.n(f),g=o(2464),v=o.n(g),b=o(4602),x={};x.styleTagTransform=v(),
x.setAttributes=h(),x.insert=p(),x.domAPI=l(),x.insertStyleElement=d();n()(b.Z,x);b.Z&&b.Z.locals&&b.Z.locals;let y,k,_,C=e=>e;const w="position: static; visibility: visible; bottom: auto;"
;let T=i.Z.keyframes(y||(y=C`100% {${0}}`),w);const D=s.Common.VisualComponent.create({displayName:"message",
mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ContentMixin,s.Common.ColorSchemaMixin],statics:{tagName:u.Z.name("Message"),classNames:{main:()=>{let e=u.Z.css("message"),t=!0
;if(navigator.userAgent.match("Safari")&&!navigator.userAgent.match("Chrome/")){parseFloat(navigator.userAgent.toLowerCase().split("version/")[1]||14)<14&&(t=!1)}return e+=t?" "+i.Z.css(k||(k=C`
              position: absolute;
              visibility: hidden;
              bottom: 0;
              animation: ${0} 200ms step-end both;
            `),T):" "+i.Z.css(_||(_=C`${0}`),w),e}}},shouldComponentUpdate_(e,t){let o=!1;return e.content===this.props.content&&e.colorSchema===this.props.colorSchema||(o=!0),o},
_getLabel:e=>e&&"object"==typeof e&&!e.type?Uu5g05.Utils.Element.create(s.Bricks.Lsi,{lsi:e}):e,_getMainPropsToPass(){let e=this.getMainPropsToPass()
;return this.props.colorSchema&&(e.className+=" uu5-common-text"),e.content=this._getLabel(e.content||this.getChildren()),e},render:function(){let e=this.props.inline?s.Bricks.Span:s.Bricks.Div
;return Uu5g05.Utils.Element.create(e,this._getMainPropsToPass())}})},2810:(e,t,o)=>{"use strict";o.d(t,{Z:()=>N});var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),
o(1256)),n=o(7530),a=o(2851),l=o(6047),m=o(2196),p=o(6062),c=o.n(p),h=o(4036),f=o.n(h),d=o(507),g=o.n(d),v=o(7892),b=o.n(v),x=o(1173),y=o.n(x),k=o(2464),_=o.n(k),C=o(6448),w={}
;w.styleTagTransform=_(),w.setAttributes=b(),w.insert=g(),w.domAPI=f(),w.insertStyleElement=y();c()(C.Z,w);C.Z&&C.Z.locals&&C.Z.locals;const T="text",D="password",I="textarea",P={s:{top:3,bottom:5},
m:{top:6,bottom:6},l:{top:9,bottom:10},xl:{top:11,bottom:13}},S={s:12,m:14,l:16,xl:18},F={s:24,m:32,l:40,xl:48},N=i.Common.VisualComponent.create({displayName:"text-input",
mixins:[i.Common.BaseMixin,i.Common.ElementaryMixin,i.Common.LsiMixin],statics:{tagName:r.Z.name("TextInput"),classNames:{main:r.Z.css("text-input"),loading:r.Z.css("input-loading-icon"),
item:r.Z.css("input-form-item"),text:r.Z.css("input-form-item-text"),textarea:r.Z.css("input-form-item-textarea"),hiddenDiv:r.Z.css("input-hidden-div"),hiddenTextarea:r.Z.css("input-hidden-textarea"),
autoResizeTextarea:r.Z.css("input-auto-resize-textarea"),iconLink:r.Z.css("text-icon-link"),iconLinkReadOnly:r.Z.css("text-icon-link-read-only"),inputError:r.Z.css("input-error"),
revealableInput:r.Z.css("text-input-revealable"),revealButton:r.Z.css("text-input-reveal-button"),revealIcon:r.Z.css("text-input-reveal-icon"),inputWithPrefix:(e,t)=>{let o=[];if(e.prefix){
let s=t.prefixWidth;e.icon&&(s+=F[e.size]),s>0&&o.push(`padding-left: ${s}px;`)}return a.Z.css(`\n            &&&&& {\n              ${o.join(" ")}\n            }\n          `)},prefix:e=>{let t=0,o=8
;return e.icon&&(t+=F[e.size],
o=2),a.Z.css(`\n            display: inline-block;\n            position: absolute;\n            height: 100%;\n            pointer-events: none;\n            white-space: pre;\n            left: ${t}px;\n\n            &&&& {\n              padding-top: ${P[e.size].top};\n              padding-bottom: ${P[e.size].bottom};\n              padding-left: ${o}px;\n              padding-right: ${o}px;\n            }\n          `)
},suffix:(e,t)=>{
let o=["\n              display: inline-block;\n              position: absolute;\n              height: 100%;\n              right: 0;\n              overflow: hidden;\n              text-overflow: ellipsis;\n              pointer-events: none;\n              white-space: pre;\n\n              && {\n                text-align: left;\n              }\n            "],s=t.assumedValueWidth+t.prefixWidth
;return e.icon&&(s+=F[e.size]),
o.push(`\n            left: ${s}px;\n\n            &&&& {\n              padding-top: ${P[e.size].top};\n              padding-bottom: ${P[e.size].bottom};\n              padding-left: 1px;\n              padding-right: 6px;\n            }\n          `),
a.Z.css(o.join(" "))},withIcon:r.Z.css("input-with-icon")}},propTypes:{value:i.PropTypes.string,placeholder:i.PropTypes.oneOfType([i.PropTypes.object,i.PropTypes.string]),
type:i.PropTypes.oneOf([T,D,I]),onChange:i.PropTypes.func,onBlur:i.PropTypes.func,onFocus:i.PropTypes.func,onKeyDown:i.PropTypes.func,icon:i.PropTypes.string,loading:i.PropTypes.bool,
...
placeholder:null,type:T,onChange:null,onBlur:null,onFocus:null,onKeyDown:null,icon:null,loading:!1,rows:null,iconOnClick:null,autoResize:!1,maxRows:null,feedback:null,borderRadius:null,bgStyle:null,
...
this._suffix&&this._textInput&&(e.assumedValueWidth=i.Common.Tools.calculateTextWidth(this._textInput.value,{fontSize:`${S[this.props.size]}px`,whiteSpace:"pre"})),
e.prefixWidth===this.state.prefixWidth&&e.assumedValueWidth===this.state.assumedValueWidth||this.setState({...e})},_getPlaceholder(){let e
;return this.props.placeholder&&("string"==typeof this.props.placeholder?e=this.props.placeholder:"object"==typeof this.props.placeholder&&(e=this.getLsiItem(this.props.placeholder))),e},
...
let e,t=this.getClassName().item;this.props.type===T||this.props.type===D?t+=" "+this.getClassName().text:this.props.type===I&&(t+=" "+this.getClassName().textarea),
this.props.bgStyle?(t+=" "+n.Z[this.props.bgStyle],
"filled"!==this.props.bgStyle&&"transparent"!==this.props.bgStyle||(t+=" "+n.Z.focus)):["success","warning","error"].indexOf(this.props.feedback)>-1&&(t+=" "+n.Z.outline,
t+=" "+a.Z.css("\n          &&& {\n            background-color: #FFFFFF;\n          }\n        ")),this.props.elevation&&(t+=" "+n.Z.elevation+this.props.elevation)
...
tabIndex:this.props.readonly?"-1":void 0,ref:e=>this._textInput=e,style:{...(o||{}).style,borderRadius:this.props.borderRadius}};if(o&&(r=i.Common.Tools.merge(r,o)),
this.props.type===T||this.props.type===D)r.className+=" "+this.getClassName("inputWithPrefix"),
e=Uu5g05.Utils.Element.create("input",r);else if(this.props.type===I)if(this.props.autoResize||this.props.maxRows){let t={borderRadius:this.props.borderRadius,maxHeight:this._getMaxHeight(),
height:this.state.height,overflow:this.state.autoResizeOverflow?this.state.autoResizeOverflow:"hidden"};e=[Uu5g05.Utils.Element.create("textarea",u()({key:"textarea"},r,{rows:this.props.rows,style:t
})),this._createHiddenTextarea(r.className,this.props.value)]}else e=Uu5g05.Utils.Element.create("textarea",u()({},r,{rows:this.props.rows}));return e},_getFeedbackIcon(){let e
;if(this.props.loading)e=Uu5g05.Utils.Element.create(l.Z,{className:this.getClassName("loading"),id:this.getId()});else if(this.props.clickable){let t=this.getClassName("iconLink")
;this.props.readonly&&(t+=" "+this.getClassName("iconLinkReadOnly")),e=Uu5g05.Utils.Element.create(i.Bricks.Link,{className:t,onClick:(e,t)=>{t.stopPropagation(),this.props.iconOnClick()},mainAttrs:{
tabIndex:this.props.clickable?0:null,onKeyDown:e=>{13===(e.keyCode||e.which)&&(e.stopPropagation(),this.props.iconOnClick())}},disabled:this.props.disabled||this.props.readonly
},Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.props.icon,clickable:!0}))}else this.props.type!==I&&this.props.icon&&(e=Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this.props.icon,
clickable:this.props.clickable}));return e},_getPrefix(){return this.props.prefix?Uu5g05.Utils.Element.create(m.Z,{content:this.props.prefix,className:this.getClassName("prefix"),
ref_:this._registerPrefix}):null},_getSuffix(){return this.props.suffix&&this.props.value?Uu5g05.Utils.Element.create(m.Z,{content:this.props.suffix,className:this.getClassName("suffix"),
ref_:this._registerSuffix}):null},_createHiddenTextarea(e,t){return Uu5g05.Utils.Element.create("div",{key:"textarea-hidden",className:this.getClassName().hiddenDiv
},Uu5g05.Utils.Element.create("textarea",{className:this.getClassName().hiddenTextarea+" "+e,value:t,readOnly:!0,ref:e=>this._hiddenTextarea=e,rows:this.props.rows}))},_getNewHeightOfTextarea(){
...
return"auto"===this.props.inputWidth?null:this.props.inputWidth},_getWrapperAttrs(){let e={...this.props.wrapperAttrs}||{}
;return e.className?e.className+=" "+this._getFullClassName():e.className=this._getFullClassName(),e.style=e.style||{width:this._getInputWidth()},e},render(){
return Uu5g05.Utils.Element.create("div",this._getWrapperAttrs(),this._getPrefix(),this._getTextInput(),this._getSuffix(),this._getFeedbackIcon(),"password"===this.props.type&&this.props.revealable?Uu5g05.Utils.Element.create(i.Bricks.Button,{
className:this.getClassName("revealButton"),bgStyle:"transparent",size:this.props.size,colorSchema:"grey",disabled:this.props.disabled,mainAttrs:{tabIndex:-1,onMouseDown:e=>{e.preventDefault(),
this.setState((e=>({revealed:!e.revealed})))}}},Uu5g05.Utils.Element.create(i.Bricks.Icon,{icon:this._isEffectivelyRevealed()?"mdi-eye-off-outline":"mdi-eye-outline",
className:this.getClassName("revealIcon")})):null)}})},8881:(e,t,o)=>{"use strict";o.d(t,{Z:()=>n});var s=o(5032),u=o.n(s),i=o(4434),r=o.n(i);const n=e=>{if(!r().Common.Context.isSupported())return e
;let t=r().Common.Reference.forward(((t,o)=>{let{_dateFormat:s,format:i,...r}=t,{valueType:n,parseDate:a,step:l}=t
;return!s||null!=i||"iso"!==n&&"date"!==n||"function"==typeof a||l&&"days"!==l||(i=s.replace(/[DMYdWE]+|\[^]*\]/g,(e=>{switch(e[0]){case"D":case"M":return e.toLowerCase().slice(0,2);case"Y":
return 2===e.length?"y":"Y";case"d":case"W":case"E":case"[":return""}})).trim()||i),Uu5g05.Utils.Element.create(e,u()({},r,{format:i,ref:o}))}));return t.isUu5PureComponent=!0,
t.displayName=`forwardRef(${e.displayName||e.name||"Component"})`,t.tagName=e.tagName,t}},7054:(e,t,o)=>{"use strict";o.d(t,{Z:()=>r,n:()=>i});var s=o(4434),u=o.n(s);const i={propTypes:{
placeholder:u().PropTypes.any,required:u().PropTypes.bool,requiredMessage:u().PropTypes.any,buttonHidden:u().PropTypes.bool,iconOpen:u().PropTypes.string,iconClosed:u().PropTypes.string},
getDefaultProps:function(){return{placeholder:null,required:!1,requiredMessage:null,buttonHidden:!1,iconOpen:"mdi-menu-up",iconClosed:"mdi-menu-down"}},isValid(){
...
;s&&"object"==typeof s&&"error"===s.feedback&&(o=!1)}return o}},r=i},8887:(e,t,o)=>{"use strict";o.d(t,{Z:()=>i,b:()=>u});var s=o(4434);const u={
...
;e&&!e.hasFormControls()&&e.registerFormControls(this.getId(),this)}},i=u},6154:(e,t,o)=>{"use strict";o.d(t,{T:()=>C,Z:()=>w});var s=o(4434),u=(o(5617),
o(8216)),i=o(2851),r=o(6062),n=o.n(r),a=o(4036),l=o.n(a),m=o(507),p=o.n(m),c=o(7892),h=o.n(c),f=o(1173),d=o.n(f),g=o(2464),v=o.n(g),b=o(7757),x={};x.styleTagTransform=v(),x.setAttributes=h(),
x.insert=p(),x.domAPI=l(),x.insertStyleElement=d();n()(b.Z,x);b.Z&&b.Z.locals&&b.Z.locals;let y,k=e=>e;function _(e,t){Object.keys(e).forEach((o=>{let s=e[o];t[s.getId()]&&(delete t[s.getId()],
s.enable())}));for(let e in t)delete t[e]}const C={statics:{"UU5.Forms.FormMixin":{classNames:{
form:e=>"uu5-common-form "+i.Z.css(`\n          padding: ${s.Common.Tools.fillUnit(e.padding)};\n        `)},warnings:{formInForm:"Form control %s should not be placed in other form control %s.",
...
duplicateId:"Duplicate id '%s' of a form control."},lsi:()=>s.Environment.Lsi.Forms.formMixin}},propTypes:{values:s.PropTypes.object,progressIndicator:s.PropTypes.any,onInit:s.PropTypes.func,
onSave:s.PropTypes.func,onSaveDone:s.PropTypes.func,onSaveFail:s.PropTypes.func,onSaveByKey:s.PropTypes.func,onValidate:s.PropTypes.func,onReset:s.PropTypes.func,onCancel:s.PropTypes.func,
saveOnEnter:s.PropTypes.bool,usePageAlertBus:s.PropTypes.bool,spacing:s.PropTypes.number,readOnly:s.PropTypes.bool,labelColWidth:s.PropTypes.oneOfType([s.PropTypes.shape({xs:s.PropTypes.number,
s:s.PropTypes.number,m:s.PropTypes.number,l:s.PropTypes.number,xl:s.PropTypes.number}),s.PropTypes.string]),inputColWidth:s.PropTypes.oneOfType([s.PropTypes.shape({xs:s.PropTypes.number,
s:s.PropTypes.number,m:s.PropTypes.number,l:s.PropTypes.number,xl:s.PropTypes.number}),s.PropTypes.string]),labelAlignment:s.PropTypes.string,
padding:s.PropTypes.oneOfType([s.PropTypes.string,s.PropTypes.number]),disableValidationAlert:s.PropTypes.bool},getDefaultProps:function(){return{values:null,progressIndicator:null,onInit:null,
...
}))},setValues(e){Object.keys(e).forEach((t=>void 0===e[t]?delete e[t]:""));let t={...this.state.formContextValue,values:e};this.setState({values:e,formContextValue:t},(()=>{this.eachFormInput((t=>{
if(!t.props._hasFormContext||!this._hasFormContext){let o=e[t.getName()||t.getId()];void 0!==o&&t.setValue(o,{shouldValidateRequired:!1})}}))}))},eachFormInput(e){for(var t in this.formInputs){
if(!1===e(this.formInputs[t]))break}return this.formInputs},hasFormControls(){return 0!==Object.getOwnPropertyNames(this.formControls).length},eachFormControls(e){for(let t in this.formControls){
if(!1===e(this.formControls[t]))break}return this.formInputs},isValid(){let e=!0
...
var t=null;return this._eachFormInputWithName(((o,s)=>{var u=o===e;return u&&(t=s),!u})),t},getFormChildren(e){this._hasFormContext=!0;let t="function"==typeof e&&e(),o=[]
;t&&(t=Array.isArray(t)?t:[t],t.forEach(((e,t)=>{if(e)if(Array.isArray(e))e.forEach(((e,u)=>{if("object"==typeof e){let i=s.Common.Tools.merge({},e.props);i.key=i.key||t+"-"+u,i.parent=i.parent||this,
o.push(s.Common.Element.clone(e,i))}else o.push(e)}));else if("object"==typeof e){let u=s.Common.Tools.merge({},e.props);u.key=u.key||t,u.parent=u.parent||this,o.push(s.Common.Element.clone(e,u))
}else o.push(e);else o.push(e)})));let i=this._getMainAttrs();return i.className=s.Common.Tools.joinClassNames(i.className,this.getClassName("form","UU5.Forms.FormMixin")),
Uu5g05.Utils.Element.create("form",i,Uu5g05.Utils.Element.create(s.Bricks.AlertBus,{ref_:e=>this._alertBus=e,closeTimer:null,location:this.props.usePageAlertBus?"page":"local"
}),Uu5g05.Utils.Element.create(u.q3.Provider,{value:this.state.formContextValue},o),Uu5g05.Utils.Element.create("button",{type:"submit",style:{display:"none"}}))},getAlertBus(){return this._alertBus},
save(e){return e=e||this.getValues(),"function"==typeof this.save_?this.save_(e):this.saveDefault(e),this},saveDefault(e){return e=e||this.getValues(),
...
this._formPending=!0;let t=this.getInputs();return _(t,this.pendingComponents),Object.keys(t).forEach((e=>{let o=t[e];o.isDisabled()||(this.pendingComponents[o.getId()]=o,o.disable())})),
this.getAlertBus().addAlertToPosition(0,{id:this.getId()+"-pending",closeTimer:null,closeDisabled:!0,content:this.props.progressIndicator||Uu5g05.Utils.Element.create(s.Bricks.Loading,null)}),
this.hasFormControls()?this.eachFormControls((t=>t.disable(e))):"function"==typeof e&&e(),this},setReady(e){return this._formPending=!1,_(this.getInputs(),this.pendingComponents),
...
;for(let e in this.formInputs)"function"==typeof this.formInputs[e].reset&&t++;let o=s.Common.Tools.buildCounterCallback(e,t)
...
let u=o.which||o.keyCode,i=s.Common.Tools.isMac()?o.metaKey:null,r=!(!o.ctrlKey&&!i)||17===u;s.Common.Tools.isIE()||(t=o.nativeEvent.repeat),r&&83===u&&"function"==typeof e&&(o.preventDefault(),
o.stopPropagation(),t||(t=!0,e({component:this,event:o})))},onKeyUp:e=>{let o=e.which||e.keyCode,u=s.Common.Tools.isMac()?e.metaKey:null;(!(!e.ctrlKey&&!u)||17===o)&&83===o&&(t=!1)}}},readOnly(){
let e={...this.state.formContextValue,readOnly:!0};return this.setState({readOnly:!0,formContextValue:e}),this},editable(){let e={...this.state.formContextValue,readOnly:!1};return this.setState({
readOnly:!1,formContextValue:e}),this},isReadOnly(){return this.state.readOnly},isFormPending(){return this._formPending},_eachFormInputWithName(e){var t=this;return this.eachFormInput((o=>{
var s=o.getName();s||(t.showWarning("noName",o.getId(),{mixinName:"UU5.Forms.FormMixin",context:{input:{tagName:o.getTagName(),props:o.props,component:o}}}),s=o.getId()),e(s,o)})),this},
_getMainAttrs(){let e=this.getMainAttrs();if(e.onSubmit=e=>{e.preventDefault(),this.props.saveOnEnter&&(this.isValid()?this.save():this.validate())},"function"==typeof this.props.onSaveByKey){
let t=this.getSaveFormEvents(this.props.onSaveByKey);Object.keys(t).forEach((o=>{let s=e[o];e[o]=e=>{"function"==typeof s&&s(e),t[o](e)}}))}
return"number"==typeof this.props.spacing&&(e.className+=" "+s.Common.Css.css(y||(y=k`
...
e}},w=C},1182:(e,t,o)=>{"use strict";o.d(t,{K:()=>i,Z:()=>r});var s=o(4434),u=o.n(s);o(3167);const i={propTypes:{value:u().PropTypes.arrayOf(u().PropTypes.shape({label:u().PropTypes.any.isRequired,
...
8977:(e,t,o)=>{"use strict";o.d(t,{Hb:()=>E,ry:()=>S,J5:()=>U,LB:()=>V,BI:()=>F,Ng:()=>N,ZP:()=>O});var s=o(1256),u=o(4434),i=(o(5853),
o(6062)),r=o.n(i),n=o(4036),a=o.n(n),l=o(507),m=o.n(l),p=o(7892),c=o.n(p),h=o(1173),f=o.n(h),d=o(2464),g=o.n(d),v=o(9351),b={};b.styleTagTransform=g(),b.setAttributes=c(),b.insert=m(),b.domAPI=a(),
b.insertStyleElement=f();r()(v.Z,b);v.Z&&v.Z.locals&&v.Z.locals;var x=o(2196),y=o(5032),k=o.n(y),_=(o(5617),o(1370)),C=o(544),w={};w.styleTagTransform=g(),w.setAttributes=c(),w.insert=m(),
w.domAPI=a(),w.insertStyleElement=f();r()(C.Z,w);C.Z&&C.Z.locals&&C.Z.locals;const T=u.Common.VisualComponent.create({displayName:"InputWrapper",mixins:[u.Common.BaseMixin,u.Common.PureRenderMixin],
statics:{tagName:s.Z.name("InputWrapper"),classNames:{main:s.Z.css("input-wrapper"),cover:s.Z.css("input-wrapper-cover"),wrapper:s.Z.css("input-button-wrapper"),
feedbackInitial:s.Z.css("input-wrapper-initial"),paddingRight:s.Z.css("input-button-wrapper-padding-right"),inputButton:s.Z.css("input-button"),inputButtonIcon:s.Z.css("input-button-icon")}},
propTypes:{required:u.PropTypes.bool,feedback:u.PropTypes.string,message:u.PropTypes.any,buttons:u.PropTypes.arrayOf(u.PropTypes.shape({icon:u.PropTypes.string,disabled:u.PropTypes.bool,
onClick:u.PropTypes.func,pressed:u.PropTypes.bool,size:u.PropTypes.string})),slider:u.PropTypes.bool,datetimepicker:u.PropTypes.bool,daterangepicker:u.PropTypes.bool},getDefaultProps:function(){
...
let o=this.getClassName("wrapper");return this.props.datetimepicker&&0===t&&(o=" "+this.getClassName("paddingRight")),Uu5g05.Utils.Element.create("span",{key:t,className:o
},Uu5g05.Utils.Element.create(u.Bricks.Button,k()({},e,{className:this.getClassName("inputButton"),icon:null}),Uu5g05.Utils.Element.create(u.Bricks.Icon,{icon:e.icon,
className:this.getClassName("inputButtonIcon")})))})):null},_getFeedbackColorSchema(){let e;switch(this.props.feedback){case"warning":e="warning";break;case"error":e="danger";break;case"success":
e="success"}return e},_getRenderResult(){let e,t;"initial"===this.props.feedback&&(t=this.getClassName("feedbackInitial"))
;let o=!this.props.readonly&&!this.props.disabled&&this.props.message&&Uu5g05.Utils.Element.create(_.Z,{colorSchema:this._getFeedbackColorSchema(),content:this.props.message,className:t})
;if(this.props.datetimepicker||this.props.daterangepicker){let t=u.Common.Children.toArray(this.props.children),s=this._getButtons()
;e=Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("div",{className:this.getClassName("cover")},t[0],s&&s[0],t.slice(1),s&&s[1]),o)
}else e=this.props.buttons&&this.props.buttons.length>0?Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("div",{className:this.getClassName("cover")
},u.Common.Children.toArray(this.props.children),this._getButtons()),o):this.props.slider?Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("cover")},u.Common.Children.toArray(this.props.children)),o):Uu5g05.Utils.Element.create("div",this._getMainAttrs(),u.Common.Children.toArray(this.props.children),o)
;return e},render:function(){return this._getRenderResult()}});var D=o(2851);let I,P=e=>e;const S="initial",F="success",N="warning",E="error",V="loading",U={statics:{"UU5.Forms.InputMixin":{
classNames:{main:s.Z.css("input"),formItem:s.Z.css("input-form-item"),input:s.Z.css("input-"),readOnly:s.Z.css("input-read-only"),hasIcon:s.Z.css("input-icon"),inline:s.Z.css("input-inline"),
labelWidth:s.Z.css("input-label-width"),withAutoWidth:s.Z.css("input-auto-width"),preventWrap:s.Z.css("input-prevent-wrap")},defaults:{columnRegexp:/^([a-z]+)(?:-)?(\d+)$/,labelColWidth:{xs:12,s:5},
inputColWidth:{xs:12,s:7}}}},propTypes:{label:u.PropTypes.any,message:u.PropTypes.any,feedback:u.PropTypes.oneOf([S,F,N,E,V]),readOnly:u.PropTypes.bool,size:u.PropTypes.oneOf(["s","m","l","xl"]),
onChange:u.PropTypes.func,onValidate:u.PropTypes.func,onChangeFeedback:u.PropTypes.func,labelColWidth:u.PropTypes.oneOfType([u.PropTypes.shape({xs:u.PropTypes.number,s:u.PropTypes.number,
m:u.PropTypes.number,l:u.PropTypes.number,xl:u.PropTypes.number}),u.PropTypes.string]),inputColWidth:u.PropTypes.oneOfType([u.PropTypes.shape({xs:u.PropTypes.number,s:u.PropTypes.number,
m:u.PropTypes.number,l:u.PropTypes.number,xl:u.PropTypes.number}),u.PropTypes.string]),inputWidth:u.PropTypes.string,labelWidth:u.PropTypes.string,inputAttrs:u.PropTypes.object,
spacing:u.PropTypes.number,tooltipIcon:u.PropTypes.string,labelAlignment:u.PropTypes.string},getDefaultProps:function(){return{label:null,message:null,feedback:S,readOnly:!1,size:"m",onChange:null,
onValidate:null,labelColWidth:U.statics["UU5.Forms.InputMixin"].defaults.labelColWidth,inputColWidth:U.statics["UU5.Forms.InputMixin"].defaults.inputColWidth,inputWidth:null,labelWidth:null,
inputAttrs:null,spacing:null,tooltipIcon:"mdi-information-outline",labelAlignment:void 0}},getInitialState:function(){return{message:this.props.message,feedback:this.props.feedback,
...
"function"==typeof this.setInitial_?this.setInitial_(e,t,o):this.setInitialDefault(e,t,o),this},setInitialDefault(e,t,o){return void 0===e&&(e=null),this._setFeedback(S,e,t,o),this},isInitial(){
return this.getFeedback()===S},setLoading(e,t,o){return"function"==typeof this.setLoading_?this.setLoading_(e,t,o):this.setLoadingDefault(e,t,o),this},setLoadingDefault(e,t,o){
return this._setFeedback(V,e,t,o),this},isLoading(){return this.getFeedback()===V},setSuccess(e,t,o){return"function"==typeof this.setSuccess_?this.setSuccess_(e,t,o):this.setSuccessDefault(e,t,o),
...
return this.getFeedback()===N},setError(e,t,o){return"function"==typeof this.setError_?this.setError_(e,t,o):this.setErrorDefault(e,t,o),this},setErrorDefault(e,t,o){return this._setFeedback(E,e,t,o),
this},isError(){return this.getFeedback()===E},reset(e){return"function"==typeof this.reset_?this.reset_(e):this.resetDefault(e),this},resetDefault(e){return this.setState({message:this.props.message,
feedback:this.props.feedback,value:this.props.value,readOnly:this.props.readOnly},e),this},getChangeFeedback(e){let t
;return t="function"==typeof this.getChangeFeedback_?this.getChangeFeedback_(e):this.getChangeFeedbackDefault(e),t},getChangeFeedbackDefault(e){return{feedback:e.feedback||S,message:e.message||null,
...
;return null!==this.props.label&&(t=Uu5g05.Utils.Element.create(x.Z,this._getLabelProps(e))),t},getInputWrapper(e,t,o){return Uu5g05.Utils.Element.create(T,this._getInputWrapperProps(e,t,o))},focus(){
return"function"==typeof this.focus_?this.focus_():u.Common.DOM.findNode(this).focus(),this},isComputedDisabled(){var e,t
...
(this.state.feedback!=S||this.props.required)&&(t.className+=" "+this.getClassName("hasIcon","UU5.Forms.InputMixin")),
...
this.props.labelWidth&&(t.className+=" "+this.getClassName("labelWidth","UU5.Forms.InputMixin")),"number"==typeof this.props.spacing&&(t.className+=" "+u.Common.Css.css(I||(I=P`
...
;t=(t?t+" ":"")+D.Z.css(`\n        &.uu5-forms-label {\n          @media ${o} {\n            text-align: ${e.xs}\n          }\n\n          @media ${s} {\n            text-align: ${e.s}\n          }\n\n          @media ${u} {\n            text-align: ${e.m}\n          }\n\n          @media ${i} {\n            text-align: ${e.l}\n          }\n\n          @media ${r} {\n            text-align: ${e.xl}\n          }\n        }\n      `)
}"right"===this.props.labelPosition&&(t=(t?t+" ":"")+s.Z.css("input-label-right"));let o=null,i=this.props.labelColWidth||this.getDefault("labelColWidth","UU5.Forms.InputMixin")
;return this.props.inputWidth||this.props.labelWidth||(o=u.Common.Tools.buildColWidthClassName(i)),{required:this.props.required,for:e,content:this.props.label,colWidth:o,className:t,
...
n[e]?s[r][e]=n[e]:s[r][e]=o[t-1]?s[r][o[t-1]]:12):(n=u[r].match(i),n=n&&n[0],s[r][e]=n?parseInt(n.match(/\d+/)[0]):o[t-1]?s[r][o[t-1]]:12)}))})),s.label[o]+s.input[o]},_getInputWrapperProps(e,t,o){
let s;return s="function"==typeof this.getInputWrapperProps_?this.getInputWrapperProps_(e,t,o):this._getInputWrapperPropsDefault(e,t,o),s},_getInputWrapperPropsDefault(e,t,o){
let s=this.props.label,i=null!==s
;"UU5.Forms.DateRangePicker"!==this.getTagName()&&"UU5.Forms.DateTimeRangePicker"!==this.getTagName()||(!this._isSorXs()&&this.props.innerLabel?s=null:this._isSorXs()&&(this.props.labelFrom||this.props.labelTo)&&(i=!0))
;let r=null,n=this.props.inputColWidth||this.getDefault("inputColWidth","UU5.Forms.InputMixin");this.props.inputWidth||this.props.labelWidth||(r=u.Common.Tools.buildColWidthClassName(i?n:"xs12"))
...
e.elevation||(e.elevation=this.props.elevation)})),{colWidth:r,feedback:a,message:l,required:this.props.required,buttons:t,children:e,slider:"UU5.Forms.Slider"===this.getTagName(),
...
;return Array.isArray(o)&&o.indexOf(e)>-1&&o.indexOf(t)>-1||(typeof e!=typeof t?s=!0:"string"!=typeof t&&"number"!=typeof t||e===t?"object"==typeof t&&t instanceof Date?u.Common.Tools.compareDates(e,t,"equals")||(s=!0):(Array.isArray(t)||"object"==typeof t&&null!==t)&&(u.Common.Tools.deepEqual(e,t)||(s=!0)):s=!0),
s},_findScrollElement(e){let t=null;for(;e&&e.tagName;)e.classList.contains("uu5-bricks-modal-body")||e===document.documentElement?(t=e,e=null):e=e.parentNode;return t}};U.INITIAL_FEEDBACK=S,
U.SUCCESS_FEEDBACK=F,U.WARNING_FEEDBACK=N,U.ERROR_FEEDBACK=E,U.LOADING_FEEDBACK=V;const O=U},1939:(e,t,o)=>{"use strict";o.d(t,{Q:()=>n,Z:()=>a});var s=o(4434),u=o(1256),i=o(8977),r=o(9501);o(3167)
;const n={mixins:[s.Common.ColorSchemaMixin,i.ZP],statics:{"UU5.Forms.TextInputMixin":{classNames:{main:u.Z.css("text-input"),item:u.Z.css("auto-complete-item","group-item")}}},propTypes:{
...
message:this.props.focusMessage,value:this.state.value,feedback:"initial"}),e},getBlurFeedback(e){let t,o=this.onValidate(e);return t=o||{feedback:i.ZP.INITIAL_FEEDBACK,message:null,value:e.value},t},
...
feedback:e.feedback||i.ZP.INITIAL_FEEDBACK,message:e.message||null,value:void 0===e.value?this.state.value:e.value,foundAutocompleteItems:t,selectedIndex:o}},setChangeFeedback_(e,t){
...
;return this.state.selectedIndex===t&&(o+=" "+this.getClassName().selected),Uu5g05.Utils.Element.create(r.Z,{className:o,key:t,value:e.value||e.content,content:e.content||e.value,mainAttrs:{
id:this.getId()+"-item-"+t,tabIndex:0}})}))}},a=n},7443:(e,t,o)=>{"use strict";o.d(t,{M:()=>P});var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),
o(3082)),n=o(1256),a=o(2810),l=o(1939),m=o(4260),p=o(8216),c=o(2202),h=o(6062),f=o.n(h),d=o(4036),g=o.n(d),v=o(507),b=o.n(v),x=o(7892),y=o.n(x),k=o(1173),_=o.n(k),C=o(2464),w=o.n(C),T=o(3357),D={}
;D.styleTagTransform=w(),D.setAttributes=y(),D.insert=b(),D.domAPI=g(),D.insertStyleElement=_();f()(T.Z,D);T.Z&&T.Z.locals&&T.Z.locals;function I(e,t){
return e===t&&e||Number.isNaN(e)&&Number.isNaN(t)||0===e&&0===t&&1/e==1/t}let P=p.ZP.withContext(i.Common.VisualComponent.create({displayName:"Number",
mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ScreenSizeMixin,l.Z],statics:{tagName:n.Z.name("Number"),classNames:{main:n.Z.css("number"),
hiddenButtons:n.Z.css("number-hidden-buttons")},defaults:{regexpNumberParts:/\B(?=(\d{3})+(?!\d))/g,regexpExponent:/e\+\d+$/,inputColWidth:"xs12 s4 m4 l3 xl3"},
...
I(this._parseNumberFromLocalizedString(t.value),s)&&this.props.thousandSeparator===e.thousandSeparator&&this.props.decimalSeparator===e.decimalSeparator&&(t.value=o),
...
_getLocalizedValueWithFeedback(e,t){let o,s;return"number"==typeof e?(s=this._applyDecimals(e),
...
o=this._formatNumberToLocalizedStringEditable(s)||(null==e?"":e+"")):(s=void 0,o=""),{...this._checkNaNMinMaxAndGetFeedback(o),value:o}},_onChange(e){this._correctCursorPosition(e)
;let t=this._removePrefixAndSuffix(e.target.value||"");if(/\s/.test(t)&&(t=t.replace(/\s+/g,""),e.target.value=t),t.split(/[.,]/).length>=3){let e=this._parseNumberFromLocalizedString(t)
;"number"!=typeof e||Number.isNaN(e)||(t=this._formatNumberToLocalizedStringEditable(e))}t=t.replace(/[.,]/g,(()=>this._currentProps.decimalSeparator));let o=this._checkNaNAndGetFeedback(t);if(o){
let e=this._parseNumberFromLocalizedString(this.state.value);"-"!==this.state.value&&Number.isNaN(e)||(t=this.state.value),this._updateFeedback(o.feedback,o.message,t)}else{
if(I(this._parseNumberFromLocalizedString(this.state.value),this._parseNumberFromLocalizedString(t)))this.setState({value:t});else if(!this.isComputedDisabled()&&!this.isReadOnly()){let o={
value:this._getValueTypedValue(t),event:e,component:this,_data:{type:"input",value:t}};"function"==typeof this.props.onChange?this.props.onChange(o):this.onChangeDefault(o)}}return this},
_onChangeInputDefault(e,t){let o="function"==typeof t;if(this.props.validateOnChange)o=!1,this._validateOnChange(e,!1,!1,t);else{let s=e._data.value;if(this._checkRequiredValue({value:s})){
let{feedback:u,message:i}=this.getChangeFeedback(e);o=!1,this._updateFeedback(u,i,s,t)}}o&&t()},_onIncreaseDecreaseDefault(e,t,o){let s=e._data.value
;this._updateFeedback(this.state.feedback,null,s,(()=>{let{feedback:t,message:s}=this.getBlurFeedback(e);this._updateFeedback(t,s,this.state.value,o)}))},_onBlur(e){this._isFocused=!1
;let t=this._removePrefixAndSuffix(e.target.value),o={value:this._getValueTypedValue(t),event:e,component:this,_data:{value:t}}
;return"function"==typeof this.props.onBlur?this.props.onBlur(o):this.onBlurDefault(o),this},_onFocus(e){this._isFocused=!0,this._correctCursorFireFoxAndIe(e)
...
let t,o=r.Utils.Clipboard.read(e,"json"),s=!1;if(null!=o&&"number"==typeof o)t=JSON.stringify(o);else{let o=r.Utils.Clipboard.read(e);({numberString:t,ambiguous:s}=function(e,t,o){var s,u,i
;let r,n=!1,a=(null===(s=e.match(/-?\d+[.,\s0-9]*|-?[.,]\d+[.,\s0-9]*/))||void 0===s||null===(u=s[0])||void 0===u?void 0:u.trim())||"",l="-"===a[0]?"-":"";l&&(a=a.slice(1).trim()),
a=a.replace(/[.,\s]+$/,"");let m=a.split(".").length-1,p=a.split(",").length-1,c=m+p<=1&&a.includes(" ")&&!(null!==(i=a.split(/[.,]/)[1])&&void 0!==i&&i.includes(" "));if(m>0&&p>0||c){
let e=a.replace(/\s+/g,"").split(/[.,]/),t=e.length>1?e.pop():"";r=e.join("")+(t&&!t.match(/^0+$/)?"."+t:"")}else if(m>0||p>0){let e=m||p,o=m>0?".":","
;if(a.split(o).slice(1).every((e=>3===e.length)))e>1||t===o?(r=a.replace(/\s+/g,"").replaceAll(o,""),n=1===e):(r=a.replace(/\s+/g,"").replace(o,".").replace(/\.0*$/,""),n=!0);else{
let e=a.replace(/\s+/g,"").split(o),t=e.pop();r=e.join("")+(t&&!t.match(/^0+$/)?"."+t:"")}}else r=a.replace(/\s+/g,"");return{numberString:r&&!Number.isNaN(Number(r))?l+r:void 0,ambiguous:n}
...
onMouseUp:this._increaseEnd,onMouseOut:this._increaseEnd}}],s={...this.props.inputAttrs};if(""===s.className&&delete s.className,s.onMouseUp=this._onMouseUp,s.onKeyDown=this._onKeyDown,s.onPaste=e=>{
var t,o;"function"==typeof(null===(t=this.props.inputAttrs)||void 0===t?void 0:t.onPaste)&&(null===(o=this.props.inputAttrs)||void 0===o||o.onPaste(e)),e.defaultPrevented||this._handlePaste(e)},
s.onCopy=e=>{var t,o;"function"==typeof(null===(t=this.props.inputAttrs)||void 0===t?void 0:t.onCopy)&&(null===(o=this.props.inputAttrs)||void 0===o||o.onCopy(e)),
e.defaultPrevented||this._handleCopy(e)},this.state.value){if(e=this._prefix(),this._isFocused||Number.isNaN(this._parseNumberFromLocalizedString(this.state.value)))if(this._isFocused){
...
;return this.props.buttonHidden&&(r.className+=" "+this.getClassName("hiddenButtons")),Uu5g05.Utils.Element.create("div",r,this.getLabel(t),this.getInputWrapper([Uu5g05.Utils.Element.create(a.Z,{id:t,
key:t,name:this.props.name||t,value:e,placeholder:this.props.placeholder,type:"text",onChange:this._onChange,onBlur:this._onBlur,onFocus:this._onFocus,onKeyDown:this.onKeyDown,mainAttrs:s,
...
elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth(),colorSchema:this.props.colorSchema,size:this.props.size}),Uu5g05.Utils.Element.create(m.Z,u()({
key:"item-list"},this._getItemListProps()),this._getChildren()),Uu5g05.Utils.Element.create(i.Bricks.Backdrop,u()({key:"backdrop"},this._getBackdropProps()))],o))}}));P=(0,c.ZP)(P,{
thousandSeparator:"numberGroupingSeparator",decimalSeparator:"numberDecimalSeparator"})},1518:(e,t,o)=>{"use strict";o.d(t,{h:()=>T});var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),
o(1256)),n=o(5966),a=o(8081),l=o(901),m=o(6062),p=o.n(m),c=o(4036),h=o.n(c),f=o(507),d=o.n(f),g=o(7892),v=o.n(g),b=o(1173),x=o.n(b),y=o(2464),k=o.n(y),_=o(7554),C={};C.styleTagTransform=k(),
C.setAttributes=v(),C.insert=d(),C.domAPI=h(),C.insertStyleElement=x();p()(_.Z,C);_.Z&&_.Z.locals&&_.Z.locals;const w={text:"",textarea:"",bool:!1,number:null,date:"",time:"",datetime:"",uu5string:"",
uu5json:null,select:null},T=i.Common.VisualComponent.create({displayName:"PropsForm",mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.SectionMixin],statics:{
tagName:r.Z.name("PropsForm"),classNames:{main:r.Z.css("propsform"),additionalPropsPanel:r.Z.css("additional-props-panel")},limits:{radiosMax:5},lsi:{panelHeader:{cs:"Doplňující vlastnosti",
en:"Additional properties"}}},propTypes:{props:i.PropTypes.arrayOf(i.PropTypes.shape({name:i.PropTypes.string.isRequired,placeholder:i.PropTypes.string,
...
uu5string:!1}),_getDefaultPropValue(e){let t;if(void 0!==e.defaultValue)t=e.defaultValue;else{let o=this._getType(e.type);t=void 0===w[o]?w.text:w[o]}return t},_getType(e){
...
;"function"==typeof t&&(s=()=>t(o)),"number"===e.type&&(""===o.value?o.value=w.number:void 0!==o.value&&(o.value=+o.value.replace(e.props&&e.props.decimalSeparator||",","."))),
...
t.Component="UU5.CodeKit.JsonEditor",t.props.rows=5;break;case"select":t.Component="UU5.Forms.Select",t.props.onChange=this._onChangeHandler(e),
t.children=e.type.map((e=>Uu5g05.Utils.Element.create(l.Z.Option,{value:e,key:e})));break;case"radios":t.Component="UU5.Forms.Radios",t.props.onChange=this._onChangeHandler(e),
t.props.value=e.type.map((t=>({label:t,name:t,value:t===e.value})));break;case"custom":t.Component=e.name;break;default:t.Component="UU5.Forms.Text"}if(!t.props.onChange){let o
;e.props&&e.props.onBlur&&(o=e.props.onBlur,delete e.props.onBlur),t.props.onBlur=t=>{
...
"number"===e.type&&(""===t.value?t.value=w.number:void 0!==t.value&&(t.value=+t.value.replace(e.props&&e.props.decimalSeparator||",","."))),this._setProp(e,o)}}}return t},_getNewValue(e,t){
...
this._result&&this._result.setProp(e.name,this._getNewValue(e,t))},_toUU5String:e=>(null===e&&(e=w.uu5string),`<uu5string/>${e=e.replace(i.Common.REGEXP.uu5string,"")}`),render(){let e={},t=[],o=[]
...
},n,s.props),r);!1===s.visible?o.push(l):t.push(l)})),Uu5g05.Utils.Element.create(n.Z,u()({},this.getMainPropsToPass(),{onSave:this.props.onSave,onCancel:this.props.onCancel
}),t,!!o.length&&Uu5g05.Utils.Element.create(i.Bricks.Panel,{bgStyleHeader:"underline",iconAlign:"after",iconCollapsed:"mdi-menu-down",iconExpanded:"mdi-menu-up",
header:this.getLsiComponent("panelHeader"),className:this.getClassName("additionalPropsPanel")},o),this.props.tagName&&Uu5g05.Utils.Element.create(i.Bricks.CodePreview,{tagName:this.props.tagName,
props:e,uu5string:this.props.uu5string,ref_:e=>this._result=e}),Uu5g05.Utils.Element.create(a.C,null))}})},3588:(e,t,o)=>{"use strict";o.d(t,{T:()=>T})
;var s=o(4434),u=o(1256),i=o(7530),r=o(2851),n=o(8977),a=o(1182),l=o(7791),m=o(8216),p=o(6062),c=o.n(p),h=o(4036),f=o.n(h),d=o(507),g=o.n(d),v=o(7892),b=o.n(v),x=o(1173),y=o.n(x),k=o(2464),_=o.n(k),C=o(7997),w={}
;w.styleTagTransform=_(),w.setAttributes=b(),w.insert=g(),w.domAPI=f(),w.insertStyleElement=y();c()(C.Z,w);C.Z&&C.Z.locals&&C.Z.locals;const T=m.ZP.withContext(s.Common.VisualComponent.create({
displayName:"Radios",mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ElementaryMixin,s.Common.ColorSchemaMixin,s.Common.ScreenSizeMixin,n.ZP,a.Z],statics:{tagName:u.Z.name("Radios"),
classNames:{main:u.Z.css("radios"),inline:u.Z.css("inputs-inline"),loading:u.Z.css("input-loading-icon"),
inner:e=>u.Z.css("input-inner")+" "+r.Z.css(`\n          border-radius: ${s.Common.Tools.fillUnit(e.selectionBorderRadius)};\n        `),selectionBackground:u.Z.css("radios-selection-background"),
column:u.Z.css("radios-column")},defaults:{columnRegexp:/^((?:offset-)?[a-z]+)(?:-)?(\d+)$/},lsi:()=>s.Environment.Lsi.Forms.message},propTypes:{bgStyleChecked:s.PropTypes.oneOf(["filled","outline"]),
selectionBackground:s.PropTypes.bool,selectionBorderRadius:s.PropTypes.oneOfType([s.PropTypes.string,s.PropTypes.number])},getDefaultProps:()=>({bgStyleChecked:"outline",selectionBackground:!0,
...
;this._onChange(t,(()=>{e[this._currentFocus].focus()}))}else t(o)}return this};s.Environment.EventListener.addWindowEvent("keydown",this.getId(),(e=>{38!==e.which&&40!==e.which||e.preventDefault()
})),s.Environment.EventListener.addWindowEvent("keyup",this.getId(),t)},_removeEvent(){s.Environment.EventListener.removeWindowEvent("keydown",this.getId()),
s.Environment.EventListener.removeWindowEvent("keyup",this.getId())},_onFocus(){this._addEvent()},_onBlur(){this._removeEvent()},_getNumberOfColumns(){let e=this.getScreenSize(),t=this.props.colWidth
...
_getCheckbox(e,t,o){let u,i=s.Common.Tools.merge({},t),r=!!this.isComputedDisabled()||!!t.disabled;return u=o===e?null:"-1",Uu5g05.Utils.Element.create(l.Z,{size:this.props.size,key:e,
value:this.getValue()===i.name,label:t.label,onChange:this._onChange,onIcon:t.onIcon||this.props.onIcon||null,offIcon:t.offIcon||this.props.offIcon||null,name:t.name,_radio:!0,
labelPosition:this.props.labelPosition,disabled:r,readOnly:this.isReadOnly(),feedback:this.isLoading()&&0===e?"loading":"initial",inputAttrs:{onFocus:this._onFocus,onBlur:this._onBlur,tabIndex:u},
ref_:e=>{this._itemsRefs.push(e)},inputWidth:this._getInputWidth(),nestingLevel:this.props.nestingLevel,className:this.getClassName("inner"),bgStyleChecked:this.props.bgStyleChecked})},
_getColumns(e,t){let o=[];return this.props.value.map(((s,u)=>{let i=Math.floor(u/(this.props.value.length/e));void 0===o[i]&&(o[i]=[]),o[i].push(this._getCheckbox(u,s,t))})),o},_getCheckboxes(){
let e=this.props.value.findIndex((e=>e.name===this.getValue()&&!e.disabled));-1===e&&(e=this.props.value.findIndex((e=>!e.disabled)));let t=[]
;if(null===this.props.colWidth||this.props.inline)t=this.props.value.map(((t,o)=>this._getCheckbox(o,t,e)));else{let o,u=this._getNumberOfColumns();o=this._getColumns(u,e),o.forEach((e=>{
t.push(Uu5g05.Utils.Element.create(s.Bricks.Column,{colWidth:this.props.colWidth,className:this.getClassName("column")},e))}))}return t},_getMainAttrs(){let e=this._getInputAttrs()
;return this.props.inline&&(e.className+=" "+this.getClassName().inline),this.props.bgStyleChecked&&(e.className+=" "+i.Z[this.props.bgStyleChecked]),
this.props.selectionBackground&&(e.className+=" "+this.getClassName("selectionBackground")),e},render(){let e=this.getId()+"-input"
;return Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(e),this.getInputWrapper(this.props.value?this._getCheckboxes():null))}}))},9501:(e,t,o)=>{"use strict";o.d(t,{Z:()=>k})
;var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),o(1256)),n=(o(4260),o(3167),o(6062)),a=o.n(n),l=o(4036),m=o.n(l),p=o(507),c=o.n(p),h=o(7892),f=o.n(h),d=o(1173),g=o.n(d),v=o(2464),b=o.n(v),x=o(6561),y={}
;y.styleTagTransform=b(),y.setAttributes=f(),y.insert=c(),y.domAPI=m(),y.insertStyleElement=g();a()(x.Z,y);x.Z&&x.Z.locals&&x.Z.locals;const k=i.Common.VisualComponent.create({
displayName:"select-option",mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ContentMixin],statics:{tagName:r.Z.name("Select.Option"),classNames:{
main:r.Z.css("select-option","group-item")},errors:{invalidParent:"Parent of this component is not Select."},editMode:{enableWrapper:!1}},propTypes:{value:i.PropTypes.string.isRequired,
selectedContent:i.PropTypes.any,onClick:i.PropTypes.func},getDefaultProps:()=>({value:null,selectedContent:null,onClick:null}),UNSAFE_componentWillMount(){
...
e},render(){return Uu5g05.Utils.Element.create(i.Bricks.Link,u()({},this._getMainProps(),{ref_:e=>this._item=e}))}})},901:(e,t,o)=>{"use strict";o.d(t,{P:()=>h,Z:()=>f})
;var s=o(5032),u=o.n(s),i=o(4434),r=(o(5617),o(1256)),n=o(4260),a=o(8379),l=o(7054),m=o(8977),p=o(9501),c=o(8216);o(9616);const h=c.ZP.withContext(i.Common.VisualComponent.create({
displayName:"Select",mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ContentMixin,i.Common.ScreenSizeMixin,i.Common.ColorSchemaMixin,m.ZP,l.Z],statics:{
tagName:r.Z.name("Select"),classNames:{main:r.Z.css("select"),stateHolder:r.Z.css("select-state-holder"),link:r.Z.css("select-link"),open:r.Z.css("select-open"),multiple:r.Z.css("select-multiple"),
selectAllEnabled:r.Z.css("select-all"),hasValue:r.Z.css("select-has-value"),screenSizeBehaviour:r.Z.css("screen-size-behaviour"),inputOpen:r.Z.css("items-input-open"),popover:r.Z.css("select-popover")
...
"function"==typeof this.props.onChange?this.props.multiple?this.props.onChange(e):this.close((()=>this.props.onChange(e))):this.onChangeDefault(e)},onChangeDefault(e,t){let o=(e={...e})._data.type
...
}return this},_onSelectDefault(e,t){let o=e._data.result,s=this.props.multiple,u="function"==typeof t;return e._data.requiredResult?"function"==typeof this.props.onValidate?(e.component=this,
e.value=o,s||(e.value=o[0]),this._validateOnChange({event:e.event,value:this._valuesToValuesArray(e.value),component:this},!1),this.close(t)):(u=!1,s||(o=o[0]),o=this._valuesToValuesArray(o),
...
onFocus:this.isReadOnly()||this.isComputedDisabled()?null:()=>this._onFocus()},e)),e},_getItemValues(e){let t=[];if(this.props.placeholder&&null===e&&t.push(Uu5g05.Utils.Element.create(i.Bricks.Span,{
...
let s=e.find((e=>e.props.value===this.state.value[o])),u=s?s.props.selectedContent||s.props.content||s.props.children||s.props.value:null;t.push(u)}else t=[this.state.value];return t},_getHeader(){
let e;if(this.props.selectAllEnabled&&this.props.multiple){let t=this._isSelectedAll()?this.getLsiComponent("unselectAll"):this.getLsiComponent("selectAll")
;e=Uu5g05.Utils.Element.create(i.Bricks.Link,{content:t,onClick:this._selectAll,className:this.getClassName("link"),colorSchema:"grey"})}return e},_isSelectedAll(){let e=!1
...
let e=this.getId()+"-input",t=this._getChildren();return Uu5g05.Utils.Element.create("div",u()({},this._getMainAttrs(),{ref:e=>this._root=e
}),this.getLabel(e),this.getInputWrapper([Uu5g05.Utils.Element.create(a.Z,{id:e,name:this.props.name||e,value:this._getItemValues(t),placeholder:this.props.placeholder,multiple:this.props.multiple,
...
onItemClick:this.isReadOnly()||this.isComputedDisabled()?null:e=>this.removeValue(e),
...
borderRadius:this.props.borderRadius,elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth(),colorSchema:this.props.colorSchema,key:"input"
}),Uu5g05.Utils.Element.create(n.Z,u()({},this._getItemListProps(),{key:"itemList"
}),this.isOpen()&&t),"portal"===this.props.popoverLocation&&this.isOpen()&&!this._shouldOpenToContent()?Uu5g05.Utils.Element.create(i.Bricks.ResizeObserver,{onResize:this._onInputWrapperResize,
key:"resizeObserver"}):null]))}}));h.Option=p.Z;const f=h},1046:(t,o,s)=>{"use strict";s.d(o,{i:()=>T});var u=s(5032),i=s.n(u),r=s(4434),n=(s(5617),
s(1256)),a=s(8977),l=s(2810),m=s(8216),p=s(6062),c=s.n(p),h=s(4036),f=s.n(h),d=s(507),g=s.n(d),v=s(7892),b=s.n(v),x=s(1173),y=s.n(x),k=s(2464),_=s.n(k),C=s(2025),w={};w.styleTagTransform=_(),
w.setAttributes=b(),w.insert=g(),w.domAPI=f(),w.insertStyleElement=y();c()(C.Z,w);C.Z&&C.Z.locals&&C.Z.locals;const T=m.ZP.withContext(r.Common.VisualComponent.create({displayName:"Slider",
mixins:[r.Common.BaseMixin,r.Common.PureRenderMixin,r.Common.ElementaryMixin,r.Common.ContentMixin,r.Common.ColorSchemaMixin,a.ZP],statics:{tagName:n.Z.name("Slider"),classNames:{
main:n.Z.css("slider"),inputGroup:n.Z.css("slider-input-group"),slider:n.Z.css("slider-slider"),number:n.Z.css("slider-number"),sliderReadOnly:n.Z.css("slider-slider-read-only")},defaults:{
...
return this.setValue(e.value?+e.value:null,e.callback),this},render(){let e=this.getId()+"-input",t=this.props.inputAttrs||{};return""===t.className&&delete t.className,
Uu5g05.Utils.Element.create("div",this._getInputAttrs(),this.getLabel(e),this.getInputWrapper([Uu5g05.Utils.Element.create(r.Bricks.Slider,i()({ref_:this._mountSlider
},this._getSliderProps())),Uu5g05.Utils.Element.create(l.Z,i()({},this._getNumberProps(),{id:e,name:this.props.name||e,placeholder:this.props.placeholder,type:"text",mainAttrs:t,
disabled:this.isComputedDisabled(),readonly:this.isReadOnly(),loading:this.isLoading(),feedback:this.getFeedback(),onFocus:this.isReadOnly()||this.isDisabled()?null:()=>this._onFocus(),
onBlur:()=>this._onBlur(),colorSchema:this.props.colorSchema,size:this.props.size}))]))}}))},1226:(e,t,o)=>{"use strict";o.d(t,{K:()=>_});var s=o(5032),u=o.n(s),i=o(4434),r=o.n(i),n=(o(5617),
o(1256)),a=o(8977),l=o(8216),m=o(9501),p=o(2851),c=o(4260),h=o(8379);o(9616);const f=(e,t)=>{let o=!1;return"string"==typeof e?e.trim().split(" ").some((e=>t==e&&(o=!0,
!0))):"boolean"==typeof e&&(o=e),o},d={s:"12px",m:"14px",l:"16px",xl:"18px"},g={main:(e,t)=>{
let o=[n.Z.css("select-body")],s=`\n      min-height: 32px;\n      font-size: ${d[e.size]};\n      line-height: 19px;\n    `
;return t.open&&f(e.openToContent,t.screenSize)&&(s+="\n        && {\n          border-bottom-left-radius: 0;\n          border-bottom-right-radius: 0;\n        }\n      "),o.push(p.Z.css(s)),
o.join(" ")},itemList:(e,t)=>{let o=""
;return t.open&&f(e.openToContent,t.screenSize)&&(o+="\n        && {\n          position: relative;\n          margin-top: 0px;\n          box-shadow: unset;\n          border-radius: 0px;\n          width: 100%;\n        }\n      "),
o?p.Z.css(o):""}},v=r().Common.VisualComponent.create({
...
tagName:n.Z.name("SelectBody"),classNames:{main:g.main,itemList:g.itemList,link:n.Z.css("select-link"),open:n.Z.css("select-open")+" "+n.Z.css("items-input-open"),multiple:n.Z.css("select-multiple"),
selectAllEnabled:n.Z.css("select-all"),hasValue:n.Z.css("select-has-value"),screenSizeBehaviour:n.Z.css("screen-size-behaviour")},defaults:{childTagName:"UU5.Forms.Select.Option"},
...
component:!1,input:!1,item:!1,label:!1,picker:!1};return this._getEventPath(e).every((e=>{let r=e.matches?"matches":"msMatchesSelector";if(e[r]){if(e[r](t))i.label=!0;else{
if(e[r](o))return i.input=!0,!1;if(e[r](s))return i.picker=!0,!1;e[r](u)&&(i.item=!0)}return!0}return!1})),i},_handleClick(e){let t=this._findTarget(e)
...
"portal"===this.props.popoverLocation&&this.isOpen()&&!f(this.props.openToContent,this.state.screenSize)&&this._onOpen()},_getItemValues(e){let t=[]
;if(this.props.placeholder&&null===e&&t.push(Uu5g05.Utils.Element.create(r().Bricks.Span,{className:this.getClassName("placeholder"),content:this.props.placeholder})),
e&&this.props.value)if(Array.isArray(this.props.value))for(let o=0;o<this.props.value.length;o++){
let s=e.find((e=>e.props.value===this.props.value[o])),u=s?s.props.selectedContent||s.props.content||s.props.children||s.props.value:null;t.push(u)}else t=[this.props.value];return t},_getHeader(){
let e;if(this.props.selectAllEnabled&&this.props.multiple){let t=this._isSelectedAll()?this.getLsiComponent("unselectAll"):this.getLsiComponent("selectAll")
;e=Uu5g05.Utils.Element.create(r().Bricks.Link,{content:t,onClick:this._selectAll,className:this.getClassName("link"),colorSchema:"grey"})}return e},_getChildren(){let e=[];if(this.props.children){
...
},_onOpen(e){let t="function"==typeof this.props.onOpen?()=>this.props.onOpen(e):e;if(this._itemList){let e=f(this.props.openToContent,this.state.screenSize);this._itemList.open({
...
this._itemList&&this._itemList.open({onClose:this._onClose,aroundElement:r().Common.DOM.findNode(this._textInput),position:"bottom",offset:f(this.props.openToContent,this.state.screenSize)?0:4,
preventPositioning:f(this.props.openToContent,this.state.screenSize)})},_getIcon(){
...
e.location=f(this.props.openToContent,this.state.screenSize)?"local":this.props.popoverLocation,e.disabled=this.state.disabled,
...
f(this.props.openToContent,this.state.screenSize)&&(e.className+=" "+this.getClassName("screenSizeBehaviour")),e},_getMainAttrs(){let e=this.props.mainAttrs||{}
...
this.toggle((()=>this.isOpen()&&f(this.props.openToContent,this.state.screenSize)?r().Common.Tools.scrollToTarget(this.getId()+"-input",!1,r().Environment._fixedOffset+20,(e=>{let t=null
...
;if(!this.props.readOnly&&!this.props.disabled){let o=e.onClick;e.onClick=e=>{"function"==typeof o&&o(e),t(e)}}return e},render(){let e=this._getChildren()
;return Uu5g05.Utils.Element.create(Uu5g05.Fragment,null,Uu5g05.Utils.Element.create(h.Z,u()({},this._getMainPropsToPass(),{key:"input",id:this.getId()+"-input",name:this.props.name||this.props.id,
...
ref_:this._registerInput,borderRadius:this.props.borderRadius,elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this.props.inputWidth})),Uu5g05.Utils.Element.create(c.Z,u()({
key:"itemList"
},this._getItemListProps()),this.isOpen()&&e),"portal"===this.props.popoverLocation&&this.isOpen()&&!f(this.props.openToContent,this.state.screenSize)?Uu5g05.Utils.Element.create(r().Bricks.ResizeObserver,{
onResize:this._onInputWrapperResize,key:"resizeObserver"}):null)}});let b,x,y=e=>e;const k=["items","children","content","ref_"],_=l.ZP.withContext(i.Common.VisualComponent.create({
displayName:"SwitchSelector",mixins:[i.Common.BaseMixin,i.Common.ElementaryMixin,a.ZP],statics:{tagName:n.Z.name("SwitchSelector"),classNames:{main:(e,t)=>{let o=[n.Z.css("switch-selector")]
;return t.displaySelect&&o.push(n.Z.css("select")),o.join(" ")},hiddenWrapper:n.Z.css("hidden-wrapper ")+p.Z.css(b||(b=y`
            position: absolute;
            left: 0;
            right: 0;
            visibility: hidden;
            overflow: hidden;
          `)),buttonWrapper:p.Z.css(x||(x=y`
            min-width: ${0};
...
colorSchema:i.Common.ColorSchemaMixin.propTypes.colorSchema,message:a.ZP.propTypes.message,feedback:a.ZP.propTypes.feedback,readOnly:a.ZP.propTypes.readOnly,inputAttrs:a.ZP.propTypes.inputAttrs,
inputWidth:a.ZP.propTypes.inputWidth,popoverLocation:v.propTypes.popoverLocation},getDefaultProps:()=>({popoverLocation:v.defaultProps.popoverLocation}),getInitialState(){
...
value:t,component:this},!0):this.setFeedback(e.feedback,e.message,t)}},componentDidUpdate(e){e.size!==this.props.size&&this.setState((()=>({displaySelect:this._isOverflowing()})))},
onChangeDefault(e,t){return this.setValue(e.value,t),this},reset_(e){return this.setState({message:this.props.message,feedback:this.props.feedback,value:this._getInitialValue(),
readOnly:this.props.readOnly},e),this},setValue_(e,t){return"function"==typeof this.props.onValidate?this._validateOnChange({value:e,component:this}):this.setInitial(null,e,t),this},
_registerSwitch(e){this._switchRef=e},_onResize({width:e}){this._lastWidth!==e&&this.setState((()=>({displaySelect:this._isOverflowing()}))),this._lastWidth=e},_isOverflowing(){
const e=i.Common.DOM.findNode(this._switchRef),t=null==e?void 0:e.parentElement;if(t){const o=t.getBoundingClientRect().width
;return(i.Common.Tools.isIE()?e.scrollWidth+3:e.getBoundingClientRect().width)>o}return!1},_getSelectItems(){return this.props.items.map(((e,t)=>Uu5g05.Utils.Element.create(m.Z,u()({key:t},e))))},
_validateOnChange(e,t,o){let s="function"==typeof o;if(!t||this._hasValueChanged(this.state.value,e.value)){let t="function"==typeof this.props.onValidate?this.props.onValidate(e):null
;t&&("object"==typeof t?t.feedback?(s=!1,this.setFeedback(t.feedback,t.message,t.value,o)):(s=!1,this.setState({value:e.value},o)):this.showError("validateError",null,{context:{event:null,
func:this.props.onValidate,result:t}}))}return s&&o(),this},_getInitialValue(e=this.props){
return e.value||"number"==typeof e.value||"boolean"==typeof e.value?e.value:e.items&&e.items.length&&e.items[0].value||void 0},_onChange(e){"function"==typeof this.props.onChange?this.props.onChange({
...e,component:this}):this.onChangeDefault(e)},_getColorSchema(){let e=this.props.colorSchema;switch(this.state.feedback){case a.Hb:e="danger";break;case a.Ng:e="warning";break;case a.BI:e="success"}
return e},_getSelectProps(){let e=this.getId()+"-input",t={...this.props,id:e,name:this.props.name||e,value:[this.state.value],mainAttrs:this.props.inputAttrs,disabled:this.isComputedDisabled(),
readonly:this.isReadOnly(),loading:this.isLoading(),feedback:this.getFeedback(),elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth(),
colorSchema:this.props.colorSchema,onRemove:this.isReadOnly()||this.isComputedDisabled()?null:e=>this.removeValue(e),onChange:this._onChange,popoverLocation:this.props.popoverLocation}
;return k.forEach((e=>{delete t[e]})),"number"==typeof t.borderRadius&&(t.borderRadius=i.Common.Tools.fillUnit(t.borderRadius)),t},_getSwitchProps(e){let t={items:this.props.items,
value:this.state.value,size:this.props.size,colorSchema:this._getColorSchema(),bgStyle:this.props.bgStyle,borderRadius:this.props.borderRadius,elevation:this.props.elevation,
readOnly:this.isDisabled()||this.isReadOnly(),disabled:this.isComputedDisabled(),width:this.props.inputWidth,className:this.getClassName("buttonWrapper")}
;return this.state.feedback===a.Hb&&(t.borderWidth=2,t.borderWidthFeedback=2),e||(t.mainAttrs=this.props.inputAttrs,t.onChange=this._onChange),t},_getMainAttrs(){let e=this._getInputAttrs()
;return this.props.colorSchema&&(e.className+=" color-schema-"+i.Environment.getColorSchema(this.props.colorSchema)),e},_getWrapper(e){
return this.props.inputWidth?e:Uu5g05.Utils.Element.create(i.Bricks.Resize,{height:void 0,onResize:this._onResize},e)},render(){let e;if(this.state.displaySelect){
const t=this._getSelectProps(),o=this._getSwitchProps(!0);e=Uu5g05.Utils.Element.create(Uu5g05.Fragment,null,Uu5g05.Utils.Element.create("div",{className:this.getClassName("hiddenWrapper")
},Uu5g05.Utils.Element.create(i.Bricks.SwitchSelector,u()({},o,{ref_:this._registerSwitch}))),Uu5g05.Utils.Element.create(v,u()({},t,{onChange:this._onChange}),this._getSelectItems()))
}else e=Uu5g05.Utils.Element.create(i.Bricks.SwitchSelector,u()({},this._getSwitchProps(),{ref_:this._registerSwitch}))
;return this._getWrapper(Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(this.getId()+"-input"),this.getInputWrapper(e)))}}))},9656:(e,t,o)=>{"use strict";o.d(t,{O:()=>R})
;var s=o(4434),u=(o(5617),o(1256)),i=o(8977),r=o(2810),n=o(8379),a=o(8216),l=o(2851);let m,p,c,h,f,d,g,v,b,x,y=e=>e;function k(e){return!(!e.disabled&&"loading"!==e.feedback)}
const _=s.Environment.colors,C={s:"3px 2px",m:"3px 2px",l:"4px 3px",xl:"5px 4px"},w={s:"1px 3px 3px 5px",m:"2px 4px 3px 7px",l:"3px 4px 4px 8px",xl:"3px 6px 5px 9px"},T={s:"20px",m:"24px",l:"28px",
xl:"32px"},D={s:"3px",m:"4px",l:"6px",xl:"8px"},I={s:"12px",m:"14px",l:"16px",xl:"18px"},P={s:"22px",m:"30px",l:"38px",xl:"46px"},S={s:"4px",m:"5px",l:"6px",xl:"6px"},F={s:"136px",m:"160px",l:"180px",
xl:"200px"},N={main:e=>{let t="\n      .uu5-bricks-button.uu5-forms-input-button {\n        width: auto; padding: 0 16px;\n      }\n    "
...
u.Z.css("tag-select")+" "+l.Z.css(t)},tag:e=>l.Z.css(m||(m=y`
      && {
        display: inline-flex;
        align-items: center;
    ...
    `),T[e.size],w[e.size],C[e.size]),tagTextWrapper:()=>l.Z.css(p||(p=y`
      overflow: hidden;
      text-overflow: ellipsis;
      white-space: nowrap;
    `)),itemsInput:e=>l.Z.css(c||(c=y`
      border-radius: 2px;
      ...
      ${0}
    `),e.disabled?`&&&:focus { border-color: ${s.Environment.colors.grey.c400}; box-shadow: none; }`:""),inputValueWrapper:e=>{let t,o=parseInt(D[e.size])+parseInt(w[e.size].split(" ")[3])+"px"
;return t=e.multiple?D[e.size]:parseInt(D[e.size])+parseInt(w[e.size].split(" ")[3])+"px",l.Z.css(h||(h=y`
      display: flex;
      flex-grow: 1;
      align-items: center;
      padding-left: ${0};
      padding-right: ${0};
      max-width: 100%;
    `),t,o)},valueWrapper:()=>l.Z.css(f||(f=y`
    max-width: 100%;
    overflow: hidden;
    text-overflow: ellipsis;
  `)),inputValue:e=>l.Z.css(d||(d=y`
      display: flex;
      flex: 1 1 auto;
      flex-wrap: ${0};
      align-items: center;
    ...
    `),e.multiple?"wrap":"nowrap",P[e.size]),inputResetIconWrapper:()=>l.Z.css(g||(g=y`
      &&& {
        height: 100%;
      }
    `)),inputResetIcon:(e,t)=>l.Z.css(v||(v=y`
      &&& {
        height: 1em;
        padding: 0;
        margin-top: ${0};
    ...
    `),S[e.size],t.readOnly||k(t)?"default":"pointer"),textInput:(e,t)=>{let o,u=!t.searchValue&&(e.multiple||!function(e){return!(!e||!e.length)
}(t.value)),i=u?e.placeholder||s.Environment.Lsi.Forms.tagSelect.placeholder:null,r=u?s.Common.Tools.calculateTextWidth("string"==typeof i?i:s.Common.BaseMixin.getLsiItem(i),{fontSize:`${I[e.size]}`,
whiteSpace:"pre"}):void 0;o=e.multiple?parseInt(w[e.size].split(" ")[3])+"px":"0px";let n="1 0 auto",a=C[e.size],m=0;return e.multiple||t.searchValue||(n="0 0 0",a="0 -1px 0 0",m=r||1),
l.Z.css(b||(b=y`
      flex: ${0};
      display: inline-block;
      padding-left: ${0};
    ...
    `),n,o,o,a,t.readOnly||k(t)?"default":"text",m,T[e.size],s.Common.Tools.isIE()?"&::-ms-clear { display: none; }":"")},itemList:e=>{const t=function(e){e=e||"default";let t=function(e){
return"default"===e||"blue"===e||"custom"===e?s.Environment.colors.blue:s.Environment.colors[e.replace(/-rich/,"")]}(e=s.Environment.colorSchemaMap[e].color)
;return"default"===e?U(t):"white"===e||"black"===e||"grey"===e||"grey-rich"===e?function(e){return{itemBgColorHover:_.grey.c300,selectedItemBgColor:e.c50,selectedItemBgColorHover:e.c500,
selectedItemTextColorHover:e.inverse}}(t):e.match(/\w+-rich/)?V(t):E(t)}(e.colorSchema);return l.Z.css(x||(x=y`
      && {
        display: block;
      }
    ...
    `),t.itemBgColorHover,t.selectedItemBgColor,t.selectedItemBgColorHover,t.selectedItemTextColorHover)},noMatchItem:()=>l.Z.css({pointerEvents:"none"})};function E(e){return{
itemBgColorHover:_.grey.c300,selectedItemBgColor:e.c50,selectedItemBgColorHover:e.c500,selectedItemTextColorHover:e.inverse}}const V=E,U=E;const O=N;var Z=o(4260),A=o(9501);o(3167)
;const R=a.ZP.withContext(s.Common.VisualComponent.create({mixins:[s.Common.BaseMixin,s.Common.ElementaryMixin,s.Common.LsiMixin,i.ZP],statics:{tagName:u.Z.name("TagSelect"),classNames:{...O,
item:u.Z.css("auto-complete-item","group-item"),inputOpen:u.Z.css("items-input-open")},lsi:()=>s.Common.Tools.merge({},s.Environment.Lsi.Forms.tagSelect,s.Environment.Lsi.Forms.message)},propTypes:{
value:s.PropTypes.oneOfType([s.PropTypes.string,s.PropTypes.arrayOf(s.PropTypes.string)]),availableTags:s.PropTypes.arrayOf(s.PropTypes.shape({value:s.PropTypes.string,
content:s.PropTypes.oneOfType([s.PropTypes.string,s.PropTypes.object]),colorSchema:s.PropTypes.string,bgStyle:s.PropTypes.oneOf(["filled","outline","transparent","underline"])})),
ignoreTags:s.PropTypes.arrayOf(s.PropTypes.string),allowCustomTags:s.PropTypes.bool,colorSchema:s.PropTypes.string,multiple:s.PropTypes.bool,
borderRadius:s.PropTypes.oneOfType([s.PropTypes.string,s.PropTypes.number]),bgStyle:s.PropTypes.oneOf(["filled","outline","transparent","underline"]),
elevation:s.PropTypes.oneOf(["-1","0","1","2","3","4","5",-1,0,1,2,3,4,5]),placeholder:s.PropTypes.oneOfType([s.PropTypes.string,s.PropTypes.object]),required:s.PropTypes.bool,
requiredMessage:s.PropTypes.any,popoverLocation:s.PropTypes.oneOf(["local","portal"])},getDefaultProps:()=>({value:void 0,availableTags:void 0,ignoreTags:void 0,allowCustomTags:!1,multiple:!1,
...
e._data.state&&this._checkRequired(e._data.state)&&this.setState({...e._data.state},(()=>{this.setInitial(void 0,this.state.value),this._onOpen(t)}))),this},isValid(){
...
u=t?e.filter((e=>!s.find((t=>t===e)))):e.filter((e=>o.find((t=>t.value===e))&&!s.find((t=>t===e)))),u},_initAvailableTags(e=this.props){this._availableTags=e.availableTags?e.availableTags.map((e=>({
...e,content:e.content||e.value,searchValue:this._getTagSearchValue(e)}))):[]},_correctAvailableTags(e,t=this.props){e&&e.forEach((e=>{
t.allowCustomTags&&!this._availableTags.find((t=>t.value===e))&&this._availableTags.push({value:e,content:e,searchValue:this._getTagSearchValue(e)})}))},_getTagContent(e){
return"object"!=typeof e.content||s.Common.Element.isValid(e.content)?e?e.content:null:this.getLsiItem(e.content)},_getTagSearchValue(e){let t=""
;return t="string"==typeof e?e:s.Common.Element.isValid(e.content)&&"string"!=typeof e.content||!e.content?e.value:this._getTagContent(e),t.toLowerCase()},_getTagTooltip(e){
return s.Common.Element.isValid(e.content)?e.value:this._getTagContent(e)},_hasValue:e=>!(!e||!e.length),_hasValidValue:e=>!(!e||!e.length)&&e.some((e=>!!e)),_validate(e,t,o){
...
;"function"==typeof this.props.onChange?this.props.onChange(t):this.onChangeDefault(t)},_close(e){this._itemList?this._itemList.close((()=>{this._checkRequired({value:this.state.value}),
this.setState({open:!1},"function"==typeof this.props.onClose?()=>this.props.onClose(e):e)})):"function"==typeof e&&e()},_removeTagValue(e,t){e.preventDefault(),e.stopPropagation()
...
return t.filter((({searchValue:t})=>-1!==t.indexOf(e.toLowerCase())))},_addKeyboardEvent(){let e,t,o=-1;s.Environment.EventListener.addWindowEvent("keydown",this.getId(),(o=>{switch(e=this._itemList,
...
t&&o.preventDefault()}})),s.Environment.EventListener.addWindowEvent("keyup",this.getId(),(s=>{switch(s.which){case 13:
...
!this.props.disableBackdrop&&window.addEventListener("mousedown",this._onMouseDown,!0)},_removeEvent(){this.props.disableBackdrop||window.removeEventListener("mousedown",this._onMouseDown,!0),
s.Environment.EventListener.removeWindowEvent("keydown",this.getId()),s.Environment.EventListener.removeWindowEvent("keyup",this.getId())},_getEventPath(e){let t=[],o=e.target
;for(;o&&o!==document.body&&o!=document.documentElement;)t.push(o),o=o.parentNode;return t},_findTarget(e){
...
this._itemList?this._itemList.open({aroundElement:s.Common.DOM.findNode(this._itemsInput),position:"bottom",offset:4,fitWidthToAroundElement:"portal"===this.props.popoverLocation
...
this._addKeyboardEvent()},_getTagList(){let e;return e=this._hasValue(this.state.value)?this.props.multiple?this.state.value.map((e=>{let t=this._availableTags.find((t=>t.value===e))
;return Uu5g05.Utils.Element.create(s.Bricks.Label,{key:e,bgStyle:t.bgStyle,colorSchema:t.colorSchema||"custom",
iconOnClick:this.isReadOnly()||this.isComputedDisabled()?null:(t,o)=>this._removeTagValue(o,e),icon:this.isComputedDisabled()||this.isReadOnly()?void 0:"mdi-close",className:this.getClassName("tag"),
tooltip:this._getTagTooltip(t)},Uu5g05.Utils.Element.create("span",{className:this.getClassName("tagTextWrapper")},this._getTagContent(t)))})):this.state.value[0]:[],e},_onTextInputKeyPress(e){
13!==(e.keyCode||e.which)||e.shiftKey||e.ctrlKey||(e.preventDefault(),this.isReadOnly()||this.isComputedDisabled()||this._addTagValue({value:this.state.searchValue}))},_getTextInput(){
return Uu5g05.Utils.Element.create(r.Z,{key:"text-input",value:this.state.searchValue,wrapperAttrs:{onClick:this.isReadOnly()||this.isComputedDisabled()?void 0:this._onInputClick},
...
colorSchema:"custom"===this.props.colorSchema?this.props.colorSchema:void 0})},_getItemListItems(){
...
;return this.state.searchValue&&this.state.searchValue.trim()&&(e=this._getMatchingTags(this.state.searchValue.trim(),e)),e.length?e.map(((e,t)=>Uu5g05.Utils.Element.create(A.Z,{
className:this.getClassName("item"),key:t,value:e.value,content:this._getTagContent(e),mainAttrs:{id:this.getId()+"-item-"+t,tabIndex:0}
}))):this.props.allowCustomTags?void 0:[Uu5g05.Utils.Element.create(A.Z,{className:this.getClassName("item")+" "+this.getClassName("noMatchItem"),content:this.getLsiComponent("noItemsAvailable"),
value:"noMatch",key:"no-match",disabled:!0})]},_getInputContent(){if(this._hasValue(this.state.value)){let e=[this._getTextInput()];if(!this.state.searchValue&&!this.state.searchValue.trim()){
let t=this._availableTags.find((e=>e.value===this._getTagList()));e.push(Uu5g05.Utils.Element.create("div",{className:this.getClassName("valueWrapper"),title:this._getTagTooltip(t),key:"value"
},this._getTagContent(t)))}return e}return this._getTextInput()},_getMultiInputContent(){let e=this._getTagList();return e.push(this._getTextInput()),e},_onEnterResetIcon(e){
13===e.which&&this._emptyValues(e)},_getInputValue(){let e=this.props.multiple?this._getMultiInputContent():this._getInputContent();return Uu5g05.Utils.Element.create("div",{
className:this.getClassName("inputValueWrapper")},Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputValue")
},e),!this._hasValidValue(this.state.value)||this.isComputedDisabled()||this.isReadOnly()?null:Uu5g05.Utils.Element.create("div",{className:this.getClassName("inputResetIconWrapper")
},Uu5g05.Utils.Element.create(s.Bricks.Icon,{icon:"mdi-close",className:this.getClassName("inputResetIcon"),mainAttrs:this.isReadOnly()?null:{onClick:this._emptyValues,
onKeyPress:this._onEnterResetIcon,tabIndex:"0"}})))},_getItemList(){let e=null;if(this.state.open){let t=this._getItemListItems();if(null!=t&&t.length){let o=this.getClassName("itemList")
;"portal"===this.props.popoverLocation&&(o+=" "+this.getClassName("input","UU5.Forms.InputMixin")+this.props.size),e=Uu5g05.Utils.Element.create(Z.Z,{onChange:this._addTagValue,
ref:this._registerItemList,id:`${this.getId()}-item-list`,value:this.state.value,parent:this,className:o,location:this.props.popoverLocation},t)}}return e},_getInputMainAttrs(){
...
this.isReadOnly()||this.isComputedDisabled()||(e={tabIndex:this.isReadOnly()||this.isComputedDisabled()?void 0:"0",
...
_getMainPropsToPass(){let e=this._getInputAttrs();return this.props.colorSchema&&(e.className+=" color-schema-"+this.props.colorSchema),e},render(){let e=this.getId()+"-input"
;return Uu5g05.Utils.Element.create(s.Bricks.Div,this._getMainPropsToPass(),this.getLabel(e),this.getInputWrapper(Uu5g05.Utils.Element.create(Uu5g05.Fragment,null,Uu5g05.Utils.Element.create(n.Z,{
id:e,name:this.props.name||e,value:this._getInputValue(),disabled:this.isDisabled()||this.isLoading(),readonly:this.isReadOnly(),loading:this.isLoading(),feedback:this.getFeedback(),
...
}),this._getItemList(),"portal"===this.props.popoverLocation&&this.state.open?Uu5g05.Utils.Element.create(s.Bricks.ResizeObserver,{onResize:this._onInputWrapperResize,key:"resizeObserver"}):null)))}
}))},1755:(t,o,s)=>{"use strict";s.d(o,{K:()=>C})
;var u=s(4434),i=(s(5617),s(1256)),r=s(2810),n=s(1939),a=s(8216),l=s(6062),m=s.n(l),p=s(4036),c=s.n(p),h=s(507),f=s.n(h),d=s(7892),g=s.n(d),v=s(1173),b=s.n(v),x=s(2464),y=s.n(x),k=s(5484),_={}
;_.styleTagTransform=y(),_.setAttributes=g(),_.insert=f(),_.domAPI=c(),_.insertStyleElement=b();m()(k.Z,_);k.Z&&k.Z.locals&&k.Z.locals;const C=a.ZP.withContext(u.Common.VisualComponent.create({
displayName:"TextArea",mixins:[u.Common.BaseMixin,u.Common.PureRenderMixin,u.Common.ElementaryMixin,n.Z],statics:{tagName:i.Z.name("TextArea"),classNames:{main:i.Z.css("text-area")},errors:{
validateError:"Validated result is not object."},lsi:()=>u.Environment.Lsi.Forms.message},propTypes:{value:u.PropTypes.string,rows:u.PropTypes.number,autoResize:u.PropTypes.bool,
maxRows:u.PropTypes.number},getDefaultProps:function(){return{value:"",rows:3,autoResize:!1,maxRows:null}},UNSAFE_componentWillMount(){
...
let e=this.getId()+"-input",t=this.props.inputAttrs||{};return""===t.className&&delete t.className,
Uu5g05.Utils.Element.create("div",this._getInputAttrs(),this.getLabel(e),this.getInputWrapper([Uu5g05.Utils.Element.create(r.Z,{id:e,name:this.props.name||e,value:this.state.value,
placeholder:this.props.placeholder,type:"textarea",onChange:this.onChange,onBlur:this.onBlur,onFocus:this.onFocus,onKeyDown:this.onKeyDown,mainAttrs:t,disabled:this.isComputedDisabled(),
readonly:this.isReadOnly(),loading:this.isLoading(),rows:this.props.rows,autoResize:this.props.autoResize,maxRows:this.props.maxRows,ref_:e=>this._textInput=e,feedback:this.getFeedback(),
borderRadius:this.props.borderRadius,elevation:this.props.elevation,bgStyle:this.props.bgStyle,inputWidth:this._getInputWidth(),colorSchema:this.props.colorSchema,size:this.props.size,key:"input"})]))
}}))},2435:(t,o,s)=>{"use strict";s.d(o,{A:()=>C})
;var u=s(4434),i=(s(5617),s(1256)),r=s(9036),n=s(1939),a=s(8216),l=s(6062),m=s.n(l),p=s(4036),c=s.n(p),h=s(507),f=s.n(h),d=s(7892),g=s.n(d),v=s(1173),b=s.n(v),x=s(2464),y=s.n(x),k=s(9542),_={}
;_.styleTagTransform=y(),_.setAttributes=g(),_.insert=f(),_.domAPI=c(),_.insertStyleElement=b();m()(k.Z,_);k.Z&&k.Z.locals&&k.Z.locals;const C=a.ZP.withContext(u.Common.VisualComponent.create({
displayName:"TextButton",mixins:[u.Common.BaseMixin,u.Common.PureRenderMixin,u.Common.ElementaryMixin,n.Z],statics:{tagName:i.Z.name("TextButton"),classNames:{main:i.Z.css("text-button")},
lsi:()=>u.Environment.Lsi.Forms.message},propTypes:{value:u.PropTypes.string,buttons:u.PropTypes.arrayOf(u.PropTypes.shape({icon:u.PropTypes.string,onClick:u.PropTypes.func,
colorSchema:u.PropTypes.string,bgStyle:u.PropTypes.string,borderRadius:u.PropTypes.string,elevation:u.PropTypes.oneOf(["-1","0","1","2","3","4","5",-1,0,1,2,3,4,5])})),pattern:u.PropTypes.string,
actionOnEnter:u.PropTypes.bool,popoverLocation:u.PropTypes.oneOf(["local","portal"])},getDefaultProps:()=>({value:"",buttons:null,pattern:null,actionOnEnter:!1,popoverLocation:"local"}),
...
_getButtons(){let e=[];return this.isReadOnly()||this.props.buttons&&this.props.buttons.map(((t,o)=>{let s=u.Common.Tools.merge({size:this.props.size,colorSchema:this.props.colorSchema},t)
...
e.push(s)})),e},_getInputProps(e){let t=this.props.inputAttrs||{};this.props.actionOnEnter&&(t=u.Common.Tools.merge({autoComplete:"off"},t),t.onKeyPress=this._onEnter),
...
;return this.state.autocompleteItems&&(o={...o,itemsListItems:this.state.autocompleteItems,foundItemListItems:this.state.autocompleteItems?this._getChildren():void 0,
itemListProps:this.state.autocompleteItems?this._getItemListProps():void 0,open:this.isOpen(),onClose:this.close,onOpen:this.open}),o},_getInput(e){
return Uu5g05.Utils.Element.create(r.Z,this._getInputProps(e))},render(){let e=this.getId()+"-input"
;return Uu5g05.Utils.Element.create("div",this._getInputAttrs(),this.getLabel(e),this.getInputWrapper(this._getInput(e),this._getButtons()))}}))},2523:(t,o,s)=>{"use strict";s.d(o,{V:()=>C})
;var u=s(4434),i=(s(5617),s(1256)),r=s(9036),n=s(1939),a=s(8216),l=s(6062),m=s.n(l),p=s(4036),c=s.n(p),h=s(507),f=s.n(h),d=s(7892),g=s.n(d),v=s(1173),b=s.n(v),x=s(2464),y=s.n(x),k=s(9038),_={}
;_.styleTagTransform=y(),_.setAttributes=g(),_.insert=f(),_.domAPI=c(),_.insertStyleElement=b();m()(k.Z,_);k.Z&&k.Z.locals&&k.Z.locals;const C=a.ZP.withContext(u.Common.VisualComponent.create({
displayName:"TextIcon",mixins:[u.Common.BaseMixin,u.Common.PureRenderMixin,u.Common.ElementaryMixin,n.Z],statics:{tagName:i.Z.name("TextIcon"),classNames:{main:i.Z.css("text-icon"),
left:i.Z.css("text-icon-left"),right:i.Z.css("text-icon-right")},errors:{validateError:"Validated result is not object."},lsi:()=>u.Environment.Lsi.Forms.message},propTypes:{value:u.PropTypes.string,
password:u.PropTypes.bool,icon:u.PropTypes.string,iconPosition:u.PropTypes.oneOf(["left","right"]),onClick:u.PropTypes.func,pattern:u.PropTypes.string,actionOnEnter:u.PropTypes.bool,
popoverLocation:u.PropTypes.oneOf(["local","portal"])},getDefaultProps:function(){return{value:"",password:!1,icon:null,iconPosition:"right",onClick:null,pattern:null,actionOnEnter:!1,
...
;this.state.autocompleteItems&&(t=u.Common.Tools.merge({autoComplete:"off"},t)),this.props.actionOnEnter&&(t.onKeyPress=this._onEnter),""===t.className&&delete t.className;let o={id:e,
...
clickable:"function"==typeof this.props.onClick,size:this.props.size,popoverLocation:this.props.popoverLocation};return this.state.autocompleteItems&&(o={...o,
...
open:this.isOpen(),onClose:this.close,onOpen:this.open}),o},_getInput(e){return Uu5g05.Utils.Element.create(r.Z,this._getInputProps(e))},render(){let e=this.getId()+"-input"
;return Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(e),this.getInputWrapper(this._getInput(e)))}}))},4328:(e,t,o)=>{"use strict";o.d(t,{x:()=>_});var s=o(4434),u=(o(5617),
o(1256)),i=o(9036),r=o(1939),n=o(8216),a=o(6062),l=o.n(a),m=o(4036),p=o.n(m),c=o(507),h=o.n(c),f=o(7892),d=o.n(f),g=o(1173),v=o.n(g),b=o(2464),x=o.n(b),y=o(167),k={};k.styleTagTransform=x(),
k.setAttributes=d(),k.insert=h(),k.domAPI=p(),k.insertStyleElement=v();l()(y.Z,k);y.Z&&y.Z.locals&&y.Z.locals;const _=n.ZP.withContext(s.Common.VisualComponent.create({displayName:"Text",
mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ElementaryMixin,r.Z],statics:{tagName:u.Z.name("Text"),classNames:{main:u.Z.css("text")},errors:{
validateError:"Validated result is not object."},lsi:()=>s.Environment.Lsi.Forms.message},propTypes:{value:s.PropTypes.string,password:s.PropTypes.bool,pattern:s.PropTypes.string,
popoverLocation:s.PropTypes.oneOf(["local","portal"]),revealable:s.PropTypes.bool},getDefaultProps:()=>({value:"",password:!1,pattern:null,popoverLocation:"local",revealable:!1}),
UNSAFE_componentWillMount(){return this.props.onValidate&&"function"==typeof this.props.onValidate&&this._validateOnChange({value:this.state.value,event:null,component:this}),this},
...
_getInputProps(e){let t=this.props.inputAttrs||{};this.state.autocompleteItems&&(t=s.Common.Tools.merge({autoComplete:"off"},t)),""===t.className&&delete t.className;let o={id:e,
...
;return this.state.autocompleteItems&&(o={...o,itemsListItems:this.state.autocompleteItems,foundItemListItems:this.state.autocompleteItems?this._getChildren():void 0,
itemListProps:this.state.autocompleteItems?this._getItemListProps():void 0,open:this.isOpen(),onClose:this.close,onOpen:this.open}),o},_getInput(e){
return Uu5g05.Utils.Element.create(i.Z,this._getInputProps(e))},render(){let e=this.getId()+"-input"
;return Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this.getLabel(e),this.getInputWrapper(this._getInput(e)))}}))},1952:(e,t,o)=>{"use strict";o.d(t,{jI:()=>P,LB:()=>S})
;var s=o(5032),u=o.n(s),i=o(4434),r=o(1256),n=o(2810),a=o(1939),l=o(2438),m=o(8216),p=o(1960),c=o(2202),h=o(6062),f=o.n(h),d=o(4036),g=o.n(d),v=o(507),b=o.n(v),x=o(7892),y=o.n(x),k=o(1173),_=o.n(k),C=o(2464),w=o.n(C),T=o(6666),D={}
;D.styleTagTransform=w(),D.setAttributes=y(),D.insert=b(),D.domAPI=g(),D.insertStyleElement=_();f()(T.Z,D);T.Z&&T.Z.locals&&T.Z.locals;const I="24"
;let P=m.ZP.withContext(i.Common.VisualComponent.create({displayName:"TimePicker",mixins:[i.Common.BaseMixin,i.Common.PureRenderMixin,i.Common.ElementaryMixin,i.Common.ScreenSizeMixin,a.Z],statics:{
tagName:r.Z.name("TimePicker"),classNames:{main:r.Z.css("timepicker"),open:r.Z.css("timepicker-open"),menu:r.Z.css("input-menu"),seconds:r.Z.css("timepicker-seconds"),
screenSizeBehaviour:r.Z.css("screen-size-behaviour"),popover:r.Z.css("timepicker-popover")},defaults:{regexpFormat1:/^\d{1,2}:?\d{0,2} ?[PpAa]?\.?[Mm]?\.?$/,regexpFormat2:/^\d{1,2}:?\d{0,2}$/,
...
iconOpen:"mdi-clock-outline",iconClosed:"mdi-clock-outline",format:I,nanMessage:{cs:"Prosím zadejte čas ve správném formátu.",en:"Please insert a valid time."},seconds:!1,valueType:null,
...
;let s=this.getBlurFeedback(e),u=this._validateTime(s);u={feedback:"initial",message:null,...u},this._updateState(u)}else this.setState({value:o||t})},open_(e){this._addEvent(),
...
;for(let o=0;o<t.length;o++){let s=t[o];this._formattingValues[s]=e[s]}},_registerInput(e){this._textInput=e},_setUpLimits(e){let{timeFrom:t,timeTo:o,show24:s}=p.ZP.setupLimits(e);this._timeFrom=t,
...
value:this.state.value,event:e,component:this};t.input||t.picker||this.isOpen()&&(this._allowBlur=!0,this.close((()=>this._onBlur(o))))},_addEvent(){
window.addEventListener("click",this._handleClick,!0)},_removeEvent(){window.removeEventListener("click",this._handleClick,!0)},_open(e){this._popover?this._popover.open({onClose:this._close,
aroundElement:i.Common.DOM.findNode(this._textInput),position:"bottom",offset:this._shouldOpenToContent()?0:4,preventPositioning:this._shouldOpenToContent()},e):"function"==typeof e&&e()},_close(e){
...
;(!r||"12"==this.props.format&&r.match(p.o1.timeFormat12)||this.props.seconds&&1===this.props.step&&"12"==this.props.format&&r.match(p.o1.timeFormat12seconds)||this.props.format==I&&r.match(p.o1.timeFormat24)||this.props.seconds&&1===this.props.step&&this.props.format==I&&r.match(p.o1.timeFormat24seconds))&&(u=!1,
...
return p.ZP.validateLimits(e,this._timeFrom,this._timeTo)},_validateTime(e){let t={...e},o=e.value?this._parseTime(e.value,!1):null
...
;return t=i.Common.Tools.merge({autoComplete:"off"},t),""===t.className&&delete t.className,Uu5g05.Utils.Element.create("div",u()({},this._getMainAttrs(),{ref:e=>this._root=e
}),this.getLabel(e),this.getInputWrapper([Uu5g05.Utils.Element.create(n.Z,{id:e,name:this.props.name||e,value:this.state.value||"",placeholder:this.props.placeholder,type:"text",
onChange:this._onChange,onFocus:this.isReadOnly()||this.isComputedDisabled()?null:this._onFocus,onBlur:this.isReadOnly()||this.isComputedDisabled()?null:this._trueOnBlur,onKeyDown:this.onKeyDown,
mainAttrs:t,disabled:this.isComputedDisabled(),readonly:this.isReadOnly(),icon:this._getFeedbackIcon(),iconClickable:!1,loading:this.isLoading(),ref_:this._registerInput,feedback:this.getFeedback(),
...
size:this.props.size,key:"input"}),Uu5g05.Utils.Element.create(i.Bricks.Popover,u()({},this._getPopoverProps(),{key:"popover"
}),this.isOpen()?Uu5g05.Utils.Element.create(l.Z,this._getTimeProps(this._parseTime(this.state.value))):null)]))}}));P=(0,c.ZP)(P,{format:"hourFormat"});const S=P},2438:(e,t,o)=>{"use strict";o.d(t,{
q:()=>_,Z:()=>C});var s=o(4434),u=(o(5617),o(1256)),i=o(6062),r=o.n(i),n=o(4036),a=o.n(n),l=o(507),m=o.n(l),p=o(7892),c=o.n(p),h=o(1173),f=o.n(h),d=o(2464),g=o.n(d),v=o(9156),b={}
;b.styleTagTransform=g(),b.setAttributes=c(),b.insert=m(),b.domAPI=a(),b.insertStyleElement=f();r()(v.Z,b);v.Z&&v.Z.locals&&v.Z.locals;const x="AM",y="PM",k="12",_=s.Common.VisualComponent.create({
displayName:"Time",mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ElementaryMixin,s.Common.ScreenSizeMixin,s.Common.ColorSchemaMixin,s.Common.LsiMixin],statics:{tagName:u.Z.name("Time"),
classNames:{main:u.Z.css("time"),button:u.Z.css("time-button"),hours:u.Z.css("time-hours"),minutes:u.Z.css("time-minutes"),seconds:u.Z.css("time-seconds"),hoursWrapper:u.Z.css("time-hours-wrapper"),
minutesWrapper:u.Z.css("time-minutes-wrapper"),secondsWrapper:u.Z.css("time-seconds-wrapper"),pickerWrapper:u.Z.css("time-picker-wrapper"),hoursPickerWrapper:u.Z.css("time-hours-picker-wrapper"),
minutesPickerWrapper:u.Z.css("time-minutes-picker-wrapper"),secondsPickerWrapper:u.Z.css("time-seconds-picker-wrapper"),timeHeader:u.Z.css("time-header"),timeSeparator:u.Z.css("time-separator"),
timeBody:u.Z.css("time-body"),timePart:u.Z.css("time-part"),timePartSwitch:u.Z.css("time-part-switch"),am:u.Z.css("time-am"),amSelected:u.Z.css("time-am-selected uu5-common-text"),
pm:u.Z.css("time-pm"),pmSelected:u.Z.css("time-pm-selected uu5-common-text"),iconAm:u.Z.css("time-icon-am"),iconPm:u.Z.css("time-icon-pm"),nav:u.Z.css("time-nav"),navMax:u.Z.css("time-nav-max"),
singleColumnView:u.Z.css("time-single-column-view"),singleColumnViewButton:u.Z.css("time-single-column-view-button"),screenSizeBehaviour:u.Z.css("screen-size-behaviour")},defaults:{
upIcon:"mdi-menu-up",downIcon:"mdi-menu-down"},lsi:()=>s.Environment.Lsi.Forms.time},propTypes:{value:s.PropTypes.shape({hours:s.PropTypes.number,minutes:s.PropTypes.number,seconds:s.PropTypes.number,
dayPart:s.PropTypes.oneOf([x,y])}),format:s.PropTypes.oneOf([k,"24",12,24]),onChange:s.PropTypes.func,seconds:s.PropTypes.bool,step:s.PropTypes.number,
type:s.PropTypes.oneOf(["single-column","multi-column"]),mobileDisplay:s.PropTypes.bool,timeFrom:s.PropTypes.object,timeTo:s.PropTypes.object,show24:s.PropTypes.bool},getDefaultProps:()=>({value:null,
format:null,onChange:null,seconds:null,step:1,type:"multi-column",mobileDisplay:!1,timeFrom:void 0,timeTo:void 0,show24:!1}),getInitialState(){this._setUpLimits(this.props);let e=this.props.value?{
...this.props.value}:null;return this.props.show24&&e&&24===e.hours&&this._overMidnight&&(e.hours=0),{...this._parseTime(e),valid:this._validateTime(e)}},UNSAFE_componentWillReceiveProps(e){
if(e.controlled&&(this._setUpLimits(e),
...
let t=e.value?{...e.value}:null;e.show24&&t&&24===t.hours&&this._overMidnight&&(t.hours=0),this.setState({...this._parseTime(t),valid:this._validateTime(t,e)})}return this},componentDidMount(){
this._updateScrolls()},componentDidUpdate(e,t){t.hidden&&!this.state.hidden&&this._updateScrolls()},onChangeDefault(e,t){let o=e._data.type,s=e._data.value
;return"secondsUp"==o||"secondsDown"==o?(is12&&(s.pm=pm),this.setState(s,t)):"switchDayPart"==o?this.setState((e=>({pm:!e.pm})),t):"setTime"==o&&this.setState(s,t),this},_validateTime(e){let t=!0
;if(e){let o=this._timeFrom,s=this._timeTo;((e=60*((e={...e}).hours+(e.hours<12&&e.dayPart==y?12:0))*60+60*e.minutes+e.seconds)<o||e>s)&&(this._overMidnight?((e+=86400)<o||e>s)&&(t=!1):t=!1)}return t
...
}):e.scrollTop+e.clientHeight-e.scrollHeight<=1&&this.state[t+"BottomMax"]&&this.setState({[t+"BottomMax"]:!1}))},_parseTime(e){let t;return null!==e?(t={...e},
this._isFormat12()&&(0===t.hours&&(t.hours=1),t.pm=e&&e.dayPart===y,t.hours>12&&(t.hours-=12))):t={hours:null,minutes:null,seconds:null},t},_getDayPart:e=>e?y:x,_addDayPart(e,t){
return e.dayPart=this._getDayPart(t),this},_isFormat12(){return this.props.format==k},_setTime(e,t,o){let u,i=this._isFormat12();u="single-column"===t?{hours:parseInt(e.split(":")[0]),
...
this._show24&&24===u.hours?(u.minutes=0,
...
u.minutes===this._minutesFrom&&u.seconds<this._secondsFrom&&(u.seconds=this._secondsFrom));let r={value:u,event:o,component:this,_data:{overMidnight:u.hours>24,type:"picker",changeType:t,
value:s.Common.Tools.merge({pm:this.state.pm},u)}};return i&&this._addDayPart(u,this.state.pm),"function"==typeof this.props.onChange?this.props.onChange(r):this.onChangeDefault(r),this},_getHours(){
...
this._getButtons(e,1,this.state.seconds,"seconds")},_getButtons(e,t,o,u){return o=this.state.valid?o:null,e.map(((e,t)=>Uu5g05.Utils.Element.create(s.Bricks.Button,{
colorSchema:o===e?this.getColorSchema():"default",className:this.getClassName("button"),bgStyle:o===e?"filled":"transparent",content:s.Common.Tools.rjust(e,2,"0"),key:t,
onClick:(t,o)=>this._setTime(e,u,o)})))},_getSingleColumnItems(){let e=[],t=60*this.props.step,o=this._timeTo-this._timeFrom,u=this._timeFrom;for(let i=0;i<=o/t;i++){
let o,r=Math.floor(u/60/60),n=Math.floor((u-60*r*60)/60);if(this.props.format==k){if(r-=1,24===r)break;r>=12?(o=y,r-=12):o=x,0===r&&(r=12)}else!this._show24&&r>=24&&(r%=24)
;let a=s.Common.Tools.rjust(r,2,"0")+":"+s.Common.Tools.rjust(n,2,"0");o&&(a+=" "+o);let l=r===this.state.hours&&n===this.state.minutes;o&&l&&(l=!(!this.state.pm||o!==y)||!this.state.pm&&o===x)
;const m=(e,t)=>{o?o===x&&this.state.pm?this.setState({pm:!1},(()=>this._setTime(a,"single-column",t))):o!==y||this.state.pm?this._setTime(a,"single-column",t):this.setState({pm:!0
},(()=>this._setTime(a,"single-column",t))):this._setTime(a,"single-column",t)};e.push(Uu5g05.Utils.Element.create(s.Bricks.Button,{className:this.getClassName("singleColumnViewButton"),
colorSchema:l?this.getColorSchema():"default",bgStyle:l?"filled":"transparent",content:a,key:i,onClick:m})),u+=t}return e},_scrollUp(e){let t=document.getElementById(e),o=t.scrollTop
;return t.scrollTop=o-32,this},_scrollDown(e){let t=document.getElementById(e),o=t.scrollTop;return t.scrollTop=o+32,this},_increaseStart(e){this._increaseTimeout=setTimeout((()=>{
this._increaseTimer=s.Environment.TimeManager.setInterval((()=>this._scrollUp(e)),100)}),300)},_increaseEnd(){this._increaseTimeout&&clearTimeout(this._increaseTimeout),
this._increaseTimer&&s.Environment.TimeManager.clearInterval(this._increaseTimer)},_decreaseStart(e){this._decreaseTimeout=setTimeout((()=>{
this._decreaseTimer=s.Environment.TimeManager.setInterval((()=>this._scrollDown(e)),100)}),300)},_decreaseEnd(){this._decreaseTimeout&&clearTimeout(this._decreaseTimeout),
this._decreaseTimer&&s.Environment.TimeManager.clearInterval(this._decreaseTimer)},_switchDayPart(e){let t,o
;return t="function"==typeof this.props.onChange?()=>this.props.onChange(o):()=>this.onChangeDefault(o),this._buttonSwitch.toggle((()=>{this.setState((t=>{let u=!t.pm,i={hours:t.hours,
minutes:t.minutes,seconds:t.seconds};o={value:i,event:e,component:this,_data:{type:"switchDayPart",value:s.Common.Tools.merge({pm:u},i)}},this._addDayPart(i,u)}),t)})),this},_getHeader(e){
return Uu5g05.Utils.Element.create("div",{className:this.getClassName("timeHeader")},this.isXs()?this.getLsiComponent(e):this.getLsiComponent(e)[0])},_getBody(e){let t,o,u,i
;return"seconds"==e?(t=this.getId()+"-secondsPickerWrapper",o=this.getClassName("nav")+(this.state.secondsTopMax?" "+this.getClassName("navMax"):""),
u=this.getClassName("nav")+(this.state.secondsBottomMax?" "+this.getClassName("navMax"):""),i=this._getSeconds()):"minutes"==e?(t=this.getId()+"-minutesPickerWrapper",
...
i=this._getMinutes()):"hours"==e&&(t=this.getId()+"-hoursPickerWrapper",o=this.getClassName("nav")+(this.state.hoursTopMax?" "+this.getClassName("navMax"):""),
u=this.getClassName("nav")+(this.state.hoursBottomMax?" "+this.getClassName("navMax"):""),i=this._getHours()),Uu5g05.Utils.Element.create("div",{className:this.getClassName("timeBody")
},Uu5g05.Utils.Element.create(s.Bricks.Button,{colorSchema:"custom",className:o,onClick:()=>this._scrollUp(t),mainAttrs:{onMouseDown:()=>this._increaseStart(t),onMouseUp:()=>this._increaseEnd(t),
onMouseOut:()=>this._increaseEnd(t)}},Uu5g05.Utils.Element.create(s.Bricks.Icon,{icon:this.getDefault("upIcon")})),Uu5g05.Utils.Element.create("div",{className:this.getClassName("hoursPickerWrapper"),
id:t,ref:t=>{"hours"===e?this._hoursPickerWrapper=t:"minutes"===e?this._minutesPickerWrapper=t:"seconds"===e&&(this._secondsPickerWrapper=t)},onScroll:t=>{
this._updateArrowButton(t.nativeEvent.target,e)}},Uu5g05.Utils.Element.create("div",{className:this.getClassName(e)},i)),Uu5g05.Utils.Element.create(s.Bricks.Button,{colorSchema:"custom",className:u,
onClick:()=>this._scrollDown(t),mainAttrs:{onMouseDown:()=>this._decreaseStart(t),onMouseUp:()=>this._decreaseEnd(t),onMouseOut:()=>this._decreaseEnd(t)}},Uu5g05.Utils.Element.create(s.Bricks.Icon,{
icon:this.getDefault("downIcon")})))},_getType(){let e;return e="multi-column"===this.props.type?Uu5g05.Utils.Element.create("div",this._getMainAttrs(),Uu5g05.Utils.Element.create("div",{
className:this.getClassName("pickerWrapper")},Uu5g05.Utils.Element.create("div",{className:this.getClassName("hoursWrapper")
},this._getHeader("hours"),this._getBody("hours")),this.isXs()?Uu5g05.Utils.Element.create("div",{className:this.getClassName("timeSeparator")}):null,Uu5g05.Utils.Element.create("div",{
className:this.getClassName("minutesWrapper")},this._getHeader("minutes"),this._getBody("minutes")),this.props.seconds&&(this.props.step<=1||!this.props.step)?[Uu5g05.Utils.Element.create("div",{
className:this.getClassName("timeSeparator"),key:"separator"}),Uu5g05.Utils.Element.create("div",{className:this.getClassName("secondsWrapper"),key:"wrapper"
},this._getHeader("seconds"),this._getBody("seconds"))]:null),this._isFormat12()&&Uu5g05.Utils.Element.create("div",{className:this.getClassName("timePart")},Uu5g05.Utils.Element.create("span",{
className:this.getClassName("am")+(this.state.pm?"":" "+this.getClassName("amSelected"))},"AM"),Uu5g05.Utils.Element.create(s.Bricks.Switch,{size:"m",onIcon:"mdi-chevron-right",
offIcon:"mdi-chevron-left",className:this.getClassName("timePartSwitch"),ref_:e=>this._buttonSwitch=e,onChange:()=>this._switchDayPart(),switchedOn:!!this.state.pm
}),Uu5g05.Utils.Element.create("span",{className:this.getClassName("pm")+(this.state.pm?" "+this.getClassName("pmSelected"):"")
},"PM"))):Uu5g05.Utils.Element.create("div",this._getMainAttrs(),this._getSingleColumnItems()),e},_getMainAttrs(){let e=this.getMainAttrs()
;return"single-column"===this.props.type&&(e.className+=" "+this.getClassName("singleColumnView"),e.ref=this._registerSinglePickerWrapper),
this.props.mobileDisplay&&(e.className+=" "+this.getClassName("screenSizeBehaviour")),e},render(){return this._getType()}}),C=_},7123:(e,t,o)=>{"use strict";o.d(t,{I:()=>C});var s=o(4434),u=(o(5617),
o(1256)),i=o(7530),r=o(8977),n=o(6047),a=o(8216),l=o(6062),m=o.n(l),p=o(4036),c=o.n(p),h=o(507),f=o.n(h),d=o(7892),g=o.n(d),v=o(1173),b=o.n(v),x=o(2464),y=o.n(x),k=o(3269),_={}
;_.styleTagTransform=y(),_.setAttributes=g(),_.insert=f(),_.domAPI=c(),_.insertStyleElement=b();m()(k.Z,_);k.Z&&k.Z.locals&&k.Z.locals;const C=a.ZP.withContext(s.Common.VisualComponent.create({
displayName:"TriStateCheckbox",mixins:[s.Common.BaseMixin,s.Common.PureRenderMixin,s.Common.ElementaryMixin,s.Common.ColorSchemaMixin,r.ZP],statics:{tagName:u.Z.name("TriStateCheckbox"),classNames:{
main:u.Z.css("tri-state-checkbox"),button:u.Z.css("tri-state-checkbox-button"),right:u.Z.css("input-label-right"),rightWrapper:u.Z.css("right-wrapper"),checked:u.Z.css("tri-state-checkbox-checked"),
unChecked:u.Z.css("tri-state-checkbox-unchecked"),indeterminate:u.Z.css("tri-state-checkbox-indeterminate"),loading:u.Z.css("input-loading-icon")},defaults:{onIcon:"mdi-check",
indeterminateIcon:"mdi-stop",offIcon:""},lsi:()=>s.Environment.Lsi.Forms.message},propTypes:{value:s.PropTypes.oneOf([!0,!1,null]),onIcon:s.PropTypes.string,offIcon:s.PropTypes.string,
...
bgStyleIndeterminate:s.PropTypes.oneOf(["filled","outline"])},getDefaultProps:()=>({value:null,onIcon:"",offIcon:"",indeterminateIcon:"",labelPosition:"left",bgStyleChecked:"outline",
...
;null===this.state.value&&(e.className+=" "+this.getClassName("indeterminate"),this.props.bgStyleIndeterminate&&(e.className+=" "+i.Z[this.props.bgStyleIndeterminate])),
!0===this.state.value&&(e.className+=" "+this.getClassName("checked"),this.props.bgStyleChecked&&(e.className+=" "+i.Z[this.props.bgStyleChecked])),
!1===this.state.value&&(e.className+=" "+this.getClassName("unChecked"),e.className+=" "+i.Z.outline),"right"===this.props.labelPosition&&(e.className+=" "+this.getClassName().right);let t=e=>{
...
Uu5g05.Utils.Element.create(s.Bricks.Icon,{icon:e})},_getWrapperAttrs(){let e={};return e.className=this.getClassName("rightWrapper"),this.props.inputWidth&&(e.style={width:this.getInputWidth_()}),e},
render(){let e,t=this.getId()+"-input",o=this.getLabel(t);return e=this.isLoading()?Uu5g05.Utils.Element.create(n.Z,{className:this.getClassName("loading"),id:this.getId()
}):Uu5g05.Utils.Element.create(s.Bricks.Button,{className:this.getClassName().button,colorSchema:"custom",disabled:this.isComputedDisabled(),mainAttrs:s.Common.Tools.merge({
disabled:this.isReadOnly()||this.isComputedDisabled()},this.props.inputAttrs),content:this._getIcon(),ref_:e=>this._focusElement=e}),
Uu5g05.Utils.Element.create("div",this._getMainAttrs(),"left"===this.props.labelPosition&&o,this.getInputWrapper(Uu5g05.Utils.Element.create(s.Bricks.Div,this._getWrapperAttrs(),e,"right"===this.props.labelPosition&&o)))
}}))},507:e=>{e.exports=function(e){var t=document.head||document.body;e.setAttribute("data-owner","uu5g04/uu5g04-forms@1.58.6"),e.setAttribute("data-emotion","uu-forms"),
...
(u=document.querySelector("[data-uu-app-styles-insert-before]"))?u.parentNode.insertBefore(e,u):t.appendChild(e)}},9586:(e,t,o)=>{var s;e.exports=function(e,t){
if(!s&&t&&"1.58.6"!==t&&("undefined"!=typeof Uu5Loader||"undefined"!=typeof SystemJS)){s=!0
...
;const n=r},7554:(e,t,o)=>{"use strict";o.d(t,{Z:()=>n});var s=o(9601),u=o.n(s),i=o(2609),r=o.n(i)()(u());r.push([e.id,"",""]);const n=r},7997:(e,t,o)=>{"use strict";o.d(t,{Z:()=>n})
;var s=o(9601),u=o.n(s),i=o(2609),r=o.n(i)()(u())
...
m[2]=o):m[2]=o),u&&(m[4]?(m[1]="@supports (".concat(m[4],") {").concat(m[1],"}"),m[4]=u):m[4]="".concat(u)),t.push(m))}},t}},9601:e=>{"use strict";e.exports=function(e){return e[1]}},6232:(e,t,o)=>{
"use strict";var s=o(6062),u=o.n(s),i=o(4036),r=o.n(i),n=o(507),a=o.n(n),l=o(7892),m=o.n(l),p=o(1173),c=o.n(p),h=o(2464),f=o.n(h),d=o(288),g={};g.styleTagTransform=f(),g.setAttributes=m(),
g.insert=a(),g.domAPI=r(),g.insertStyleElement=c();u()(d.Z,g),d.Z&&d.Z.locals&&d.Z.locals},3167:(e,t,o)=>{"use strict"
;var s=o(6062),u=o.n(s),i=o(4036),r=o.n(i),n=o(507),a=o.n(n),l=o(7892),m=o.n(l),p=o(1173),c=o.n(p),h=o(2464),f=o.n(h),d=o(1826),g={};g.styleTagTransform=f(),g.setAttributes=m(),g.insert=a(),
g.domAPI=r(),g.insertStyleElement=c();u()(d.Z,g),d.Z&&d.Z.locals&&d.Z.locals},5853:(e,t,o)=>{"use strict"
;var s=o(6062),u=o.n(s),i=o(4036),r=o.n(i),n=o(507),a=o.n(n),l=o(7892),m=o.n(l),p=o(1173),c=o.n(p),h=o(2464),f=o.n(h),d=o(4165),g={};g.styleTagTransform=f(),g.setAttributes=m(),g.insert=a(),
g.domAPI=r(),g.insertStyleElement=c();u()(d.Z,g),d.Z&&d.Z.locals&&d.Z.locals},9616:(e,t,o)=>{"use strict"
;var s=o(6062),u=o.n(s),i=o(4036),r=o.n(i),n=o(507),a=o.n(n),l=o(7892),m=o.n(l),p=o(1173),c=o.n(p),h=o(2464),f=o.n(h),d=o(2373),g={};g.styleTagTransform=f(),g.setAttributes=m(),g.insert=a(),
g.domAPI=r(),g.insertStyleElement=c();u()(d.Z,g),d.Z&&d.Z.locals&&d.Z.locals},6062:e=>{"use strict";var t=[];function o(e){for(var o=-1,s=0;s<t.length;s++)if(t[s].identifier===e){o=s;break}return o}
...
;0===t[m].references&&(t[m].updater(),t.splice(m,1))}i=a}}},1173:e=>{"use strict";e.exports=function(e){var t=document.createElement("style");return e.setAttributes(t,e.attributes),
e.insert(t,e.options),t}},7892:(e,t,o)=>{"use strict";e.exports=function(e){var t=o.nc;t&&e.setAttribute("nonce",t)}},4036:e=>{"use strict";e.exports=function(e){
if("undefined"==typeof document)return{update:function(){},remove:function(){}};var t=e.insertStyleElement(e);return{update:function(o){!function(e,t,o){var s=""
;o.supports&&(s+="@supports (".concat(o.supports,") {")),o.media&&(s+="@media ".concat(o.media," {"));var u=void 0!==o.layer;u&&(s+="@layer".concat(o.layer.length>0?" ".concat(o.layer):""," {")),
s+=o.css,u&&(s+="}"),o.media&&(s+="}"),o.supports&&(s+="}");var i=o.sourceMap
;i&&"undefined"!=typeof btoa&&(s+="\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(i))))," */")),t.styleTagTransform(s,e,t.options)}(t,e,o)
...
for(;t.firstChild;)t.removeChild(t.firstChild);t.appendChild(document.createTextNode(e))}}},3145:e=>{"use strict";e.exports=t},4434:e=>{"use strict";e.exports=o},6843:e=>{"use strict";e.exports=s},
3082:e=>{"use strict";e.exports=u},5032:e=>{function t(){return e.exports=t=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t]
;for(var s in o)Object.prototype.hasOwnProperty.call(o,s)&&(e[s]=o[s])}return e},e.exports.__esModule=!0,e.exports.default=e.exports,t.apply(this,arguments)}e.exports=t,e.exports.__esModule=!0,
...
Object.defineProperty(e,"__esModule",{value:!0})},a.p="",a.nc=void 0,a(7944)})()));