...
class TestHelper {
   ...
   * @param {String} options.setupDbScript Deprecated - Path to mongo shell script file or script content to be executed on setup
   ...
   * @deprecated Use getDbConnection() or application API instead.
