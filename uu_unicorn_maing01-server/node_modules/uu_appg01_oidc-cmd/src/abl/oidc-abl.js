...
class OidcAbl {
  ...
  async verifyAccessPolicy(awid, session) {
    ...
    if (!accessPolicy) {
      await this.mutex.runOneAtTime(accessPolicyCacheKey, async () => {
        accessPolicy = await this._getOidcClientAuthNConfig(oidcServerClient, serviceName, awid,
        ...
        this.accessPolicyCache.set(accessPolicyCacheKey, accessPolicy);
      });
    }
